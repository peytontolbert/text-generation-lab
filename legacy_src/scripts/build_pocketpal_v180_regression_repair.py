    ...
    rows.append(
        {
            ...
            "encoder_text": prompt,
            "example_id": f"v180_{task_type}_{split}_{idx:06d}",
            ...
            "source_id": f"v180_{task_type}",
            "source_type": "pocketpal_v180_regression_repair",
            "split": split,
            "task_type": task_type,
            "weight": float(weight),
        }
    ...
    for _ in range(repeats):
        for name, item, deadline, reason, user_text in [
            ...
            idx = _add(
                ...
                "rewrite",
                34.0,
                _payload("respond", "Hello, I hope you are well.", "negative_greeting_attractor"),
            )
        idx = _add(
            rows,
            split,
        ...
        idx = _add(
            ...
            "saved_data",
            36.0,
            _payload("extension_request", "Requesting approval to search the web.", "negative_web_when_saved_data", web_meta),
        )
        idx = _add(
            rows,
            split,
        ...
        for text, label, negative_label in [
            ("Please approve invoice INV-2048 for $1,200.", "finance", "travel"),
            ("Finance needs approval for invoice INV-2048.", "finance", "web_search"),
            ...
            idx = _add(
                ...
                28.0,
                _payload("respond", negative_label, "negative_classifier_attractor"),
            )
        for prompt, action, content, task_type, intent, weight, metadata in [
            (gates._runtime_plain_chat_prompt("Hi how are you?"), "respond", "I'm doing well. What would you like help with?", "runtime_plain_chat", "casual", 20.0, None),
            (
                gates._agent_prompt(
...
def main() -> None:
    ...
    parser.add_argument("--train-repeats", type=int, default=180)
    ...
    manifest = {
        ...
        "objective": "pocketpal_v180_regression_repair",
