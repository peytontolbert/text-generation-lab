...
BASE_SCRIPT = ROOT / "scripts/build_stage12340_combined_train_support_ledger_v2.py"
BASE_SUMMARY = ROOT / "runs/summaries/stage12340_combined_train_support_ledger_v2.json"
STAGE = "stage12344_combined_train_support_ledger_v3"
OUT = ROOT / "runs/local/artifacts" / STAGE
SUMMARY = ROOT / "runs/summaries" / f"{STAGE}.json"
EXTRA = ROOT / "runs/local/artifacts/stage12343_openclaw_access_selected_test_admission/openclaw_access_selected_test_train_support_rows.jsonl"
...
def main() -> None:
    ...
    source_counts["stage12343_openclaw_access_selected_test"] = len(extra_rows)
    ...
    ledger.update({
        "stage": STAGE,
        "decision": "combined_train_support_ledger_v3_ready_500_not_reached",
    ...
    (OUT / "combined_train_support_ledger_v3.json").write_text(json.dumps(ledger, indent=2, sort_keys=True) + "\n", encoding="utf-8")
