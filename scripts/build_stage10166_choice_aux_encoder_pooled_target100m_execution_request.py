...
STAGE = 10166
NAME = 'stage10166_choice_aux_encoder_pooled_target100m_execution_request'
OUT_DIR = ROOT / 'runs/local/artifacts' / NAME
REQUEST = OUT_DIR / 'choice_aux_encoder_pooled_target100m_execution_request.json'
COMMAND_JSON = OUT_DIR / 'choice_aux_encoder_pooled_target100m_command.json'
MANIFEST = OUT_DIR / 'choice_aux_encoder_pooled_target100m_manifest.jsonl'
...
RUN_ID = 'stage10167_choice_aux_encoder_pooled_target100m_probe'
OUTPUT_DIR = 'runs/local/artifacts/stage10167_choice_aux_encoder_pooled_target100m_probe/bounded_decoder_probe'
