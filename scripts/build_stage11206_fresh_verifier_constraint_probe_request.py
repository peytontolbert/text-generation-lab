...
STAGE = 11206
NAME = "stage11206_fresh_verifier_constraint_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "fresh_verifier_constraint_probe_request.json"
COMMAND_JSON = OUT_DIR / "fresh_verifier_constraint_probe_command.json"
MANIFEST = OUT_DIR / "fresh_verifier_constraint_probe_manifest.jsonl"
...
RUN_DIR = ARTIFACTS / "stage11207_fresh_verifier_constraint_probe"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "fresh_verifier_constraint_probe_requested",
