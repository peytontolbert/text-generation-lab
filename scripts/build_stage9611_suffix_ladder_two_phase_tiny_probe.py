...
STAGE = 9611
NAME = "stage9611_suffix_ladder_two_phase_tiny_probe"
SOURCE_SUMMARY = ROOT / "runs/summaries/stage9610_suffix_ladder_two_phase_contract_preflight.json"
...
AUDIT = OUT_DIR / "suffix_ladder_two_phase_tiny_probe_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "SUFFIX_LADDER_TWO_PHASE_TINY_PROBE_STAGE9611.md"
...
def command() -> list[str]:
    return [
        ...
        str(RUN_DIR),
        "--run-id",
        "stage9611_suffix_ladder_two_phase_probe",
...
def main() -> None:
    ...
    next_step = "Audit Stage9611 generation samples and token losses; if quality passes, design a slightly wider suffix-ladder residual denoise probe, otherwise patch the remaining failure bucket."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Executed the suffix-ladder in-memory two-phase suffix-choice plus residual-denoise tiny probe under closed runtime/export authority.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage9611 Suffix-Ladder Two-Phase Tiny Probe",
                "",
