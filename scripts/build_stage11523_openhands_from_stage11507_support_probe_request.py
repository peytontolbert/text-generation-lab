...
STAGE = 11523
NAME = "stage11523_openhands_from_stage11507_support_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "openhands_from_stage11507_support_probe_request.json"
MANIFEST = OUT / "openhands_from_stage11507_support_probe_manifest.jsonl"
COMMAND = OUT / "openhands_from_stage11507_support_probe_command.json"
PROBE = ART / "stage11523_openhands_from_stage11507_support_probe/bounded_decoder_probe"
RUNTIME_OUT = ART / "stage11523_openhands_from_stage11507_support_probe/runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "openhands_stage11507_support_probe_ready" if all(gates.values()) else "openhands_stage11507_support_probe_blocked",
        "metrics": {
        ...
        "command": command,
        "claim_boundary": [
            "Diagnostic Web transfer support probe only.",
