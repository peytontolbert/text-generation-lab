...
STAGE = 11348
NAME = "stage11348_web_static_verifier_current_runtime_score"
OUT = ART / NAME
SUMMARY = OUT / "web_static_verifier_current_runtime_score.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "web_static_verifier_current_runtime_score_complete",
        ...
        "recommended_next_action": "If Stage11347 rows are not saturated while canary is preserved, build a canary-preserving support package from them; otherwise prioritize verifier execution to upgrade them.",
    }
