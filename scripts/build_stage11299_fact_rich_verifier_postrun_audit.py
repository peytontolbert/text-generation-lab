...
STAGE = 11299
NAME = "stage11299_fact_rich_verifier_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "fact_rich_verifier_postrun_audit.json"
RUNTIME_BUNDLE = ARTIFACTS / "stage11298_fact_rich_verifier_probe/runtime_model/runtime_model_bundle.json"
REQUEST_JSON = ARTIFACTS / "stage11297_fact_rich_verifier_probe_request/fact_rich_verifier_probe_request.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "fact_rich_verifier_postrun_audit_complete",
