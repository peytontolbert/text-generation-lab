...
STAGE = 10201
NAME = "stage10201_targeted_contrast_target100m_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST = OUT_DIR / "targeted_contrast_target100m_execution_request.json"
COMMAND_JSON = OUT_DIR / "targeted_contrast_target100m_command.json"
MANIFEST = OUT_DIR / "targeted_contrast_target100m_manifest.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
PACKAGE = ROOT / "runs/local/artifacts/stage10200_targeted_contrast_compact_package/targeted_contrast_compact_package.json"
...
RUN_ID = "stage10202_targeted_contrast_target100m_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10202_targeted_contrast_target100m_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10202_targeted_contrast_target100m_probe/runtime_model"
MAX_STEPS = 224
...
def build_request() -> dict[str, Any]:
    ...
    request = {
        ...
        "run_id": RUN_ID,
        "request_status": "save_enabled_execution_ready",
        ...
        "artifact_purpose": "targeted contrast recovery probe for evidence citation and web file-family disambiguation",
        "required_honesty_gates": [
            "strict eval rows must remain identical to stage10149",
            "targeted contrast rows remain train-only and auxiliary",
