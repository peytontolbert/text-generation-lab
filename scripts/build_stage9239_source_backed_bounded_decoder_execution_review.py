...
STAGE = 9239
NAME = "stage9239_source_backed_bounded_decoder_execution_review"
SOURCE_9237 = ROOT / "runs/summaries/stage9237_source_backed_bounded_decoder_tiny_package.json"
SOURCE_9238 = ROOT / "runs/summaries/stage9238_source_backed_target_100m_contract_only_preflight.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "SOURCE_BACKED_BOUNDED_DECODER_EXECUTION_REVIEW_STAGE9239.md"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
TICKET = OUT_DIR / "source_backed_bounded_decoder_execution_review_inactive.json"
AUDIT = OUT_DIR / "source_backed_bounded_decoder_execution_review_audit.json"
...
OUTPUT_DIR = "runs/local/artifacts/stage9240_source_backed_target_100m_bounded_tiny_probe/bounded_decoder_probe"
RUN_ID = "stage9240_source_backed_target_100m_bounded_tiny_probe"
...
def build_ticket(source_9238: dict[str, Any]) -> dict[str, Any]:
    ticket = {
        "ticket_id": "stage9239_source_backed_bounded_decoder_execution_review__inactive",
        "ticket_status": "DESIGN_ONLY_INACTIVE",
        "requested_stage": 9240,
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "Built an inactive execution review for the source-backed target-100M bounded tiny probe. It records the future command but authorizes no execution." if audit["passed"] else "Source-backed bounded decoder execution review failed.",
        "next_best_step": "If the user explicitly authorizes one tiny execution, run the reviewed Stage9240 command; otherwise continue no-execution data/compiler work.",
