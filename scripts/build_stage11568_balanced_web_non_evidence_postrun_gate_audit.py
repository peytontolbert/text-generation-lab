...
STAGE = 11568
NAME = "stage11568_balanced_web_non_evidence_postrun_gate_audit"
OUT = ART / NAME
SUMMARY = OUT / "balanced_web_non_evidence_postrun_gate_audit.json"

RUNTIME = ART / "stage11567_balanced_web_non_evidence_support_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "balanced_web_non_evidence_postrun_gate_promising" if all(gates.values()) else "text_rich_bridge_postrun_gate_not_promotable",
