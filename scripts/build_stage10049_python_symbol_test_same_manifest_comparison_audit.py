...
STAGE = 10049
NAME = "stage10049_python_symbol_test_same_manifest_comparison_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT = OUT_DIR / "python_symbol_test_same_manifest_comparison_audit.json"
ROWS = OUT_DIR / "python_symbol_test_same_manifest_comparison_rows.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "PYTHON_SYMBOL_TEST_SAME_MANIFEST_COMPARISON_AUDIT_STAGE10049.md"
...
SUCCESSOR_HUNDRED_M = ROOT / "runs/local/artifacts/stage10048_python_symbol_test_target100m_probe/edit_localization_probe/row_field_logits.jsonl"
...
def main() -> None:
    ...
    next_step = "Use this audit to decide whether the stage10047 fresh source-backed Python intervention actually improves Python without giving back the honest multilingual heldout lead."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Materialized the same-manifest comparison audit for the Python symbol-vs-test successor run so the resulting 100M outputs can be judged directly against both the stage10040 baseline and the fixed Gemma comparator.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage10049 Python Symbol Test Same Manifest Comparison Audit",
                "",
