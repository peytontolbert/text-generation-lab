#!/usr/bin/env python3
"""Refresh support supply after additional google/benchmark C/C++ admissions."""
...
STAGE = 11879
NAME = "stage11879_source_heldout_support_supply_status_v33"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v33.json"

PYTHON = ART / "stage11870_python_verifier_support_combined_audit_v13/python_verifier_support_combined_audit_v13.json"
CPP = ART / "stage11878_cpp_abstain_support_combined_audit_v9/cpp_abstain_support_combined_audit_v9.json"
RUST = ART / "stage11854_rust_verifier_support_combined_audit_v11/rust_verifier_support_combined_audit_v11.json"
...
def main() -> None:
    ...
    support_status = {
        ...
        "cpp_abstain_attractor_support": {
            ...
            "same_repo_family_warning": cpp.get("same_repo_family_warning"),
        },
    ...
    artifact = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "support_supply_ready_for_guarded_training_probe_request" if training_probe_ready else "support_supply_improved_but_training_probe_not_ready",
        "passed": True,
        "training_probe_ready": training_probe_ready,
        "support_status": support_status,
        "quota_satisfied": {
            "python_verifier_support": py_roots >= 12,
            "cpp_abstain_attractor_support": cpp_roots >= 16,
            "rust_verifier_support": rust_roots >= 12,
        },
        "next_actions": [
            "Build a guarded training probe request only if accepting same-repo-family C/C++ support is appropriate for this diagnostic.",
            "Keep source-heldout breadth claims separate from this support quota closure.",
            "Preserve Python and Rust completed quotas.",
        ],
        "claim_boundary": [
            "No model frontier score changed in this stage.",
            "No training, Gemma comparison, or full-product claim is implied.",
            "C/C++ quota closure includes multiple google_benchmark same-repo-family support roots.",
        ],
        "source_artifacts": {
