#!/usr/bin/env python3
"""Combined C/C++ abstain-attractor support audit including google/benchmark."""
...
STAGE = 11874
NAME = "stage11874_cpp_abstain_support_combined_audit_v8"
OUT = ART / NAME
SUMMARY = OUT / "cpp_abstain_support_combined_audit_v8.json"
COMBINED_ROWS = OUT / "cpp_abstain_support_rows_v8.jsonl"

ROW_SOURCES = [
    ART / "stage11826_cpp_abstain_support_combined_audit_v7/cpp_abstain_support_rows_v7.jsonl",
    ART / "stage11873_cpp_benchmark_filter_abstain_support_rows/cpp_benchmark_filter_abstain_support_rows.jsonl",
]
