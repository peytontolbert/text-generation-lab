...
STAGE = 11377
NAME = "stage11377_web_sourcebot_combined_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_sourcebot_combined_postrun_audit.json"
RUNTIME = ART / "stage11376_web_sourcebot_combined_probe/runtime_model/runtime_model_bundle.json"
...
def main() -> None:
    ...
    decision = "accept_stage11376_as_diagnostic_support_runtime_keep_stage11200_frontier" if all(gates.values()) else "reject_stage11376_keep_stage11200_frontier"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        ...
        "recommended_next_action": "If validation regressed, do not promote. Add preservation support for the Python abstention validation behavior or broaden Web support further before another training run.",
    }
