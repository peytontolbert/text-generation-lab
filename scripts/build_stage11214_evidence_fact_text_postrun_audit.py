...
STAGE = 11214
NAME = "stage11214_evidence_fact_text_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "evidence_fact_text_postrun_audit.json"

RUNTIME_BUNDLE = ARTIFACTS / "stage11213_evidence_fact_text_probe/runtime_model/runtime_model_bundle.json"
...
def main() -> None:
    ...
    product_scorer = "encoder_option_retrieval_evidence_fact_text"
    diagnostic_scorers = [
