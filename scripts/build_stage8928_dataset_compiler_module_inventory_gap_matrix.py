...
STAGE = 8928
NAME = "stage8928_dataset_compiler_module_inventory_gap_matrix"
REGISTRY = ROOT / "runs/local/artifacts/reconstructed_stage_registry.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "DATASET_COMPILER_MODULE_INVENTORY_GAP_MATRIX_STAGE8928.md"
SPINE = ROOT / "docs" / "MODEL_STACK_SPINE.md"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
MATRIX = OUT_DIR / "dataset_compiler_module_inventory_gap_matrix.json"

SOURCE_SUMMARY = ROOT / "runs/summaries/stage8927_tokenizer_hashlock_bridge_decision.json"
...
def build_matrix(registry: dict[str, Any]) -> dict[str, Any]:
    ...
    checks = {
        "source_stage8927_passed": load_json(SOURCE_SUMMARY).get("passed") is True,
...
def validate_matrix(matrix: dict[str, Any], registry: dict[str, Any]) -> list[str]:
    ...
    if latest not in {8926, 8927, STAGE}:
...
def main() -> None:
    ...
    marker = "## Stage8928 Dataset Compiler Module Inventory Gap Matrix"
