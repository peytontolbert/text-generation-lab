...
STAGE = 9623
NAME = "stage9623_tri_phase_reconnect_tiny_probe"
SOURCE_SUMMARY = ROOT / "runs/summaries/stage9622_tri_phase_reconnect_contract_preflight.json"
...
DOC = ROOT / "docs" / "TRI_PHASE_RECONNECT_TINY_PROBE_STAGE9623.md"
...
def command() -> list[str]:
    return [
        ...
        "--output-dir", str(RUN_DIR), "--run-id", "stage9623_tri_phase_reconnect_probe",
...
def main() -> None:
    ...
    if source.get("passed") is not True:
        failures.append("stage9622_not_passed")
    ...
    next_step = "Audit Stage9623 samples and compare against Stage9619; if quality passes, design the next controlled residual-denoise expansion, otherwise patch the remaining tri-phase failure bucket."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
    ...
    DOC.write_text("\n".join([
        "# Stage9623 Tri-Phase Reconnect Tiny Probe",
        "",
