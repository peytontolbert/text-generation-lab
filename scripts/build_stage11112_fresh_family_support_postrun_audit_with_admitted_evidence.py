...
STAGE = 11112
NAME = "stage11112_fresh_family_support_postrun_audit_with_admitted_evidence"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "fresh_family_support_postrun_audit_with_admitted_evidence.json"
...
RUNTIME_BUNDLE = ARTIFACTS / "stage11111_fresh_family_support_probe_with_admitted_evidence" / "runtime_model" / "runtime_model_bundle.json"
VALIDATION_JSON = ARTIFACTS / "stage11111_fresh_family_support_probe_with_admitted_evidence" / "bounded_decoder_probe" / "bounded_choice_eval_audit_eval.json"
STRICT_JSON = ARTIFACTS / "stage11111_fresh_family_support_probe_with_admitted_evidence" / "bounded_decoder_probe" / "bounded_choice_eval_audit_strict_eval.json"
EXECUTION_JSON = ARTIFACTS / "stage11111_fresh_family_support_probe_with_admitted_evidence" / "bounded_decoder_probe" / "execution_result.json"
RESERVED_ROWS = ARTIFACTS / "stage11051_successor_residual_support_plus_priority_evidence" / "reserved_residual_candidates.jsonl"
FRESH_SUPPORT_ROWS = ARTIFACTS / "stage11109_fresh_family_support_package_with_admitted_evidence" / "added_admitted_evidence_rows.jsonl"
BASELINE_POSTRUN = ARTIFACTS / "stage11105_fresh_family_support_postrun_audit_encoder_option_retrieval" / "fresh_family_support_postrun_audit_encoder_option_retrieval.json"
PACKAGE_SUMMARY = ARTIFACTS / "stage11109_fresh_family_support_package_with_admitted_evidence" / "fresh_family_support_package_with_admitted_evidence.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Audit the stage11111 runtime against the unchanged successor validation/strict overlay and the untouched reserved residual candidate bank.",
            "Check anti-cheat overlap between the stage11109 admitted evidence support rows and the scored strict/reserved surfaces before making any claim.",
        ],
        "source_artifacts": {
        ...
        "headline_findings": [
            "This audit measures whether admitted, leak-audited evidence support moves the untouched successor overlay or only changes support geometry.",
            ...
            "Admitted evidence support rows are explicitly checked for overlap against strict and reserved surfaces before interpreting any gain.",
        ],
        "runtime_bundle": {
