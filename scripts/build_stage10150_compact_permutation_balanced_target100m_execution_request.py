...
STAGE = 10150
NAME = 'stage10150_compact_permutation_balanced_target100m_execution_request'
OUT_DIR = ROOT / 'runs/local/artifacts' / NAME
REQUEST = OUT_DIR / 'compact_permutation_balanced_target100m_execution_request.json'
COMMAND_JSON = OUT_DIR / 'compact_permutation_balanced_target100m_command.json'
MANIFEST = OUT_DIR / 'compact_permutation_balanced_target100m_manifest.jsonl'
...
RUN_ID = 'stage10151_compact_permutation_balanced_target100m_probe'
OUTPUT_DIR = 'runs/local/artifacts/stage10151_compact_permutation_balanced_target100m_probe/bounded_decoder_probe'
