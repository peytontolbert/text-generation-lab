...
STAGE = 11562
NAME = "stage11562_web_support_train_score_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_support_train_score_audit.json"

RUNTIME = ART / "stage11507_preservation_strengthened_evidence_judgment_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
    "web_support_train": ART / "stage11550_web_root_support_from_stage11507_probe_request/web_root_support_from_stage11507_probe_manifest.jsonl",
}
SOURCES = ["encoder_option_retrieval_evidence_judgment_head"]
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "web_support_train_score_complete",
        "runtime": rel(RUNTIME),
        "device": str(DEVICE),
        "results": results,
