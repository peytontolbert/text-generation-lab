#!/usr/bin/env python3
"""Score a loadable 100M bundle plus the counted Stage968 pair interface."""
...
def main() -> None:
    ...
    parser.add_argument("--output-json", type=Path, default=Path("runs/local/artifacts/stage981_100m_pair_interface_hybrid_summary.json"))
    ...
    policy_by_operation = {
        "atomic_fact": "base",
        "composition": "stage968_counted_pair_overlap",
        "counterfactual_false_claim": "base",
        "exception": "stage976_model_owned_blend",
        "relation": "stage968_counted_pair_overlap",
    }
    ...
    summary = {
        "artifact_kind": "stage981_100m_pair_interface_hybrid",
        "status": "completed_loadable_budgeted_hybrid_scorer",
        ...
        "decision": "Loadable scorer combining Stage976 100M model-owned exception residual with the Stage968 counted pair-overlap/count interface for composition and relation. This is budgeted-interface evidence, not bridge-free model-owned KBPP.",
    }
