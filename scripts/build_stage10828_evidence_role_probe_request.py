...
STAGE = 10828
NAME = "stage10828_evidence_role_probe_request"
OUT_DIR = ARTIFACTS / NAME
REQUEST_JSON = OUT_DIR / "evidence_role_probe_request.json"
COMMAND_JSON = OUT_DIR / "evidence_role_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "evidence_role_probe_manifest.jsonl"

PACKAGE_DIR = ARTIFACTS / "stage10827_evidence_role_augmented_support_package"
PACKAGE_JSON = PACKAGE_DIR / "evidence_role_augmented_support_package.json"
TRAIN_ROWS = PACKAGE_DIR / "agentkernel_lite_encdec_train.jsonl"
VALIDATION_ROWS = PACKAGE_DIR / "agentkernel_lite_encdec_validation.jsonl"
STRICT_ROWS = PACKAGE_DIR / "agentkernel_lite_encdec_strict_eval.jsonl"
STRESS_ROWS = PACKAGE_DIR / "agentkernel_lite_encdec_stress_eval.jsonl"
...
RUN_ID = "stage10829_evidence_role_support_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10829_evidence_role_support_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10829_evidence_role_support_probe/runtime_model"
...
def main() -> None:
    ...
    request = {
        ...
        "decision": "evidence_role_support_probe_ready",
        ...
        "claim_scope": [
            "Run a standalone support probe that adds semantic evidence-role train support on top of the current queue-aligned reviewed v2.7 package.",
            "Keep validation and strict rows unchanged so evidence_citation family movement can be audited honestly against the same frontier.",
        ],
        "required_honesty_gates": [
            "validation and strict rows remain unchanged from stage10814",
            "all evidence-role rows are train-support only",
            "post-run analysis must report evidence_citation and verifier_outcome family deltas separately",
            "any gain must still pass the repaired-overlay and scorer-alignment audits before promotion",
        ],
        ...
        "next_best_step": "Run the evidence-role support probe, then audit whether evidence_citation changes without harming the rest of the unchanged 24-row strict frontier.",
    }
