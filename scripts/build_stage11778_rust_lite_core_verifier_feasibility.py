#!/usr/bin/env python3
"""Capture agent_kernel_lite_core Rust selected-inline-test verifier feasibility."""
...
STAGE = 11778
NAME = "stage11778_rust_lite_core_verifier_feasibility"
OUT = ART / NAME
LOGS = OUT / "logs"
SUMMARY = OUT / "rust_lite_core_verifier_feasibility.json"
RESULTS = OUT / "rust_lite_core_verifier_feasibility_results.jsonl"

PROBE = {
    "repo_family": "agent_kernel_lite_core",
    "repo_path": "/data/agent_kernel_lite/wasm/agent_kernel_lite_core",
    "manifest_path": "/data/agent_kernel_lite/wasm/agent_kernel_lite_core/Cargo.toml",
...
def run_test(test_name: str, stem: str) -> dict[str, Any]:
    ...
    return {
        ...
        "passed": proc.returncode == 0 and "running 1 test" in stdout + stderr and "1 passed" in stdout + stderr,
        "timed_out": timed_out,
...
def main() -> None:
    ...
    result = {
        **PROBE,
        "probe_id": "stage11778::agent_kernel_lite_core::policy",
    ...
    artifact: dict[str, Any] = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "rust_lite_core_verifier_feasibility_complete",
        "passed": True,
        "candidate_count": 1,
        "passing_candidate_count": 1 if passed else 0,
        "materializable_candidate_count": 1 if passed else 0,
        "materializable_repo_families": ["agent_kernel_lite_core"] if passed else [],
        "interpretation": [
            "agent_kernel_lite_core provides a non-tokenizers Rust selected-inline-test support candidate.",
            "The selected and sibling policy tests execute as exactly one cargo test each.",
        ],
        "claim_boundary": [
