...
STAGE = 11504
NAME = "stage11504_sampler_fixed_evidence_judgment_head_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "sampler_fixed_evidence_judgment_head_postrun_audit.json"

RUNTIME = ART / "stage11503_sampler_fixed_evidence_judgment_head_probe/runtime_model/runtime_model_bundle.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "sampler_fixed_evidence_judgment_head_promoted" if promoted else "sampler_fixed_evidence_judgment_head_rejected_or_diagnostic_only",
        ...
        "comparison_to_stage11494_base_product": {
            ...
            "stage11503_filtered_strict": product["filtered_strict"]["correct"],
            "stage11494_old_canary_strict": prior_metric(prior, "old_canary_strict"),
            "stage11503_old_canary_strict": product["old_canary_strict"]["correct"],
            "stage11494_residual_bank": prior_metric(prior, "residual_bank"),
            "stage11503_residual_bank": product["residual_bank"]["correct"],
            "stage11503_bridge_train_rows": product["bridge_train_rows"]["correct"],
        },
        "decision_basis": [
            "Stage11503 reruns the existing evidence_judgment_head on the same Stage11492/11497 rows after fixing sampler coverage and switching to cyclic row coverage.",
