...
STAGE = 9375
NAME = "stage9375_route2_filepath_residual_probe_audit"
SOURCE_SUMMARY = ROOT / "runs/summaries/stage9374_route2_filepath_residual_probe_preexecution.json"
...
RUN_DIR = ROOT / "runs/local/artifacts/stage9375_route2_filepath_residual_probe"
AUDIT = RUN_DIR / "stage9375_route2_filepath_residual_probe_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "ROUTE2_FILEPATH_RESIDUAL_PROBE_AUDIT_STAGE9375.md"
...
def audit_run() -> dict[str, Any]:
    ...
    if source.get("passed") is not True:
        failures.append("source_stage9374_not_passed")
    ...
    if execution.get("denoise_ce_rows") != 26 or contract.get("loss_counts", {}).get("denoise_ce") != 26:
    ...
    quality_gate_passed = bool(generated == 26 and exact == 26 and target_prefix == 26 and boundary == 26 and contentful == 26 and repetition_rows == 0 and short_rows == 0 and leak_rows == 0)
    return {
        ...
        "diagnosis": "The route_2 numeric `preserves` omission and route_file_path `verified edit` substitution residuals passed in isolation.",
        "next_patch_target": "full_mixture_with_route2_filepath_repairs_manifest",
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "The route2/filepath residual repair probe passed exactly in isolation; decoder CE remains closed.",
        "next_best_step": "Merge Stage9373 rows back into the full mixture and rerun a closed rejoin probe before bounded decoder CE readiness.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage9375 Route2/Filepath Residual Probe Audit",
                "",
                ...
                "",
                "The isolated residual probe passed. Decoder CE and external authority remain closed.",
                "",
            ]
        ),
        encoding="utf-8",
