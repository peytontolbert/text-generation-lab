...
STAGE = 10760
NAME = 'stage10760_hf_local_repaired_support_probe_request'
OUT_DIR = ARTIFACTS / NAME
REQUEST_JSON = OUT_DIR / 'hf_local_repaired_support_probe_request.json'
COMMAND_JSON = OUT_DIR / 'hf_local_repaired_support_probe_command.json'
MANIFEST_JSONL = OUT_DIR / 'hf_local_repaired_support_probe_manifest.jsonl'
...
TRAIN_ROWS = ARTIFACTS / 'stage10759_reviewed_v27_hf_local_repaired_support_refresh' / 'agentkernel_lite_encdec_train.jsonl'
VALIDATION_ROWS = ARTIFACTS / 'stage10759_reviewed_v27_hf_local_repaired_support_refresh' / 'agentkernel_lite_encdec_validation.jsonl'
STRICT_ROWS = ARTIFACTS / 'stage10759_reviewed_v27_hf_local_repaired_support_refresh' / 'agentkernel_lite_encdec_strict_eval.jsonl'
STRESS_ROWS = ARTIFACTS / 'stage10759_reviewed_v27_hf_local_repaired_support_refresh' / 'agentkernel_lite_encdec_stress_eval.jsonl'
...
RUN_ID = 'stage10761_hf_local_repaired_support_probe'
OUTPUT_DIR = 'runs/local/artifacts/stage10761_hf_local_repaired_support_probe/bounded_decoder_probe'
RUNTIME_MODEL_DIR = 'runs/local/artifacts/stage10761_hf_local_repaired_support_probe/runtime_model'
...
def main() -> None:
    ...
    request = {
        ...
        'decision': 'hf_local_repaired_support_probe_ready',
        ...
        'claim_scope': [
            'Run a standalone support probe that keeps the reviewed v2.7 strict frontier fixed while replacing the compressed agentkernel Python residual lane with the repaired hf_local verifier-support lane.',
        ...
        'required_honesty_gates': [
            ...
            'repaired hf_local rows enter only as train_support refresh',
            'compressed agentkernel successor row is excluded from probe-ready train support',
        ...
        'next_best_step': 'run the probe, then audit whether the repaired hf_local support flips the remaining Python residual or otherwise improves strict performance without regressions',
    }
