#!/usr/bin/env python3
"""Build a bounded probe request for the stage11016 fresh-root extension."""
...
OUT_DIR = ROOT / "runs/local/artifacts/stage11017_fresh_root_extension_probe_request"
...
def main() -> None:
    ...
    validation_rows = read_jsonl(EXT_DIR / "agentkernel_lite_encdec_validation.jsonl")
    strict_rows = read_jsonl(EXT_DIR / "agentkernel_lite_encdec_strict_eval.jsonl")
    stress_rows = read_jsonl(EXT_DIR / "agentkernel_lite_encdec_stress_eval.jsonl")
    successor_eval_rows = read_jsonl(EXT_DIR / "agentkernel_lite_encdec_successor_eval.jsonl")

    manifest_rows = train_rows + validation_rows + strict_rows + stress_rows
    ...
    summary_path = OUT_DIR / "fresh_root_extension_probe_request.json"
    ...
    command = {
        "command": [
            ...
            "/data/agentkernel-seq2seq-text-lab/runs/local/artifacts/stage11018_fresh_root_extension_probe/runtime_model",
            ...
            "1",
            "--output-dir",
            "/data/agentkernel-seq2seq-text-lab/runs/local/artifacts/stage11018_fresh_root_extension_probe/bounded_decoder_probe",
            "--run-id",
            "stage11018_fresh_root_extension_probe",
        ]
    }
    ...
    summary = {
        "stage": 11017,
        "stage_name": "stage11017_fresh_root_extension_probe_request",
        "created_at_utc": datetime.now(timezone.utc).strftime("%Y-%m-%dT%H:%M:%SZ"),
        "passed": True,
        "decision": "fresh_root_extension_probe_requested",
        "claim_scope": [
            "Run one bounded support probe on the alias-safe reviewed-v2.7 extension package.",
        ...
        "outputs": {
            ...
            "probe_output_dir": "/data/agentkernel-seq2seq-text-lab/runs/local/artifacts/stage11018_fresh_root_extension_probe/bounded_decoder_probe",
            "runtime_model_dir": "/data/agentkernel-seq2seq-text-lab/runs/local/artifacts/stage11018_fresh_root_extension_probe/runtime_model",
