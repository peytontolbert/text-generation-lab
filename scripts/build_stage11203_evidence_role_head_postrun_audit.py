...
STAGE = 11203
NAME = "stage11203_evidence_role_head_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "evidence_role_head_postrun_audit.json"
...
def main() -> None:
    ...
    product_scorer = "encoder_option_retrieval_evidence_role_head"
    diagnostic_scorers = [
