...
STAGE = 11445
NAME = "stage11445_targeted_residual_role_support_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "root_purged_semantic_candidate_postrun_audit.json"
RUNTIME = ARTIFACTS / "stage11444_targeted_residual_role_support_probe/runtime_model/runtime_model_bundle.json"
REQUEST = ARTIFACTS / "stage11443_targeted_residual_role_support_probe_request/targeted_residual_role_support_probe_request.json"
PACKAGE = ARTIFACTS / "stage11442_targeted_residual_role_support_package/targeted_residual_role_support_package.json"
FILTERED_VALIDATION = ARTIFACTS / "stage11442_targeted_residual_role_support_package/agentkernel_lite_encdec_validation.jsonl"
FILTERED_STRICT = ARTIFACTS / "stage11442_targeted_residual_role_support_package/agentkernel_lite_encdec_strict_eval.jsonl"
RESIDUAL = ARTIFACTS / "stage11442_targeted_residual_role_support_package/semantic_candidate_residual_bank.jsonl"
...
SCORERS = ["encoder_option_retrieval_semantic_candidate_head", "encoder_option_retrieval", "decoder_first_step"]
PRODUCT_SCORER = "encoder_option_retrieval_semantic_candidate_head"
BASELINE_SCORER = "encoder_option_retrieval"
...
def main() -> None:
    ...
    base = scored[BASELINE_SCORER]
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "created_at_utc": now_utc(),
        "passed": True,
        "decision": "targeted_residual_role_support_probe_not_promoted_residual_regressed_despite_canary_gain",
        ...
        "promotion_gates": {
            ...
            "old_canary_base_strict_preserves_at_least_22_of_23": (base["old_canary_strict"].get("correct") or 0) >= 22,
            "coverage_full_for_product_residual": product["residual_bank"].get("coverage") == 1.0,
        },
        "decision_basis": [
            "This audit scores the targeted residual-role support runtime against filtered strict/eval, residual bank, and the original 23-row canary.",
            "Promotion requires residual improvement beyond the 5/10 base plateau and separate preservation of the original 23-row canary; this run improves canary strict to 23/23 but regresses residual to 4/10.",
            "This run is diagnostic-only; it validates root-purged/full-coverage evaluation plumbing but not a frontier gain.",
        ],
        "source_artifacts": {
    ...
    print(json.dumps({"decision": summary["decision"], "promotion_gates": summary["promotion_gates"], "product": product, "base_old_strict": base["old_canary_strict"]}, indent=2, sort_keys=True))
