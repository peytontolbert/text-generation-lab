#!/usr/bin/env python3
"""Refresh support supply after whisper.cpp C/C++ admission."""
...
STAGE = 11827
NAME = "stage11827_source_heldout_support_supply_status_v20"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v20.json"
...
RUST = ART / "stage11822_rust_verifier_support_combined_audit_v4/rust_verifier_support_combined_audit_v4.json"
...
def main() -> None:
    ...
    artifact = {
        ...
        "next_actions": [
            ...
            "Continue Rust verifier expansion beyond 5/12 roots.",
        ],
        "claim_boundary": [
