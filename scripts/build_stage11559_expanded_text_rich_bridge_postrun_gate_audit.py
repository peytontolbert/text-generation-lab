...
STAGE = 11559
NAME = "stage11559_expanded_text_rich_bridge_postrun_gate_audit"
OUT = ART / NAME
SUMMARY = OUT / "expanded_text_rich_bridge_postrun_gate_audit.json"

RUNTIME = ART / "stage11558_expanded_text_rich_web_evidence_bridge_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "expanded_text_rich_bridge_postrun_gate_promising" if all(gates.values()) else "text_rich_bridge_postrun_gate_not_promotable",
