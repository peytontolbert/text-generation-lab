...
STAGE = 10549
NAME = "stage10549_cuda_masked_projection_successor_same_manifest_comparison"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
SUMMARY_PATH = OUT_DIR / "cuda_masked_projection_successor_same_manifest_comparison.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Same-surface seq2seq generation on the strict rows from stage10543 using the stage10548 CUDA masked-projection successor runtime.",
