...
STAGE = 11605
NAME = "stage11605_web_task_candidate_head_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "web_task_candidate_head_probe_request.json"
MANIFEST = OUT / "web_task_candidate_head_probe_manifest.jsonl"
COMMAND = OUT / "web_task_candidate_head_probe_command.json"
...
PROBE = ART / "stage11605_web_task_candidate_head_probe/bounded_decoder_probe"
RUNTIME_OUT = ART / "stage11605_web_task_candidate_head_probe/runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "web_task_candidate_head_probe_ready" if all(gates.values()) else "web_task_candidate_head_probe_blocked",
        "metrics": {
        ...
        "command": command,
        "claim_boundary": [
            "This is a guarded probe of a separate Web task-candidate scorer head on answerable no-abstain Web geometry, not a promotion.",
