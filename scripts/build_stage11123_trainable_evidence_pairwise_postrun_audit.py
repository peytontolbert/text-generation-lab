...
STAGE = 11123
NAME = "stage11123_trainable_evidence_pairwise_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "trainable_evidence_pairwise_postrun_audit.json"
...
RUNTIME_BUNDLE = ARTIFACTS / "stage11122_trainable_evidence_pairwise_probe" / "runtime_model" / "runtime_model_bundle.json"
VALIDATION_JSON = ARTIFACTS / "stage11122_trainable_evidence_pairwise_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_eval.json"
STRICT_JSON = ARTIFACTS / "stage11122_trainable_evidence_pairwise_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_strict_eval.json"
EXECUTION_JSON = ARTIFACTS / "stage11122_trainable_evidence_pairwise_probe" / "bounded_decoder_probe" / "execution_result.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Audit the stage11122 persistent pairwise scorer runtime against unchanged successor validation/strict and untouched reserved residual candidates.",
            "Decide whether the pairwise scorer architecture moved the evidence lane beyond the stage11117 encoder-option-retrieval baseline.",
        ],
        "bounded_choice_aux_source": scorer_source,
        "source_artifacts": {
        ...
        "decision": (
            "pairwise_scorer_promotable_frontier_gain"
            if strict_gate and reserved_gate and reserved_evidence_gate
            else "pairwise_scorer_diagnostic_only_move_to_evidence_role_ledger_head_or_fresh_roots"
        ),
        "headline_findings": [
            "This is the first post-loader-fix audit of a saved pairwise scorer runtime on the latest trainable evidence package.",
