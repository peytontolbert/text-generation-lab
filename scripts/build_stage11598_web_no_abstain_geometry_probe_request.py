...
STAGE = 11598
NAME = "stage11598_web_no_abstain_geometry_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "web_no_abstain_geometry_probe_request.json"
MANIFEST = OUT / "web_no_abstain_geometry_probe_manifest.jsonl"
COMMAND = OUT / "web_no_abstain_geometry_probe_command.json"
...
PROBE = ART / "stage11598_web_no_abstain_geometry_probe/bounded_decoder_probe"
RUNTIME_OUT = ART / "stage11598_web_no_abstain_geometry_probe/runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "web_no_abstain_geometry_probe_ready" if all(gates.values()) else "web_no_abstain_geometry_probe_blocked",
        "metrics": {
        ...
        "command": command,
        "claim_boundary": [
            "This is a guarded probe on answerable no-abstain Web geometry, not a promotion.",
