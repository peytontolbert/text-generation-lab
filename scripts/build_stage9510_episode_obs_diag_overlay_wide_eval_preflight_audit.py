...
STAGE = 9510
NAME = "stage9510_episode_obs_diag_overlay_wide_eval_preflight_audit"
SOURCE_SUMMARY = ROOT / "runs/summaries/stage9509_episode_obs_diag_overlay_wide_eval_audit.json"
RUN_DIR = ROOT / "runs/local/artifacts/stage9510_episode_obs_diag_overlay_wide_eval_target_100m_contract_preflight"
CONTRACT = RUN_DIR / "probe_contract_audit.json"
AUDIT = RUN_DIR / "stage9510_preflight_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "EPISODE_OBS_DIAG_OVERLAY_WIDE_EVAL_PREFLIGHT_STAGE9510.md"
...
def main() -> None:
    ...
    if source.get("passed") is not True:
        failures.append("stage9509_not_passed")
    ...
    audit = {
        "passed": not failures,
        "failures": failures,
        "source_stage": "stage9509_episode_obs_diag_overlay_wide_eval_audit",
    ...
    summary = {
        ...
        "decision": "Contract-only target-100M preflight passed for the widened observation-diagnosis overlay manifest.",
        "next_best_step": "Run Stage9511 widened target-100M observation-diagnosis overlay probe under trellis, then audit best-state exactness across 6 eval and 6 strict rows.",
