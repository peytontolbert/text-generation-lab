...
STAGE = 10939
NAME = "stage10939_explicit_verifier_ledger_candidate_slice_comparison"
OUT_DIR = ROOT / "runs" / "local" / "artifacts" / NAME
SUMMARY_JSON = OUT_DIR / "explicit_verifier_ledger_candidate_slice_comparison.json"
...
STRICT_ROWS = ROOT / "runs" / "local" / "artifacts" / "stage10938_explicit_verifier_ledger_strict_candidates" / "strict_candidate_rows.jsonl"
RUNTIME_BUNDLE = ROOT / "runs" / "local" / "artifacts" / "stage10936_explicit_verifier_ledger_support_probe" / "runtime_model" / "runtime_model_bundle.json"
MODEL_ID = "gemma3:12b"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Diagnostic scoring only on the 3-row explicit-verifier-ledger successor candidate slice.",
            "This slice remains non-promotable and exists to test whether the prior stage10915 slice was under-materialized rather than whether the model is incapable of the reviewed verifier distinction.",
        ],
