...
STAGE = 11181
NAME = "stage11181_contract_evidence_support_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "contract_evidence_support_probe_request.json"
COMMAND_JSON = OUT_DIR / "contract_evidence_support_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "contract_evidence_support_probe_manifest.jsonl"
...
PROBE_OUT_DIR = ARTIFACTS / "stage11182_contract_evidence_support_probe/bounded_decoder_probe"
RUNTIME_OUT_DIR = ARTIFACTS / "stage11182_contract_evidence_support_probe/runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "contract_evidence_support_probe_requested",
        "claim_scope": [
            "Run one diagnostic bounded probe with stage11179 contract-aware evidence rows added to the current cleaned base.",
