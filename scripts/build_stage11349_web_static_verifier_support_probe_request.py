...
STAGE = 11349
NAME = "stage11349_web_static_verifier_support_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "web_static_verifier_support_probe_request.json"
CMD = OUT / "web_static_verifier_support_probe_command.json"
MAN = OUT / "web_static_verifier_support_probe_manifest.jsonl"
TRAIN = ART / "stage11347_web_static_verifier_maintainer_rows/web_static_verifier_train_support_rows.jsonl"
...
RUN = ART / "stage11350_web_static_verifier_support_probe"
...
def main() -> None:
    ...
    baseline = read_json(BASELINE).get("product_metrics", {}).get("web_static_verifier_train_support", {})
    cmd = [
    ...
    summary = {
        ...
        "passed": True,
        "decision": "web_static_verifier_support_probe_requested_diagnostic_only",
        "metrics": {
            "train_rows": len(train),
            "eval_rows": len(val),
            "strict_rows": len(strict),
            "root_overlaps": overlaps,
            "baseline_web_static_verifier_correct": baseline.get("correct"),
            "baseline_web_static_verifier_rows": baseline.get("rows"),
            "baseline_web_static_verifier_accuracy": baseline.get("exact_accuracy"),
        },
        "source_artifacts": {
            "train": rel(TRAIN),
        ...
        "promotion_gate": {
            ...
            "web_static_verifier_train_score_should_improve": "above 8/18 current-runtime baseline",
