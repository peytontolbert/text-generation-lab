...
STAGE = 11062
NAME = "stage11062_ready_lane_fresh_support_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "ready_lane_fresh_support_probe_request.json"
COMMAND_JSON = OUT_DIR / "ready_lane_fresh_support_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "ready_lane_fresh_support_probe_manifest.jsonl"

PACKAGE_DIR = ARTIFACTS / "stage11061_ready_lane_fresh_support_package"
PACKAGE_JSON = PACKAGE_DIR / "ready_lane_fresh_support_package.json"
...
HEURISTIC_ROWS = PACKAGE_DIR / "heuristic_support_rows.jsonl"
...
PROBE_OUT_DIR = ARTIFACTS / "stage11063_ready_lane_fresh_support_probe" / "bounded_decoder_probe"
RUNTIME_OUT_DIR = ARTIFACTS / "stage11063_ready_lane_fresh_support_probe" / "runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "ready_lane_fresh_support_probe_requested",
        "claim_scope": [
            "Run one bounded probe from the stage11061 fresh support package while preserving the unchanged 23-row successor overlay.",
            "Keep heuristic Rust evidence support out of promotable claims and continue reporting the untouched reserved residual bank separately.",
        ],
        "source_artifacts": {
        ...
        "metrics": {
            ...
            "fresh_rows_added": package.get("metrics", {}).get("rows_added_total"),
            "scoreable_packet_rows_added": package.get("metrics", {}).get("scoreable_packet_rows_added"),
        },
        "required_honesty_gates": [
            "Successor validation and strict remain the main scored overlay and must stay unchanged.",
            "Heuristic Rust evidence rows are train support only and cannot be used as heldout improvement evidence.",
            "Reserved candidate reporting must remain separate from both the successor overlay and the new ready-lane support rows.",
        ],
        "next_best_step": "Execute this request, then audit successor validation/strict and the reserved residual candidate bank in one postrun summary tied to the stage11061 package.",
        "outputs": {
