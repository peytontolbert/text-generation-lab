#!/usr/bin/env python3
"""Refresh support supply after PyTorch C/C++ sample admission."""
...
STAGE = 11785
NAME = "stage11785_source_heldout_support_supply_status_v9"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v9.json"

PYTHON = ART / "stage11776_python_verifier_support_combined_audit_v4/python_verifier_support_combined_audit_v4.json"
CPP = ART / "stage11784_cpp_abstain_support_combined_audit_v3/cpp_abstain_support_combined_audit_v3.json"
...
def main() -> None:
    ...
    artifact: dict[str, Any] = {
        ...
        "delta_since_stage11781": {
            "cpp_abstain_ready_roots_added": 1,
            "cpp_abstain_ready_rows_added": 4,
            "cpp_abstain_repo_families_added": 1,
        },
        "next_actions": [
            "Continue C/C++ build/verifier expansion beyond 3/16 roots.",
