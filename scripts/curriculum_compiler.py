...
def compile_rows(rows: list[dict[str, Any]], *, allow_decoder: bool, allow_denoise: bool, allow_runtime: bool) -> tuple[dict[str, list[dict[str, Any]]], dict[str, Any]]:
...
def main() -> None:
    args = parse_args()
    buckets, card = compile_rows(read_jsonl(args.input), allow_decoder=args.allow_decoder, allow_denoise=args.allow_denoise, allow_runtime=args.allow_runtime)
