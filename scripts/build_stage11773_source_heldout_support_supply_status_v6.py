#!/usr/bin/env python3
"""Refresh support supply after bitsandbytes Python admission."""
...
STAGE = 11773
NAME = "stage11773_source_heldout_support_supply_status_v6"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v6.json"

PYTHON = ART / "stage11772_python_verifier_support_combined_audit_v3/python_verifier_support_combined_audit_v3.json"
...
def main() -> None:
    ...
    artifact: dict[str, Any] = {
        ...
        "delta_since_stage11769": {
            "python_verifier_ready_roots_added": 1,
            "python_verifier_ready_rows_added": 4,
        },
        "next_actions": [
            "Continue Python verifier expansion beyond 4/12 roots.",
