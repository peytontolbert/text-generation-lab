...
STAGE = 11117
NAME = "stage11117_trainable_evidence_support_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "trainable_evidence_support_postrun_audit.json"
...
VALIDATION_JSON = ARTIFACTS / "stage11116_trainable_evidence_support_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_eval.json"
STRICT_JSON = ARTIFACTS / "stage11116_trainable_evidence_support_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_strict_eval.json"
EXECUTION_JSON = ARTIFACTS / "stage11116_trainable_evidence_support_probe" / "bounded_decoder_probe" / "execution_result.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Audit the stage11116 runtime against the unchanged successor validation/strict overlay and the untouched reserved residual candidate bank.",
            "Check anti-cheat overlap between the stage11114 trainable evidence support rows and the scored strict/reserved surfaces before making any claim.",
        ],
        "source_artifacts": {
        ...
        "headline_findings": [
            "This audit measures whether trainable, leak-audited evidence support moves the untouched successor overlay or only changes support geometry.",
