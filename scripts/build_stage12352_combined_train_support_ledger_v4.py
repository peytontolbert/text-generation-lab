...
BASE_SCRIPT = ROOT / "scripts/build_stage12344_combined_train_support_ledger_v3.py"
BASE_SUMMARY = ROOT / "runs/summaries/stage12344_combined_train_support_ledger_v3.json"
STAGE = "stage12352_combined_train_support_ledger_v4"
OUT = ROOT / "runs/local/artifacts" / STAGE
SUMMARY = ROOT / "runs/summaries" / f"{STAGE}.json"
EXTRA = ROOT / "runs/local/artifacts/stage12351_web_fallback_selected_test_admissions/web_fallback_selected_test_train_support_rows.jsonl"
...
def main() -> None:
    ...
    source_counts["stage12351_web_fallback_selected_test"] = len(extra_rows)
    ...
    ledger.update({
        "stage": STAGE,
        "decision": "combined_train_support_ledger_v4_ready_500_not_reached",
    ...
    (OUT / "combined_train_support_ledger_v4.json").write_text(json.dumps(ledger, indent=2, sort_keys=True) + "\n", encoding="utf-8")
