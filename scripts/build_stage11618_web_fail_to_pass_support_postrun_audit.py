...
STAGE = 11618
NAME = "stage11618_web_fail_to_pass_support_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_fail_to_pass_support_postrun_audit.json"

RUNTIME = ART / "stage11617_web_fail_to_pass_support_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
    ...
    "controlled_fail_to_pass_support": ART / "stage11615_web_mutation_rows_anticheat_audit/web_mutation_rows_admitted_train_support.jsonl",
...
def main() -> None:
    ...
    gates = {
        ...
        "web_heldout_beats_recent_42_of_66": (results["web_heldout"]["correct"] or 0) > 42 and results["web_heldout"]["rows"] == 66,
        "controlled_support_measured_full_coverage": results["controlled_fail_to_pass_support"]["coverage"] == 1.0 and results["controlled_fail_to_pass_support"]["rows"] == 36,
    ...
    decision = "promote_stage11617_candidate_web_frontier" if all(promotion_gates.values()) else "do_not_promote_stage11617_keep_stage11507"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "created_at_utc": now(),
        ...
        "baseline_reference": {
            ...
            "recent_best_nonpromotable_web": "42/66 or 45/66 depending slice, but with preservation regression",
        ...
        "claim_boundary": [
            "Controlled FAIL_TO_PASS support rows are train-support diagnostics only.",
            "Promotion requires Web heldout improvement and preservation of residual/canary gates.",
            "A Web successor or controlled-support gain without Web heldout movement is overfit, not frontier progress.",
        ],
    }
