...
STAGE = 10858
NAME = "stage10858_residual_family_rebalanced_probe_request_plus_python_materialized"
OUT_DIR = ARTIFACTS / NAME
REQUEST_JSON = OUT_DIR / "residual_family_rebalanced_probe_request_plus_python_materialized.json"
COMMAND_JSON = OUT_DIR / "residual_family_rebalanced_probe_command_plus_python_materialized.json"
MANIFEST_JSONL = OUT_DIR / "residual_family_rebalanced_probe_manifest_plus_python_materialized.jsonl"

PACKAGE_JSON = ARTIFACTS / "stage10856_residual_family_rebalanced_support_package_plus_python_materialized" / "residual_family_rebalanced_support_package_plus_python_materialized.json"
TRAIN_ROWS = ARTIFACTS / "stage10856_residual_family_rebalanced_support_package_plus_python_materialized" / "agentkernel_lite_encdec_train.jsonl"
VALIDATION_ROWS = ARTIFACTS / "stage10856_residual_family_rebalanced_support_package_plus_python_materialized" / "agentkernel_lite_encdec_validation.jsonl"
STRICT_ROWS = ARTIFACTS / "stage10856_residual_family_rebalanced_support_package_plus_python_materialized" / "agentkernel_lite_encdec_strict_eval.jsonl"
STRESS_ROWS = ARTIFACTS / "stage10856_residual_family_rebalanced_support_package_plus_python_materialized" / "agentkernel_lite_encdec_stress_eval.jsonl"
...
RUN_ID = "stage10859_residual_family_rebalanced_probe_plus_python_materialized"
OUTPUT_DIR = "runs/local/artifacts/stage10859_residual_family_rebalanced_probe_plus_python_materialized/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10859_residual_family_rebalanced_probe_plus_python_materialized/runtime_model"
...
def main() -> None:
    ...
    request = {
        ...
        "decision": "residual_family_rebalanced_probe_plus_python_materialized_ready",
        ...
        "claim_scope": [
            "Run a residual-family diagnostic probe from the updated support package that now includes the materialized Python verifier root.",
            "Keep frozen validation and strict overlays unchanged while checking whether the added Python geometry changes the heldout verifier decision boundary.",
        ],
        "required_honesty_gates": [
            "strict and validation rows remain unchanged from stage10856",
        ...
        "diagnostic_intent": {
            ...
            "materialized_python_root_included": True,
        ...
        "next_best_step": "Run the probe as diagnostic-only, then compare the saved runtime on the unchanged strict overlay and inspect whether the new Python materialized support root moves the verifier residual without regressions.",
    }
