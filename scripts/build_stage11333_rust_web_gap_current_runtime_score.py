...
STAGE = 11333
NAME = 'stage11333_rust_web_gap_current_runtime_score'
OUT = ART / NAME
SUMMARY = OUT / 'rust_web_gap_current_runtime_score.json'
...
def main() -> None:
    ...
    summary = {
        ...
        'passed': True,
        'decision': 'current_frontier_rust_web_gap_score_complete',
