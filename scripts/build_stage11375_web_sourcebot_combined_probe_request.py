...
STAGE = 11375
NAME = "stage11375_web_sourcebot_combined_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "web_sourcebot_combined_probe_request.json"
CMD = OUT / "web_sourcebot_combined_probe_command.json"
MAN = OUT / "web_sourcebot_combined_probe_manifest.jsonl"
TRAIN = ART / "stage11374_web_sourcebot_combined_current_score/web_sourcebot_combined_support_rows.jsonl"
...
RUN = ART / "stage11376_web_sourcebot_combined_probe"
...
def main() -> None:
    ...
    cmd = [
        ...
        "--decoder-ce-weight", "0.08",
        "--bounded-choice-aux-weight", "2.4",
        ...
        "--bounded-choice-contrast-weight", "0.8",
        "--bounded-choice-contrast-margin", "0.08",
        "--preservation-kl-weight", "1.25",
    ...
    summary = {
        ...
        "passed": True,
        "decision": "web_sourcebot_combined_probe_requested_diagnostic_only",
        "metrics": {
