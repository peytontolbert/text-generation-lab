...
STAGE = 10188
NAME = 'stage10188_saved_choice_aux_encoder_option_retrieval_target100m_execution_request'
OUT_DIR = ROOT / 'runs/local/artifacts' / NAME
REQUEST = OUT_DIR / 'saved_choice_aux_encoder_option_retrieval_target100m_execution_request.json'
COMMAND_JSON = OUT_DIR / 'saved_choice_aux_encoder_option_retrieval_target100m_command.json'
MANIFEST = OUT_DIR / 'saved_choice_aux_encoder_option_retrieval_target100m_manifest.jsonl'
...
RUN_ID = 'stage10189_saved_choice_aux_encoder_option_retrieval_target100m_probe'
OUTPUT_DIR = 'runs/local/artifacts/stage10189_saved_choice_aux_encoder_option_retrieval_target100m_probe/bounded_decoder_probe'
RUNTIME_MODEL_DIR = 'runs/local/artifacts/stage10189_saved_choice_aux_encoder_option_retrieval_target100m_probe/runtime_model'
...
def build_request() -> dict[str, Any]:
    ...
    req = {
        ...
        'artifact_purpose': 'saved bounded-choice frontier runtime for first-wave maintainer harness repair',
        'required_honesty_gates': [
            ...
            'encoder_option_retrieval is diagnostic and does not replace real maintainer bundle adjudication',
        ],
    }
