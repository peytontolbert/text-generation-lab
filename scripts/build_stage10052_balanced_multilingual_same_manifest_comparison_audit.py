...
STAGE = 10052
NAME = "stage10052_balanced_multilingual_same_manifest_comparison_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT = OUT_DIR / "balanced_multilingual_same_manifest_comparison_audit.json"
ROWS = OUT_DIR / "balanced_multilingual_same_manifest_comparison_rows.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "BALANCED_MULTILINGUAL_SAME_MANIFEST_COMPARISON_AUDIT_STAGE10052.md"
...
BASELINE_HUNDRED_M = ROOT / "runs/local/artifacts/stage10048_python_symbol_test_target100m_probe/edit_localization_probe/row_field_logits.jsonl"
SUCCESSOR_HUNDRED_M = ROOT / "runs/local/artifacts/stage10051_balanced_multilingual_target100m_probe/edit_localization_probe/row_field_logits.jsonl"
...
def main() -> None:
    ...
    next_step = "Use this audit to decide whether the balanced multilingual packet restores the honest macro frontier while preserving the Python win over Gemma."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Materialized the same-manifest comparison audit for the balanced multilingual successor run so the resulting 100M outputs can be judged directly against both stage10048 and the fixed Gemma comparator.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage10052 Balanced Multilingual Same Manifest Comparison Audit",
                "",
