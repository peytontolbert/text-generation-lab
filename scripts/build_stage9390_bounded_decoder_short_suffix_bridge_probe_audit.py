...
STAGE = 9390
NAME = "stage9390_bounded_decoder_short_suffix_bridge_probe_audit"
SOURCE_SUMMARY = ROOT / "runs/summaries/stage9389_bounded_decoder_short_suffix_bridge_preexecution.json"
...
RUN_DIR = ROOT / "runs/local/artifacts/stage9390_bounded_decoder_short_suffix_bridge_probe"
AUDIT = RUN_DIR / "stage9390_bounded_decoder_short_suffix_bridge_probe_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "BOUNDED_DECODER_SHORT_SUFFIX_BRIDGE_PROBE_AUDIT_STAGE9390.md"
...
def audit_run() -> dict[str, Any]:
    ...
    if source.get("passed") is not True:
        failures.append("source_stage9389_not_passed")
    ...
    next_patch_target = "rejoin_short_suffix_bridge_or_expand_suffix_window" if quality_gate_passed else "inspect_short_suffix_residual_buckets"
    return {
        ...
        "diagnosis": "short_suffix_bridge_probe_completed" if quality_gate_passed else "short_suffix_bridge_quality_not_passing",
...
def main() -> None:
    ...
    next_step = "Merge the short-suffix bridge back into the bounded decoder repair path or expand the suffix window." if audit["quality_gate_passed"] else "Inspect short-suffix residual buckets and patch the smallest failing continuation family."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Audited the short-suffix bridge probe for bounded decoder failure repair; decoder CE remains closed.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage9390 Bounded Decoder Short-Suffix Bridge Probe Audit",
                "",
