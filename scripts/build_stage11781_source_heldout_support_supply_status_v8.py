#!/usr/bin/env python3
"""Refresh support supply after agent_kernel_lite_core Rust admission."""
...
STAGE = 11781
NAME = "stage11781_source_heldout_support_supply_status_v8"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v8.json"

PYTHON = ART / "stage11776_python_verifier_support_combined_audit_v4/python_verifier_support_combined_audit_v4.json"
CPP = ART / "stage11768_cpp_abstain_support_combined_audit_v2/cpp_abstain_support_combined_audit_v2.json"
RUST = ART / "stage11780_rust_verifier_support_combined_audit_v2/rust_verifier_support_combined_audit_v2.json"
...
def main() -> None:
    ...
    artifact: dict[str, Any] = {
        ...
        "delta_since_stage11777": {
            "rust_verifier_ready_roots_added": 1,
            "rust_verifier_ready_rows_added": 4,
            "rust_verifier_repo_families_added": 1,
        },
        "next_actions": [
            "Continue Rust verifier expansion beyond 3/12 roots.",
            "Continue C/C++ build/verifier expansion beyond 2/16 roots.",
            "Continue Python verifier expansion beyond 5/12 roots.",
        ],
        "claim_boundary": [
