...
STAGE = 11115
NAME = "stage11115_trainable_evidence_support_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "trainable_evidence_support_probe_request.json"
COMMAND_JSON = OUT_DIR / "trainable_evidence_support_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "trainable_evidence_support_probe_manifest.jsonl"
...
PROBE_OUT_DIR = ARTIFACTS / "stage11116_trainable_evidence_support_probe" / "bounded_decoder_probe"
RUNTIME_OUT_DIR = ARTIFACTS / "stage11116_trainable_evidence_support_probe" / "runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "trainable_evidence_support_probe_requested",
        "claim_scope": [
            "Run one bounded probe from the stage11114 package with admitted evidence rows that satisfy the trainer loss contract.",
        ...
        "required_honesty_gates": [
            ...
            "This request uses the last compatible encoder_option_retrieval runtime bundle and is pinned to GPU 2 to avoid unrelated GPU 0/1 jobs.",
        ],
        "next_best_step": "Execute this request, then audit successor validation/strict plus the reserved residual bank.",
        "outputs": {
