...
STAGE = 11374
NAME = "stage11374_web_sourcebot_combined_current_score"
OUT = ART / NAME
SUMMARY = OUT / "web_sourcebot_combined_current_score.json"
COMBINED = OUT / "web_sourcebot_combined_support_rows.jsonl"
RUNTIME = ART / "stage11200_role_focused_residual_probe/runtime_model/runtime_model_bundle.json"
SPLITS = {
    "sourcebot_combined_support": COMBINED,
...
SOURCEBOT_PARTS = [
    ART / "stage11364_web_sourcebot_executed_support_rows/web_sourcebot_executed_support_rows.jsonl",
    ART / "stage11373_web_sourcebot_extra_support_rows/web_sourcebot_extra_support_rows.jsonl",
]
SCORERS = ["encoder_option_retrieval_evidence_judgment_head", "encoder_option_retrieval", "decoder_first_step"]
...
def main() -> None:
    ...
    for scorer in SCORERS:
        ...
        for split_name, path in SPLITS.items():
            ...
            scored[scorer][split_name] = {"metric": metric(card)}
    ...
    summary = {
        ...
        "passed": True,
        "decision": "web_sourcebot_combined_current_score_complete",
        ...
        "scored": scored,
        "source_artifacts": {"runtime": rel(RUNTIME), "combined_rows": rel(COMBINED), **{f"sourcebot_part_{i}": rel(p) for i, p in enumerate(SOURCEBOT_PARTS, start=1)}},
