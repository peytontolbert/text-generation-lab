...
STAGE = 11250
NAME = "stage11250_fact_rich_evidence_option_baseline_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "fact_rich_evidence_option_baseline_audit.json"
...
SCORERS = ["encoder_option_retrieval_verifier_conditioned"]
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "fact_rich_baseline_audit_complete",
