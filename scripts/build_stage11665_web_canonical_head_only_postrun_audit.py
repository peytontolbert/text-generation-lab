...
STAGE = 11665
NAME = "stage11665_web_canonical_head_only_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_canonical_head_only_postrun_audit.json"

RUNTIME = ART / "stage11664_web_canonical_head_only_probe/runtime_model/runtime_model_bundle.json"
TRAIN_LOG = ART / "stage11664_web_canonical_head_only_probe/bounded_decoder_probe/loss_by_step.jsonl"
ROWSETS = {
...
def main() -> None:
    ...
    if not preservation_ok:
        decision = "web_canonical_head_only_rejected_protected_gate_regression"
    elif gates["original_web_heldout_beats_gemma_52_of_66"]:
        decision = "web_canonical_head_only_beats_original_web_gemma_but_requires_external_validation"
    elif gates["original_web_heldout_beats_routed_38_of_66"]:
        decision = "web_canonical_head_only_improves_original_web_heldout"
    elif gates["canonical_heldout_beats_routed_38_of_66"]:
        decision = "web_canonical_head_only_improves_canonical_heldout_only"
    elif gates["canonical_train_support_at_least_300_of_334"]:
        decision = "web_canonical_head_only_support_fit_without_frontier_gain"
    else:
        decision = "web_canonical_head_only_no_support_or_heldout_gain"
    ...
    summary = {
        ...
        "claim_boundary": [
            "Stage11664 is a head-only diagnostic on canonical-rendered Web rows.",
