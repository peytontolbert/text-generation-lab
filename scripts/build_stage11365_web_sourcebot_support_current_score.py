...
STAGE = 11365
NAME = "stage11365_web_sourcebot_support_current_score"
OUT = ART / NAME
SUMMARY = OUT / "web_sourcebot_support_current_score.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "web_sourcebot_support_current_score_complete",
        ...
        "recommended_next_action": "If sourcebot support is not saturated, train only on sourcebot support and evaluate sealed llama-stack heldout plus canaries.",
    }
