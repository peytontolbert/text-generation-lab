...
STAGE = 9904
NAME = "stage9904_current_margin_locality_signal_neutral_label_target_100m_probe"
MANIFEST = ROOT / "runs/local/artifacts/stage9903_current_margin_locality_signal_neutral_label_manifest/current_margin_locality_signal_neutral_label_manifest.jsonl"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
RUN_DIR = OUT_DIR / "edit_localization_probe"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "CURRENT_MARGIN_LOCALITY_SIGNAL_NEUTRAL_LABEL_TARGET_100M_PROBE_STAGE9904.md"
AUDIT = OUT_DIR / "current_margin_locality_signal_neutral_label_target_100m_probe_audit.json"
...
def main() -> None:
    ...
    next_step = "Audit the Stage9904 neutral-label probe against stages 9892 and 9894 to determine whether a geometry-neutral output vocabulary converts the locality signal into a real exact-match lift."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "metrics": {
            **dict(AUTHORITY_CLOSED),
            "trainer_returncode": audit["trainer_returncode"],
            "runtime_executed": audit["runtime_executed"],
            "required_row_artifacts_present": audit["required_row_artifacts_present"],
        },
        "artifacts": {
        ...
        "decision": "Executed the locality-lifted current-frontier control on a neutral A/B/C/D output vocabulary so the remaining performance gap can be attributed to model geometry or head behavior rather than packet semantics or label identity.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage9904 Current Margin Locality Signal Neutral Label Target-100M Probe",
                "",
