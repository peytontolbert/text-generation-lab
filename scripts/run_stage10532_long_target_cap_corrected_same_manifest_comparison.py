...
STAGE = 10532
NAME = "stage10532_long_target_cap_corrected_same_manifest_comparison"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
SUMMARY_PATH = OUT_DIR / "long_target_cap_corrected_same_manifest_comparison.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Same-surface seq2seq generation on the heldout-safe strict rows from stage10528 using the stage10531 long-target-cap-corrected runtime.",
