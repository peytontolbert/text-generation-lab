...
STAGE = 10355
NAME = "stage10355_preserved_citation_plus_pythonverifier_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
MANIFEST_JSONL = OUT_DIR / "preserved_citation_plus_pythonverifier_manifest.jsonl"
REQUEST_JSON = OUT_DIR / "preserved_citation_plus_pythonverifier_execution_request.json"
COMMAND_JSON = OUT_DIR / "preserved_citation_plus_pythonverifier_command.json"
...
RUN_ID = "stage10356_preserved_citation_plus_pythonverifier_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10356_preserved_citation_plus_pythonverifier_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10356_preserved_citation_plus_pythonverifier_probe/runtime_model"
MAX_STEPS = 24
LEARNING_RATE = "8e-6"
BATCH_SIZE = 2
...
def main() -> None:
    ...
    request = {
        ...
        "next_best_step": "run one preservation-enabled citation augmentation probe plus extra python verifier support and check whether the recurring python verifier collapse is eliminated while citation families remain the only drifting rows",
        "preservation": {
