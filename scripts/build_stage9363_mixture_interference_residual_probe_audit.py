...
STAGE = 9363
NAME = "stage9363_mixture_interference_residual_probe_audit"
SOURCE_SUMMARY = ROOT / "runs/summaries/stage9362_mixture_interference_residual_probe_preexecution.json"
...
RUN_DIR = ROOT / "runs/local/artifacts/stage9363_mixture_interference_residual_probe"
AUDIT = RUN_DIR / "stage9363_mixture_interference_residual_probe_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "MIXTURE_INTERFERENCE_RESIDUAL_PROBE_AUDIT_STAGE9363.md"
...
def audit_run() -> dict[str, Any]:
    ...
    if source.get("passed") is not True:
        failures.append("source_stage9362_not_passed")
    ...
    if execution.get("denoise_ce_rows") != 55 or contract.get("loss_counts", {}).get("denoise_ce") != 55:
    ...
    quality_gate_passed = bool(generated == 55 and exact == 55 and target_prefix == 55 and boundary == 55 and contentful == 55 and repetition_rows == 0 and short_rows == 0 and leak_rows == 0)
    return {
        ...
        "diagnosis": "mixture-interference residual repair rows solved route_1 verified-patch-operator and route_file_path localized-edit residuals in isolation.",
        "next_patch_target": "full_mixture_with_mixture_interference_residual_repairs_manifest",
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "The mixture-interference residual repair probe passed exactly in isolation; decoder CE remains closed.",
        "next_best_step": "Merge Stage9361 rows back into the full mixture and rerun a closed rejoin probe before any bounded decoder CE step.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage9363 Mixture Interference Residual Probe Audit",
                "",
                ...
                "",
                "The isolated residuals passed. Decoder CE and external authority remain closed.",
                "",
            ]
        ),
        encoding="utf-8",
