...
STAGE = 11508
NAME = "stage11508_preservation_strengthened_evidence_judgment_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "preservation_strengthened_evidence_judgment_postrun_audit.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "preservation_strengthened_evidence_judgment_head_promoted" if promoted else "preservation_strengthened_evidence_judgment_head_rejected_or_diagnostic_only",
        ...
        "comparison_to_stage11494_base_product": {
            ...
            "stage11507_filtered_strict": product["filtered_strict"]["correct"],
            "stage11494_old_canary_strict": prior_metric(prior, "old_canary_strict"),
            "stage11507_old_canary_strict": product["old_canary_strict"]["correct"],
            "stage11494_residual_bank": prior_metric(prior, "residual_bank"),
            "stage11507_residual_bank": product["residual_bank"]["correct"],
            "stage11507_bridge_train_rows": product["bridge_train_rows"]["correct"],
        },
        "decision_basis": [
            "Stage11507 repeats the sampler-fixed cyclic evidence_judgment_head probe with preservation KL increased from 0.5 to 1.5.",
