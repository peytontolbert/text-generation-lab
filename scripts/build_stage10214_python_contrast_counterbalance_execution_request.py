...
STAGE = 10214
NAME = "stage10214_python_contrast_counterbalance_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST = OUT_DIR / "python_contrast_counterbalance_execution_request.json"
COMMAND_JSON = OUT_DIR / "python_contrast_counterbalance_command.json"
MANIFEST = OUT_DIR / "python_contrast_counterbalance_manifest.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
PACKAGE = ROOT / "runs/local/artifacts/stage10213_python_contrast_counterbalance_package/python_contrast_counterbalance_package.json"
...
RUN_ID = "stage10215_python_contrast_counterbalance_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10215_python_contrast_counterbalance_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10215_python_contrast_counterbalance_probe/runtime_model"
...
def build_request() -> dict[str, Any]:
    ...
    request = {
        ...
        "artifact_purpose": "warm-started python label-prior counterbalance probe layered on the stage10200 targeted contrast package",
        "required_honesty_gates": [
            "strict eval rows must remain identical to stage10200 and stage10149",
            "python counterbalance rows remain train-only and auxiliary",
            "warm-start runtime initialization must come exactly from stage10202",
