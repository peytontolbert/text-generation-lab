...
STAGE = 9795
NAME = "stage9795_opaque_choice_counterfactual_anti_cheat_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT = OUT_DIR / "opaque_choice_counterfactual_anti_cheat_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "OPAQUE_CHOICE_COUNTERFACTUAL_ANTI_CHEAT_AUDIT_STAGE9795.md"
...
GEMMA_ROWS = ROOT / "runs/local/artifacts/stage9793_edit_localization_opaque_choice_gemma_comparison/edit_localization_opaque_choice_gemma_rows.jsonl"
GEMMA_AUDIT = ROOT / "runs/local/artifacts/stage9793_edit_localization_opaque_choice_gemma_comparison/edit_localization_opaque_choice_gemma_comparison.json"
        ...
        records.append(
            {
                ...
                "manifest_hash": load_json(ROOT / "runs/local/artifacts/stage9794_edit_localization_opaque_choice_exec_stable_labels/probe_contract_audit.json").get("manifest_sha256"),
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "Packaged the corrected opaque-choice multilingual win into counterfactual anti-cheat cards with real Stage9794 100M row outputs, real Stage9793 Gemma row outputs, prompt-surface leakage checks, split-stable mapping checks, shallow baselines, and transformed prompt probes.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage9795 Opaque Choice Counterfactual Anti Cheat Audit",
                "",
                ...
                "",
                "This stage does not promote the result to general intelligence. It packages the corrected opaque-choice multilingual edit-localization win with the anti-cheat and counterfactual evidence needed to judge whether the score survives prompt leakage checks, label-order changes, decoy mentions, evidence ablations, and causal swaps.",
                "",
                f"Next: {next_step}",
                "",
            ]
