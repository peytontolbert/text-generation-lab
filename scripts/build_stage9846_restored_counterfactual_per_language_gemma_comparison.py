...
STAGE = 9846
NAME = "stage9846_restored_counterfactual_per_language_gemma_comparison"
MANIFEST = ROOT / "runs/local/artifacts/stage9844_restored_counterfactual_probe_manifest/restored_counterfactual_probe_manifest.jsonl"
ROWS_100M = ROOT / "runs/local/artifacts/stage9845_direct_restored_counterfactual_exec/row_field_logits.jsonl"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
ROWS_OUT = OUT_DIR / "restored_counterfactual_gemma_rows.jsonl"
AUDIT = OUT_DIR / "restored_counterfactual_per_language_gemma_comparison.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "RESTORED_COUNTERFACTUAL_PER_LANGUAGE_GEMMA_COMPARISON_STAGE9846.md"
...
_row_text = _load_symbol("stage9846_training_data", ROOT / "legacy_src/agentkernel_lite/training_data.py", "_row_text")
...
def main() -> None:
    ...
    next_step = "Use this restored counterfactual comparison to decide whether the 100M win survives evidence removal and contradictory causal flips, then fold the result back into the anti-cheat review packet."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Ran local Gemma on the restored evidence-removed and contradictory-evidence multilingual probe and compared it against the direct row-level 100M outputs on the same harder counterfactual packet.",
