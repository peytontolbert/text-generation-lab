...
STAGE = 10812
NAME = "stage10812_reviewed_v27_plus_cpp_queue_support_package"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
PACKAGE_JSON = OUT_DIR / "reviewed_v27_plus_cpp_queue_support_package.json"
ROOT_MANIFEST_JSONL = OUT_DIR / "reviewed_v27_plus_cpp_queue_root_manifest.jsonl"
ROWS_JSONL = OUT_DIR / "reviewed_v27_plus_cpp_queue_bounded_rows.jsonl"
...
BASE_PACKAGE = ROOT / "runs/local/artifacts/stage10735_reviewed_v27_plus_cpp_train_support_package/reviewed_v27_plus_cpp_train_support_package.json"
BASE_ROOTS = ROOT / "runs/local/artifacts/stage10735_reviewed_v27_plus_cpp_train_support_package/reviewed_v27_plus_cpp_root_manifest.jsonl"
BASE_ROWS = ROOT / "runs/local/artifacts/stage10735_reviewed_v27_plus_cpp_train_support_package/reviewed_v27_plus_cpp_bounded_rows.jsonl"
BASE_TRAIN = ROOT / "runs/local/artifacts/stage10735_reviewed_v27_plus_cpp_train_support_package/agentkernel_lite_encdec_train.jsonl"
BASE_VALIDATION = ROOT / "runs/local/artifacts/stage10735_reviewed_v27_plus_cpp_train_support_package/agentkernel_lite_encdec_validation.jsonl"
BASE_STRICT = ROOT / "runs/local/artifacts/stage10735_reviewed_v27_plus_cpp_train_support_package/agentkernel_lite_encdec_strict_eval.jsonl"
BASE_STRESS = ROOT / "runs/local/artifacts/stage10735_reviewed_v27_plus_cpp_train_support_package/agentkernel_lite_encdec_stress_eval.jsonl"

CPP_ADMISSION = ROOT / "runs/local/artifacts/stage10811_cpp_queue_aligned_admission/cpp_queue_aligned_admitted_manifest.json"
CPP_ROOTS = ROOT / "runs/local/artifacts/stage10811_cpp_queue_aligned_admission/cpp_queue_aligned_root_manifest.jsonl"
...
def compile_cpp_row(bundle: dict[str, Any], root_meta: dict[str, Any], gold: dict[str, Any]) -> dict[str, Any] | None:
    ...
    return {
        ...
        "anti_cheat": {
            ...
            "bootstrap_execution_backed_cpp_bundle": True,
...
def main() -> None:
    ...
    if admission.get("passed") is not True:
        raise SystemExit("stage10811_not_passed")
    ...
    payload = {
        ...
        "passed": True,
        "decision": "reviewed_v27_extended_with_queue_aligned_cpp_support_roots",
        "claim_boundary": [
            "The strict and stress evaluation sets remain unchanged from the prior reviewed v2.7 support package.",
            "The newly added queue-aligned bootstrap C/C++ roots are admitted for train-support use only and are not same-surface admissible yet.",
        ...
        "source_artifacts": {
            ...
            "cpp_queue_aligned_admission": display(CPP_ADMISSION),
            "cpp_queue_aligned_root_manifest": display(CPP_ROOTS),
        },
        "delta_from_stage10735": {
        ...
        "next_best_step": "Use this queue-aligned reviewed support package as the C/C++ lane input to the next broader multilingual support/probe refresh, while keeping strict eval unchanged.",
    }
