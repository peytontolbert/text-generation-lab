...
STAGE = 11642
NAME = "stage11642_normalized_web_head_only_fit_request"
OUT = ART / NAME
...
PROBE = ART / "stage11642_normalized_web_head_only_fit/bounded_decoder_probe"
RUNTIME_OUT = ART / "stage11642_normalized_web_head_only_fit/runtime_model"
...
def normalize(row: dict[str, Any], split: str) -> dict[str, Any]:
    ...
    out["loss_mask"] = {"decoder_ce": False, "bounded_choice_aux": True}
...
def main() -> None:
    ...
    summary = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "normalized_web_head_only_fit_ready" if all(gates.values()) else "normalized_web_head_only_fit_blocked",
        "gates": gates,
        "metrics": {
        ...
        "claim_boundary": [
            "This is a non-promotable representability probe.",
