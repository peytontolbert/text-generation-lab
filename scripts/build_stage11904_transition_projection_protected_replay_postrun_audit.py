...
STAGE = 11904
NAME = "stage11904_transition_projection_protected_replay_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "transition_projection_protected_replay_postrun_audit.json"
...
RUNTIMES = {
    ...
    "stage11903_transition_projection_protected_replay": ART / "stage11903_transition_projection_protected_replay_probe/runtime_model/runtime_model_bundle.json",
}
PROTECTED_ROWSETS = {
...
def main() -> None:
    ...
    postrun_all = results["stage11903_transition_projection_protected_replay"]["all_transition_projection_rows"]
    protected = results["stage11903_transition_projection_protected_replay"]
    gates = {
    ...
    if gates["projection_fit_improved"] and gates["projection_fit_at_least_320_of_640"]:
        decision = "transition_projection_protected_replay_learned_interface"
    elif gates["projection_fit_improved"]:
        decision = "transition_projection_protected_replay_partial_fit"
    else:
        decision = "transition_projection_protected_replay_no_fit_gain"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "created_at_utc": now(),
        ...
        "claim_boundary": [
            ...
            "Stage11903 is non-promotable because it trains on protected replay rows.",
