...
STAGE = 11336
NAME = 'stage11336_web_alias_free_support_postrun_audit'
OUT = ART / NAME
SUMMARY = OUT / 'web_alias_free_support_postrun_audit.json'
RUNTIME = ART / 'stage11335_web_alias_free_support_probe/runtime_model/runtime_model_bundle.json'
SPLITS = {
...
def main() -> None:
    ...
    summary = {
        ...
        'passed': True,
        'decision': 'web_alias_free_support_postrun_audit_complete',
