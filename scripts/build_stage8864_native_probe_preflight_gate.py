...
def build_rows() -> list[dict[str, object]]:
    return [
        {
            "probe_id": "stage8869_tiny_structured_policy_probe_candidate",
            ...
            "output_dir": "runs/local/probes/stage8869_tiny_structured_policy_probe_candidate",
            "max_train_rows": 32,
            "max_eval_rows": 16,
            "max_strict_rows": 16,
            "max_steps": 8,
...
def main() -> None:
    ...
    card = {
        ...
        "next_best_step": "If explicitly authorized, run only the tiny Stage8869 structured-policy probe candidate and immediately audit its output with scripts/native_probe_interpretability_artifact_contract.py. Keep decoder CE closed.",
