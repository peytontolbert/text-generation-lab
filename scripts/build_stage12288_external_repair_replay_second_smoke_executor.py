...
STAGE='stage12288_external_repair_replay_second_smoke_executor'
TARGETS=ROOT/'runs/local/artifacts/stage12287_external_repair_replay_second_smoke_request/second_smoke_targets.jsonl'
ORIGINAL=ROOT/'runs/local/artifacts/stage12244_external_repair_commit_pair_replay_request/replay_targets.jsonl'
WORK_ROOT=Path('/data/tmp/stage12287_external_repair_replay_second_smoke')
