...
BASE = ROOT / 'runs/local/artifacts/stage8695_v27_context_packer_graph_attachment/central_research_graph_with_context_packer.json'
SOURCE = ROOT / 'runs/summaries/stage8700_low_level_training_mechanics_spine_patch.json'
STAGE = 8701
NAME = 'stage8701_v27_low_level_training_mechanics_graph_attachment'
