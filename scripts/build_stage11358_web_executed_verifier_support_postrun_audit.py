...
STAGE = 11358
NAME = "stage11358_web_executed_verifier_support_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_executed_verifier_support_postrun_audit.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "web_executed_verifier_support_postrun_audit_complete",
        ...
        "recommended_next_action": "Accept Stage11357 only as diagnostic/support if executed-verifier support improves above 6/12 and canary strict remains 22/22 with validation >=20/23.",
    }
