#!/usr/bin/env python3
"""Audit Stage11940 joint semantic+transition candidate-head runtime."""
...
STAGE = 11941
NAME = "stage11941_transition_joint_candidate_heads_routed_audit"
OUT = ART / NAME
SUMMARY = OUT / "transition_joint_candidate_heads_routed_audit.json"
...
RUNTIMES = {
    ...
    "stage11940_transition_joint_candidate_heads": ART / "stage11940_transition_joint_candidate_heads_probe/runtime_model/runtime_model_bundle.json",
}
PROTECTED_ROWSETS = {
...
TRANSITION_SCORERS = {
    ...
    "stage11940_transition_joint_candidate_heads": "encoder_option_retrieval_semantic_plus_transition_candidate_head",
}
...
def main() -> None:
    ...
    postrun = results["stage11940_transition_joint_candidate_heads"]
    gates = {
    ...
    if protected_ok and gates["transition_projection_at_least_gemma_386_of_640"]:
        decision = "transition_joint_candidate_heads_promotable_pending_same_manifest_gemma_attachment"
    elif protected_ok and gates["transition_projection_improved_vs_stage11924"]:
        decision = "transition_joint_candidate_heads_improved_but_not_gemma_beating"
    elif protected_ok:
        decision = "transition_joint_candidate_heads_preserved_but_no_frontier_gain"
    else:
        decision = "transition_joint_candidate_heads_rejected_protected_regression"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "created_at_utc": now(),
