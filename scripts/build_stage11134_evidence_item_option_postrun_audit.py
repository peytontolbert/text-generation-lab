...
STAGE = 11134
NAME = "stage11134_evidence_item_option_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "evidence_item_option_postrun_audit.json"
...
VALIDATION_JSON = ARTIFACTS / "stage11133_evidence_item_option_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_eval.json"
STRICT_JSON = ARTIFACTS / "stage11133_evidence_item_option_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_strict_eval.json"
EXECUTION_JSON = ARTIFACTS / "stage11133_evidence_item_option_probe" / "bounded_decoder_probe" / "execution_result.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Audit the stage11133 evidence-item option runtime against unchanged successor validation/strict and untouched reserved residual candidates.",
            "This tests visible evidence-item option geometry, not role-name support or a custom scorer head.",
        ],
        "bounded_choice_aux_source": scorer_source,
        "source_artifacts": {
        ...
        "decision": (
            "evidence_item_option_probe_promotable_frontier_gain"
            if strict_gate and validation_gate and reserved_gate and reserved_evidence_gate
            else "evidence_item_option_probe_diagnostic_only"
        ),
        "runtime_bundle": {
