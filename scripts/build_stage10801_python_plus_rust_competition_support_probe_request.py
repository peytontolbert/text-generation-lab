...
STAGE = 10801
NAME = 'stage10801_python_plus_rust_competition_support_probe_request'
OUT_DIR = ARTIFACTS / NAME
REQUEST_JSON = OUT_DIR / 'python_plus_rust_competition_support_probe_request.json'
COMMAND_JSON = OUT_DIR / 'python_plus_rust_competition_support_probe_command.json'
MANIFEST_JSONL = OUT_DIR / 'python_plus_rust_competition_support_probe_manifest.jsonl'

PACKAGE_JSON = ARTIFACTS / 'stage10799_python_plus_rust_competition_support_package' / 'python_plus_rust_competition_support_package.json'
TRAIN_ROWS = ARTIFACTS / 'stage10799_python_plus_rust_competition_support_package' / 'agentkernel_lite_encdec_train.jsonl'
VALIDATION_ROWS = ARTIFACTS / 'stage10799_python_plus_rust_competition_support_package' / 'agentkernel_lite_encdec_validation.jsonl'
STRICT_ROWS = ARTIFACTS / 'stage10799_python_plus_rust_competition_support_package' / 'agentkernel_lite_encdec_strict_eval.jsonl'
STRESS_ROWS = ARTIFACTS / 'stage10799_python_plus_rust_competition_support_package' / 'agentkernel_lite_encdec_stress_eval.jsonl'

INIT_RUNTIME = ARTIFACTS / 'stage10797_deleaked_python_support_probe' / 'runtime_model' / 'runtime_model_bundle.json'
...
RUN_ID = 'stage10802_python_plus_rust_competition_support_probe'
OUTPUT_DIR = 'runs/local/artifacts/stage10802_python_plus_rust_competition_support_probe/bounded_decoder_probe'
RUNTIME_MODEL_DIR = 'runs/local/artifacts/stage10802_python_plus_rust_competition_support_probe/runtime_model'
...
def main() -> None:
    ...
    request = {
        ...
        'decision': 'python_plus_rust_competition_support_probe_ready',
        ...
        'claim_scope': [
            'Run the next support-only probe from the clean Python-expanded package plus the first explicit Rust citation-competition repair rows.',
            'Keep the honest 24-row strict frontier fixed while testing whether targeted Rust competition support can move the remaining Rust citation miss without regressing Python.',
        ],
        'required_honesty_gates': [
            'strict and validation rows remain unchanged from the honest reviewed v2.7 frontier',
            'all Python support rows come from the stage10794 de-leaked package',
            'all added Rust rows come from the stage10798 competition-repair packet',
            'post-run promotion still requires better than 22/24 with zero strict regressions',
        ],
        ...
        'next_best_step': 'run the probe, then audit whether the added Rust competition rows move the honest frontier without regressions',
    }
