...
STAGE = 11247
NAME = "stage11247_balanced_evidence_role_grounding_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "balanced_evidence_role_grounding_postrun_audit.json"
RUNTIME_BUNDLE = ARTIFACTS / "stage11246_balanced_evidence_role_grounding_probe/runtime_model/runtime_model_bundle.json"
PACKAGE_SUMMARY = ARTIFACTS / "stage11243_balanced_evidence_role_grounding_package/balanced_evidence_role_grounding_package.json"
BASELINE_AUDIT = ARTIFACTS / "stage11244_balanced_evidence_role_grounding_baseline_audit/balanced_evidence_role_grounding_baseline_audit.json"
...
VALIDATION_ROWS = ARTIFACTS / "stage11243_balanced_evidence_role_grounding_package/balanced_evidence_role_grounding_validation_rows.jsonl"
STRICT_ROWS = ARTIFACTS / "stage11243_balanced_evidence_role_grounding_package/balanced_evidence_role_grounding_strict_rows.jsonl"
RESIDUAL_BANK = ARTIFACTS / "stage11195_clean_residual_successor_bank/clean_residual_successor_bank.jsonl"
SCORERS = ["encoder_option_retrieval_verifier_conditioned", "encoder_option_retrieval_evidence_fact_text"]
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "postrun_audit_complete",
        "package_counts": package.get("counts"),
        "runtime_initialization": init_card,
        "gates": {
            "product_clean_strict_22_of_22": scored["encoder_option_retrieval_verifier_conditioned"]["clean_strict"]["row_metric"]["correct"] == 22,
            "product_clean_validation_at_least_20_of_23": scored["encoder_option_retrieval_verifier_conditioned"]["clean_validation"]["row_metric"]["correct"] >= 20,
            "product_residual_above_5_of_10": scored["encoder_option_retrieval_verifier_conditioned"]["residual"]["row_metric"]["correct"] > 5,
            "product_verifier_residual_nonzero": scored["encoder_option_retrieval_verifier_conditioned"]["residual"]["by_gold_value"].get("verifier_and_test_constraint", {}).get("correct", 0) > 0,
            "product_balanced_validation_improved_vs_baseline": scored["encoder_option_retrieval_verifier_conditioned"]["validation"]["row_metric"]["correct"] > baseline["scored"]["encoder_option_retrieval_verifier_conditioned"]["validation"]["row_metric"]["correct"],
            "product_balanced_strict_improved_vs_baseline": scored["encoder_option_retrieval_verifier_conditioned"]["strict"]["row_metric"]["correct"] > baseline["scored"]["encoder_option_retrieval_verifier_conditioned"]["strict"]["row_metric"]["correct"],
        },
        "baseline_stage11244_product": {
            "validation": baseline["scored"]["encoder_option_retrieval_verifier_conditioned"]["validation"]["row_metric"],
            "strict": baseline["scored"]["encoder_option_retrieval_verifier_conditioned"]["strict"]["row_metric"],
            "residual": baseline["scored"]["encoder_option_retrieval_verifier_conditioned"]["residual"]["row_metric"],
        },
        "scored": scored,
        "source_artifacts": {
