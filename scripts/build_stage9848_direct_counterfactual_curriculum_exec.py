...
STAGE = 9848
NAME = "stage9848_direct_counterfactual_curriculum_exec"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
RUN_DIR = OUT_DIR
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "DIRECT_COUNTERFACTUAL_CURRICULUM_EXEC_STAGE9848.md"
AUDIT = OUT_DIR / "direct_counterfactual_curriculum_exec_audit.json"
...
def main() -> None:
    ...
    next_step = "Compare this curriculum-trained 100M run against same-surface Gemma on the heldout harder packet to see whether explicit training on missing-evidence and contradictory-evidence behavior creates a real multilingual edge."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Executed the heldout counterfactual curriculum directly through the structured training loop so the 100M model was explicitly trained on the missing-evidence and contradictory-evidence behaviors before evaluation.",
