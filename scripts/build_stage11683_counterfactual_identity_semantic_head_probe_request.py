...
NAME = "stage11683_counterfactual_identity_semantic_head_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "counterfactual_identity_semantic_head_probe_request.json"
...
RUN_DIR = ART / "stage11683_counterfactual_identity_semantic_head_probe"
...
def main() -> None:
    ...
    summary = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "stage11683_probe_ready" if all(gates.values()) else "stage11683_probe_blocked",
        ...
        "claim_boundary": [
            "This is a diagnostic fit test for a separate semantic candidate head on clean same-role counterfactual rows.",
