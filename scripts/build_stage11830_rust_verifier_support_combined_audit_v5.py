#!/usr/bin/env python3
"""Combined admission audit for Rust verifier support including codex-apply-patch."""
...
STAGE = 11830
NAME = "stage11830_rust_verifier_support_combined_audit_v5"
OUT = ART / NAME
SUMMARY = OUT / "rust_verifier_support_combined_audit_v5.json"
ADMITTED_ROWS = OUT / "rust_verifier_support_rows_v5.jsonl"
