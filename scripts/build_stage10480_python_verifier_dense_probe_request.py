...
STAGE = 10480
NAME = "stage10480_python_verifier_dense_probe_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST_JSON = OUT_DIR / "python_verifier_dense_probe_request.json"
MANIFEST_JSONL = OUT_DIR / "python_verifier_dense_probe_manifest.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"

SUPPORT_PACKAGE = ROOT / "runs/local/artifacts/stage10479_python_verifier_dense_support_package/python_verifier_dense_support_package.json"
SUPPORT_ROWS = ROOT / "runs/local/artifacts/stage10479_python_verifier_dense_support_package/python_verifier_dense_support_rows.jsonl"
...
RUN_ID = "stage10481_python_verifier_dense_probe"
OUTPUT_DIR = ROOT / "runs/local/artifacts/stage10481_python_verifier_dense_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = ROOT / "runs/local/artifacts/stage10481_python_verifier_dense_probe/runtime_model"
...
def main() -> None:
    ...
    request = {
        ...
        "decision": "python_verifier_dense_probe_ready",
        "claim_scope": [
            "Run a Python verifier-only dense support probe against the repaired strict overlay.",
            "Keep the intervention narrow enough to test whether the remaining Python verifier miss is a signal-density problem rather than a broad-support problem.",
        ],
        "source_artifacts": {
        ...
        "success_criteria": [
            ...
            "If the row stays wrong, capture target rank and margin to distinguish near-flip from unchanged semantic collapse.",
        ],
        "promotion_gate_requirements": gate["required_for_future_promotion"],
        "required_honesty_gates": support_package["required_honesty_gates"],
        "outputs": {
