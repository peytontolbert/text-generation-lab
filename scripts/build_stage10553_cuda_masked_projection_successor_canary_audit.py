...
STAGE = 10553
NAME = "stage10553_cuda_masked_projection_successor_canary_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT_JSON = OUT_DIR / "cuda_masked_projection_successor_canary_audit_rerun.json"
ROW_JSONL = OUT_DIR / "cuda_masked_projection_successor_canary_rows_rerun.jsonl"
...
def main() -> None:
    ...
    payload = {
        ...
        "passed": True,
        "claim_scope": [
            "Saved-runtime canary regression audit on the repaired 24-row v2.7 overlay using the stage10551 CUDA masked-projection successor runtime.",
