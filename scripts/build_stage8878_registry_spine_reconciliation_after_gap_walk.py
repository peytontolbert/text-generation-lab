...
STAGE = 8878
NAME = "stage8878_registry_spine_reconciliation_after_gap_walk"
REGISTRY = ROOT / "runs/local/artifacts/reconstructed_stage_registry.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "REGISTRY_SPINE_RECONCILIATION_AFTER_GAP_WALK_STAGE8878.md"
SPINE = ROOT / "docs" / "MODEL_STACK_SPINE.md"
SOURCES = [
    ROOT / "runs/summaries/stage8876_post_target_materialization_gap_reconciliation.json",
    ROOT / "runs/summaries/stage8877_reconciled_gap_walk_after_target_materialization.json",
]
AUTHORITY_CLOSED = {
...
def main() -> None:
    ...
    card = {
        ...
        "metrics": {
            **AUTHORITY_CLOSED,
            ...
            "closed_gate_blockers": gap.get("closed_gate_blockers"),
        ...
        "decision": "Reconciled post-target-materialization gap walk into registry/spine.",
        "next_best_step": "Do not train yet. Next practical branch is either metadata-only commit inventory preflight by explicit request, or an explicit execution-authorization review for the tiny Stage8890 structured probe.",
    ...
    DOC.write_text("\n".join([
        "# Stage8878 Registry Spine Reconciliation After Gap Walk",
        "",
    ...
    marker = "## Stage8876-8878 Post Target Materialization Gap Reconciliation"
