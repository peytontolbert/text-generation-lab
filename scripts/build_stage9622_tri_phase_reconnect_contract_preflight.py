...
STAGE = 9622
NAME = "stage9622_tri_phase_reconnect_contract_preflight"
SOURCE_SUMMARY = ROOT / "runs/summaries/stage9621_in_memory_handoff_trainer_patch_audit.json"
...
DOC = ROOT / "docs" / "TRI_PHASE_RECONNECT_CONTRACT_PREFLIGHT_STAGE9622.md"
...
def command() -> list[str]:
    return [
        ...
        "--output-dir", str(RUN_DIR), "--run-id", "stage9622_tri_phase_reconnect_contract",
        "--contract-only",
    ]
...
def main() -> None:
    ...
    if source.get("passed") is not True:
        failures.append("stage9621_not_passed")
    ...
    next_step = "If execution is explicitly authorized, run Stage9623 tri-phase suffix-choice -> phrase warm-up -> full residual reconnect tiny probe under the patched in-memory trainer."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Tri-phase reconnect command surface is contract-clean. No model execution occurred.",
