...
STAGE = 11603
NAME = "stage11603_web_semantic_candidate_head_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_semantic_candidate_head_postrun_audit.json"

RUNTIME = ART / "stage11602_web_semantic_candidate_head_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "promote_stage11602_if_all_gates_pass" if all(gates.values()) else "do_not_promote_stage11602_semantic_candidate_head",
        "runtime": rel(RUNTIME),
        "device": str(DEVICE),
        "scorer": SCORER,
        "results": results,
