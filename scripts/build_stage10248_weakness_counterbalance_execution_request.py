...
STAGE = 10248
NAME = "stage10248_weakness_counterbalance_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST = OUT_DIR / "weakness_counterbalance_execution_request.json"
COMMAND_JSON = OUT_DIR / "weakness_counterbalance_command.json"
MANIFEST = OUT_DIR / "weakness_counterbalance_manifest.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
PACKAGE = ROOT / "runs/local/artifacts/stage10247_weakness_counterbalance_package/weakness_counterbalance_package.json"
...
RUN_ID = "stage10249_weakness_counterbalance_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10249_weakness_counterbalance_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10249_weakness_counterbalance_probe/runtime_model"
...
def build_request() -> dict[str, Any]:
    ...
    request = {
        ...
        "artifact_purpose": "warm-started weakness-family counterbalance probe derived from refreshed multilingual misses while keeping the exact miss rows strict-eval only",
        "required_honesty_gates": [
            "exact stage10242 miss rows remain strict-eval holdout only",
            "train rows must remain disjoint from holdout roots",
            "warm-start runtime initialization must come exactly from stage10224",
            "results remain auxiliary until rerun against the refreshed admitted standalone and harness paths",
        ],
    }
