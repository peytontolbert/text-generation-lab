...
STAGE = 10590
NAME = "stage10590_fresh_python_cpp_visible_candidate_contract_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
SUMMARY_JSON = OUT_DIR / "fresh_python_cpp_visible_candidate_contract_audit.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "truthful_read": [
            "The fresh stage10584 package is repo-disjoint and candidate-contract based, but it is not promotion-clean because retrieve_answer_abstain and verifier_outcome_masked are constant-target subtypes in both support and strict splits.",
            "Constant-target subtypes can produce large apparent gains without improving the maintainer-relevant evidence selection skill.",
            "Future packages should be blocked from promotion when any strict subtype collapses to one target, unless the subtype is explicitly marked diagnostic-only.",
        ],
        "next_actions": [
