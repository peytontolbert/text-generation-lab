...
STAGE = 11034
NAME = "stage11034_next_root_support_postrun_audit_enriched"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "next_root_support_postrun_audit_enriched.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "claim_scope": [
            ...
            "Enrich the reserved candidate slice with source metadata so per-language and per-repo-family results are explicit."
        ],
        "source_artifacts": {
        ...
        "reserved_candidate_result": {
            ...
            "mismatches": [
                {k: row.get(k) for k in ["row_id", "language_family", "repo_family", "target_text", "constrained_choice_top1_label", "target_rank_full_vocab", "full_vocab_top1_text"]}
