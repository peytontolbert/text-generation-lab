#!/usr/bin/env python3
"""Refresh support supply after bitnet_wasm Rust verifier admission."""
...
STAGE = 11801
NAME = "stage11801_source_heldout_support_supply_status_v13"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v13.json"
...
def main() -> None:
    ...
    artifact = {
        ...
        "delta_since_stage11797": {"rust_verifier_ready_roots_added": 1, "rust_verifier_ready_rows_added": 4},
        "next_actions": ["Continue Rust verifier expansion beyond 4/12 roots.", "Continue C/C++ build/verifier expansion beyond 4/16 roots.", "Continue Python verifier expansion beyond 7/12 roots."],
