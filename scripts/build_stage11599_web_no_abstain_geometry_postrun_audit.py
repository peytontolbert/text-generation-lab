...
STAGE = 11599
NAME = "stage11599_web_no_abstain_geometry_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_no_abstain_geometry_postrun_audit.json"

RUNTIME = ART / "stage11598_web_no_abstain_geometry_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "promote_if_all_gates_pass" if all(gates.values()) else "do_not_promote_web_no_abstain_geometry_runtime",
        "runtime": rel(RUNTIME),
        "device": str(DEVICE),
        "scorer": SCORER,
        "results": results,
