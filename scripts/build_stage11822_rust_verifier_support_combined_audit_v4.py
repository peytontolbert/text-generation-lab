#!/usr/bin/env python3
"""Combined admission audit for Rust verifier support including codex-agent-identity."""
...
STAGE = 11822
NAME = "stage11822_rust_verifier_support_combined_audit_v4"
OUT = ART / NAME
SUMMARY = OUT / "rust_verifier_support_combined_audit_v4.json"
ADMITTED_ROWS = OUT / "rust_verifier_support_rows_v4.jsonl"
