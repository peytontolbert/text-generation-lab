...
STAGE = 11438
NAME = "stage11438_semantic_candidate_filtered_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "semantic_candidate_filtered_probe_request.json"
COMMAND_JSON = OUT_DIR / "semantic_candidate_filtered_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "semantic_candidate_filtered_probe_manifest.jsonl"

PACKAGE = ARTIFACTS / "stage11437_semantic_candidate_probe_ready_filtered_package"
PACKAGE_JSON = PACKAGE / "semantic_candidate_probe_ready_filtered_package.json"
...
QUARANTINE_JSONL = PACKAGE / "semantic_candidate_quarantined_rows.jsonl"
...
INIT_RUNTIME = ARTIFACTS / "stage11431_selected_test_rust_support_probe/runtime_model/runtime_model_bundle.json"
RUN_DIR = ARTIFACTS / "stage11439_semantic_candidate_filtered_probe"
...
def main() -> None:
    ...
    if not package.get("passed"):
        raise SystemExit("Stage11437 package did not pass")
    if not package.get("gates", {}).get("all_kept_rows_have_full_semantic_candidate_options"):
        raise SystemExit("Stage11437 kept rows are not semantic-candidate complete")
    ...
    summary = {
        ...
        "passed": True,
        "decision": "semantic_candidate_filtered_probe_requested",
        "claim_scope": "diagnostic scorer-objective probe only; filtered strict/eval denominators changed and old canary must be audited separately",
        "metrics": {
