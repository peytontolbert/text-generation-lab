...
STAGE = 11564
NAME = "stage11564_conservative_openhands_postrun_gate_audit"
OUT = ART / NAME
SUMMARY = OUT / "conservative_openhands_postrun_gate_audit.json"

RUNTIME = ART / "stage11563_conservative_openhands_from_stage11507_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "conservative_openhands_postrun_gate_promising" if all(gates.values()) else "text_rich_bridge_postrun_gate_not_promotable",
