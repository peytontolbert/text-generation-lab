...
STAGE = 11555
NAME = "stage11555_text_rich_web_evidence_judgment_bridge_probe_request"
OUT = ART / NAME
...
PROBE = ART / "stage11555_text_rich_web_evidence_judgment_bridge_probe/bounded_decoder_probe"
RUNTIME_OUT = ART / "stage11555_text_rich_web_evidence_judgment_bridge_probe/runtime_model"
...
def bridge_row(row: dict[str, Any]) -> tuple[dict[str, Any] | None, dict[str, Any] | None]:
    ...
    for option in options:
        ...
        mapped.append(item)
    out = dict(source)
    out["row_id"] = f"{source.get('row_id')}::stage11555_judgment_bridge"
    ...
    standalone["stage11555_bridge_source_row_id"] = source.get("row_id")
    standalone["stage11555_bridge_gate"] = "all_supported_text_rich_evidence_roles"
    out["standalone_projection_source"] = standalone
    ...
    anti.update(
        {
            "stage11555_judgment_bridge": True,
