#!/usr/bin/env python3
"""Combined Python verifier support admission audit including llm-memory."""
...
STAGE = 11812
NAME = "stage11812_python_verifier_support_combined_audit_v7"
OUT = ART / NAME
SUMMARY = OUT / "python_verifier_support_combined_audit_v7.json"
COMBINED_ROWS = OUT / "python_verifier_support_combined_rows_v7.jsonl"
...
ROW_SOURCES = [
    ...
    ART / "stage11775_neural_blocks_python_support_rows/neural_blocks_python_support_rows.jsonl",
    ART / "stage11791_peft_sanitizer_python_support_rows/peft_sanitizer_python_support_rows.jsonl",
    ART / "stage11795_selfplay_arena_python_support_rows/selfplay_arena_python_support_rows.jsonl",
    ART / "stage11811_llm_memory_python_support_rows/llm_memory_python_support_rows.jsonl",
]
