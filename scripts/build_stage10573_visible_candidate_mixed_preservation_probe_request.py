...
STAGE = 10573
NAME = "stage10573_visible_candidate_mixed_preservation_probe_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST_JSON = OUT_DIR / "visible_candidate_mixed_preservation_probe_request.json"
COMMAND_JSON = OUT_DIR / "visible_candidate_mixed_preservation_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "visible_candidate_mixed_preservation_probe_manifest.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"

SUPPORT_PACKAGE = ROOT / "runs/local/artifacts/stage10572_visible_candidate_mixed_preservation_support_package/visible_candidate_mixed_preservation_support_package.json"
SUPPORT_ROWS = ROOT / "runs/local/artifacts/stage10572_visible_candidate_mixed_preservation_support_package/visible_candidate_mixed_preservation_support_rows.jsonl"
...
RUN_ID = "stage10574_visible_candidate_mixed_preservation_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10574_visible_candidate_mixed_preservation_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10574_visible_candidate_mixed_preservation_probe/runtime_model"
...
def main() -> None:
    ...
    request = {
        ...
        'claim_scope': [
            'Diagnostic multilingual target-100M probe that trains on stage10572 mixed preservation support while keeping stage10561 rebuilt strict rows held out.',
            'Tests whether mixed decisive-evidence plus verifier/retrieve preservation support can improve the rebuilt strict slice without regressing the repaired v2.7 canary.',
        ...
        'training_deltas': {
            'train_support_manifest': 'stage10572_visible_candidate_mixed_preservation_support_package',
        ...
        'known_limits': [
            'Rust and web rebuilt-contract support remain thin even after stage10572, so any multilingual uplift must still be read conservatively.',
