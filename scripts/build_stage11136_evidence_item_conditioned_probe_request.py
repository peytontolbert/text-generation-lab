...
STAGE = 11136
NAME = "stage11136_evidence_item_conditioned_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "evidence_item_conditioned_probe_request.json"
COMMAND_JSON = OUT_DIR / "evidence_item_conditioned_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "evidence_item_conditioned_probe_manifest.jsonl"
...
PROBE_OUT_DIR = ARTIFACTS / "stage11137_evidence_item_conditioned_probe" / "bounded_decoder_probe"
RUNTIME_OUT_DIR = ARTIFACTS / "stage11137_evidence_item_conditioned_probe" / "runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "evidence_item_conditioned_probe_requested",
        "claim_scope": [
            "Run one isolated encoder_option_retrieval probe using stage11131 evidence-item option support rows with conditioned option retrieval.",
            "Test whether scoring conditioned option retrieval improves residual evidence behavior without adding role-name aliases or a new scorer head.",
        ],
        "source_artifacts": {
        ...
        "training_contract": {
            "bounded_choice_aux_source": "encoder_option_retrieval_conditioned",
            ...
            "purpose": "test conditioned evidence-item option geometry without evidence-role scorer architecture changes",
        },
        "promotion_gates": [
