...
STAGE = 11439
NAME = "stage11439_root_purged_semantic_candidate_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "root_purged_semantic_candidate_probe_request.json"
COMMAND_JSON = OUT_DIR / "root_purged_semantic_candidate_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "root_purged_semantic_candidate_probe_manifest.jsonl"

PACKAGE = ARTIFACTS / "stage11438_root_purged_semantic_candidate_package"
PACKAGE_JSON = PACKAGE / "root_purged_semantic_candidate_package.json"
...
RUN_DIR = ARTIFACTS / "stage11440_root_purged_semantic_candidate_probe"
...
def main() -> None:
    ...
    if not package.get("passed"):
        raise SystemExit("Stage11438 package did not pass")
    if not package.get("gates", {}).get("root_split_clean_for_probe"):
        raise SystemExit("Stage11438 package is not root-split clean")
    ...
    summary = {
        ...
        "passed": True,
        "decision": "root_purged_semantic_candidate_probe_requested",
        "claim_scope": "diagnostic scorer-objective probe only; root-purged train and filtered strict/eval denominators changed; old canary must be audited separately",
        "metrics": {
