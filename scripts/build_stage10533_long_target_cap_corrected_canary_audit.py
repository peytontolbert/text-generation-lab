...
STAGE = 10533
NAME = "stage10533_long_target_cap_corrected_canary_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT_JSON = OUT_DIR / "long_target_cap_corrected_canary_audit.json"
ROW_JSONL = OUT_DIR / "long_target_cap_corrected_canary_rows.jsonl"
...
def main() -> None:
    ...
    payload = {
        ...
        "passed": True,
        "claim_scope": [
            "Saved-runtime canary regression audit on the repaired 24-row v2.7 overlay using the stage10531 long-target-cap-corrected runtime.",
