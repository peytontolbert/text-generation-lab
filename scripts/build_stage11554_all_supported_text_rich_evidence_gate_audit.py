...
STAGE = 11554
NAME = "stage11554_all_supported_text_rich_evidence_gate_audit"
OUT = ART / NAME
SUMMARY = OUT / "all_supported_text_rich_evidence_gate_audit.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "all_supported_text_rich_evidence_gate_promising" if all(gates.values()) else "all_supported_text_rich_evidence_gate_not_promotable",
