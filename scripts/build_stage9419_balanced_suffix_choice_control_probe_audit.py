...
STAGE = 9419
NAME = "stage9419_suffix_choice_control_probe_audit"
SOURCE_SUMMARY = ROOT / "runs/summaries/stage9418_suffix_choice_control_preexecution.json"
RUN_DIR = ROOT / "runs/local/artifacts/stage9419_suffix_choice_control_probe"
AUDIT = RUN_DIR / "stage9419_suffix_choice_control_probe_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "SUFFIX_CHOICE_CONTROL_PROBE_AUDIT_STAGE9419.md"
...
def main() -> None:
    ...
    if source.get("passed") is not True:
        failures.append("source_stage9418_not_passed")
    ...
    if losses.get("suffix_choice_ce") != 60:
