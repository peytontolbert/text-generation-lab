...
STAGE = 10071
NAME = "stage10071_canonical_label_aligned_same_manifest_gemma_queue"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
QUEUE = OUT_DIR / "canonical_label_aligned_same_manifest_gemma_queue.json"
PACKETS = OUT_DIR / "canonical_label_aligned_same_manifest_gemma_packets.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "CANONICAL_LABEL_ALIGNED_SAME_MANIFEST_GEMMA_QUEUE_STAGE10071.md"
...
OUTPUT = ROOT / "runs/local/artifacts/stage10071_canonical_label_aligned_gemma_execution/same_prompt_surface_gemma12b_outputs.json"
...
def build_queue() -> dict[str, Any]:
    ...
    packet = {
        "cell_key": "canonical_label_aligned_target100m::edit_localization::same_manifest_gemma12b",
        ...
        "queue_entries": [
            {
                ...
                "language_family": "multilingual",
                "priority_rank": 1,
                "priority_reason": "same-manifest Gemma comparison for the canonical-label multilingual heldout rows",
...
def main() -> None:
    ...
    next_step = "Run the local Ollama Gemma comparator on this canonical-label same-manifest queue, then compare it directly against the matching 100M probe on the same 55 heldout rows."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Materialized a same-manifest Gemma queue for the canonical-label multilingual heldout rows so Gemma can be compared fairly on the remapped label semantics.",
