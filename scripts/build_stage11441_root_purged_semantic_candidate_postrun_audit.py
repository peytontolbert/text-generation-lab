...
STAGE = 11441
NAME = "stage11441_root_purged_semantic_candidate_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "root_purged_semantic_candidate_postrun_audit.json"
RUNTIME = ARTIFACTS / "stage11440_root_purged_semantic_candidate_probe/runtime_model/runtime_model_bundle.json"
REQUEST = ARTIFACTS / "stage11439_root_purged_semantic_candidate_probe_request/root_purged_semantic_candidate_probe_request.json"
PACKAGE = ARTIFACTS / "stage11438_root_purged_semantic_candidate_package/root_purged_semantic_candidate_package.json"
FILTERED_VALIDATION = ARTIFACTS / "stage11438_root_purged_semantic_candidate_package/agentkernel_lite_encdec_validation.jsonl"
FILTERED_STRICT = ARTIFACTS / "stage11438_root_purged_semantic_candidate_package/agentkernel_lite_encdec_strict_eval.jsonl"
RESIDUAL = ARTIFACTS / "stage11438_root_purged_semantic_candidate_package/semantic_candidate_residual_bank.jsonl"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "semantic_candidate_probe_not_promoted_residual_flat_and_filtered_eval_regressed",
        ...
        "promotion_gates": {
            ...
            "old_canary_base_strict_preserves_22_of_23": base["old_canary_strict"]["correct"] == 22,
            "coverage_full_for_product_residual": product["residual_bank"].get("coverage") == 1.0,
        },
        "decision_basis": [
            "The semantic-candidate runtime scores 21/22 filtered strict and 19/22 filtered validation, so it does not improve the filtered canary surface.",
            "Promotion requires residual improvement beyond the 5/10 base plateau and separate preservation of the original 23-row canary.",
