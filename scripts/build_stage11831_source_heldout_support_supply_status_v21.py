#!/usr/bin/env python3
"""Refresh support supply after codex-apply-patch Rust admission."""
...
STAGE = 11831
NAME = "stage11831_source_heldout_support_supply_status_v21"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v21.json"
...
RUST = ART / "stage11830_rust_verifier_support_combined_audit_v5/rust_verifier_support_combined_audit_v5.json"
...
def main() -> None:
    ...
    artifact = {
        ...
        "delta_since_stage11827": {"rust_verifier_ready_roots_added": 1, "rust_verifier_ready_rows_added": 4},
        "next_actions": ["Continue Python verifier expansion beyond 8/12 roots.", "Continue C/C++ abstain-attractor expansion beyond 7/16 roots.", "Continue Rust verifier expansion beyond 6/12 roots."],
