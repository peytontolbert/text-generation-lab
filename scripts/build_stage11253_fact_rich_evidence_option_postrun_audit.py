...
STAGE = 11253
NAME = "stage11253_fact_rich_evidence_option_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "fact_rich_evidence_option_postrun_audit.json"
RUNTIME_BUNDLE = ARTIFACTS / "stage11252_fact_rich_evidence_option_probe/runtime_model/runtime_model_bundle.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "fact_rich_postrun_audit_complete",
        ...
        "gates": {
            ...
            "product_fact_rich_validation_improved_vs_baseline": scored["encoder_option_retrieval_verifier_conditioned"]["validation"]["row_metric"]["correct"] > baseline["scored"]["encoder_option_retrieval_verifier_conditioned"]["validation"]["row_metric"]["correct"],
            "product_fact_rich_strict_improved_vs_baseline": scored["encoder_option_retrieval_verifier_conditioned"]["strict"]["row_metric"]["correct"] > baseline["scored"]["encoder_option_retrieval_verifier_conditioned"]["strict"]["row_metric"]["correct"],
        },
        "baseline_stage11250_product": {
