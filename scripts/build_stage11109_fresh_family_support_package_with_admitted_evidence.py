...
STAGE = 11109
NAME = "stage11109_fresh_family_support_package_with_admitted_evidence"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "fresh_family_support_package_with_admitted_evidence.json"
...
ADDED_ROWS_JSONL = OUT_DIR / "added_admitted_evidence_rows.jsonl"
...
ADMISSION_DIR = ARTIFACTS / "stage11108_fresh_family_evidence_admission_audit"
ADMISSION_SUMMARY = ADMISSION_DIR / "fresh_family_evidence_admission_audit.json"
ADMITTED_ROWS = ADMISSION_DIR / "admitted_evidence_rows.jsonl"
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "fresh_family_support_package_with_admitted_evidence_ready",
        "claim_scope": [
            "Extend the latest clean fresh-family support package with admitted train-support-only evidence rows.",
        ...
        "headline_findings": [
            "This package adds the first leak-audited evidence-citation replenishment rows from the fresh-family pipeline.",
