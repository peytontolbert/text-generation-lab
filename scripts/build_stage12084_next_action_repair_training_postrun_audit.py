#!/usr/bin/env python3
"""Audit Stage12083 next-action repair training runtime."""
...
STAGE = 12084
NAME = 'stage12084_next_action_repair_training_postrun_audit'
OUT = ART / NAME
...
def main() -> None:
    ...
    postrun = results['stage12083_next_action_repair_training']
    ...
    if protected_preserved and gates['transition_projection_beats_gemma_386']:
        decision = 'stage12083_promotable_transition_gemma_win_candidate'
        ...
        decision = 'stage12083_transition_frontier_gain_candidate'
    elif protected_preserved and gates['transition_projection_retains_stage11924_baseline']:
        decision = 'stage12083_retention_candidate_no_frontier_gain'
    else:
        decision = 'reject_stage12083_keep_stage11924_selected_transition_frontier'

    changes = changed_rows(transition_cards['stage11924_transition_listwise_head_only'], transition_cards['stage12083_next_action_repair_training'])
    summary = {
        'stage': STAGE,
        'stage_name': NAME,
        'created_at_utc': now(),
        ...
        'source_artifacts': {
            ...
            'stage12082_request': 'runs/summaries/stage12082_next_action_repair_training_request.json',
        },
    ...
    print(json.dumps({
        ...
        'stage12083_transition': postrun['transition_projection_routed'],
        'stage11924_next_action': previous['transition_by_task']['transition_next_action'],
        'stage12083_next_action': postrun['transition_by_task']['transition_next_action'],
        'changes': changes,
