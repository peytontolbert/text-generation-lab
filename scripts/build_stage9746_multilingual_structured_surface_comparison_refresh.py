...
STAGE = 9746
NAME = "stage9746_multilingual_structured_surface_comparison_refresh"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
COMPARISON = OUT_DIR / "multilingual_structured_surface_comparison_refresh.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "MULTILINGUAL_STRUCTURED_SURFACE_COMPARISON_REFRESH_STAGE9746.md"
...
SOURCES = {
    ...
    "edit_localization_target_only": ROOT / "runs/summaries/stage9744_multilingual_edit_localization_target_only_execution_audit.json",
...
def main() -> None:
    ...
    next_step = "Treat the refreshed best surface as the strongest current standalone multilingual 100M comparison candidate; Gemma and harness evidence are still missing and remain the hard blocker for any true cross-model claim."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Refreshed the executed multilingual structured-surface ranking after replacing edit-localization with the stronger target-only run.",
