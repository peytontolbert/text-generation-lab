...
STAGE = 10588
NAME = "stage10588_fresh_python_cpp_visible_candidate_same_manifest_comparison"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
SUMMARY_PATH = OUT_DIR / "fresh_python_cpp_visible_candidate_same_manifest_comparison.json"
...
RUNTIME_BUNDLE = ROOT / "runs/local/artifacts/stage10586_fresh_python_cpp_visible_candidate_probe/runtime_model/runtime_model_bundle.json"
EXECUTION_RESULT = ROOT / "runs/local/artifacts/stage10586_fresh_python_cpp_visible_candidate_probe/bounded_decoder_probe/execution_result.json"
MODEL_ID = "gemma3:12b"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Same-manifest seq2seq generation on the fresh repo-disjoint Python/C++ strict rows from stage10584 using the stage10586 runtime.",
            "Exact-match and semantic-match comparison only.",
            "Fresh strict slice is limited to decisive_evidence_top1, retrieve_answer_abstain, and verifier_outcome_masked.",
        ],
        "row_count": len(rows),
