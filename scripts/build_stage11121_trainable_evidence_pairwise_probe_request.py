...
STAGE = 11121
NAME = "stage11121_trainable_evidence_pairwise_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "trainable_evidence_pairwise_probe_request.json"
COMMAND_JSON = OUT_DIR / "trainable_evidence_pairwise_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "trainable_evidence_pairwise_probe_manifest.jsonl"
...
PROBE_OUT_DIR = ARTIFACTS / "stage11122_trainable_evidence_pairwise_probe" / "bounded_decoder_probe"
RUNTIME_OUT_DIR = ARTIFACTS / "stage11122_trainable_evidence_pairwise_probe" / "runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "trainable_evidence_pairwise_probe_requested",
        "claim_scope": [
            "Train a persistent pairwise bounded-choice scorer head on the current stage11114 trainable evidence support package.",
            "Keep validation and strict successor surfaces unchanged, then score the untouched reserved residual bank to test scorer-objective alignment rather than support-row volume.",
        ],
        "source_artifacts": {
        ...
        "next_best_step": "Execute this request, then run the stage11123 postrun audit over successor validation/strict and reserved residual candidates.",
        "outputs": {
