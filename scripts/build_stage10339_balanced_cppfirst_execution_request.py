...
STAGE = 10339
NAME = "stage10339_balanced_cppfirst_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
MANIFEST_JSONL = OUT_DIR / "balanced_cppfirst_manifest.jsonl"
REQUEST_JSON = OUT_DIR / "balanced_cppfirst_execution_request.json"
COMMAND_JSON = OUT_DIR / "balanced_cppfirst_command.json"
...
RUN_ID = "stage10340_balanced_cppfirst_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10340_balanced_cppfirst_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10340_balanced_cppfirst_probe/runtime_model"
MAX_STEPS = 56
LEARNING_RATE = "8e-6"
BATCH_SIZE = 2
...
def main() -> None:
    ...
    frontloaded_rows = cpp_anchor_rows + web_support_rows + python_candidate_rows
    ...
    request = {
        ...
        "passed": True,
        "decision": "balanced_cppfirst_successor_ready",
        ...
        "next_best_step": "run one cpp-first warm-start probe and promote it only if the stage10336 gains survive while c_cpp evidence citation returns to 6/6",
        "command": command,
