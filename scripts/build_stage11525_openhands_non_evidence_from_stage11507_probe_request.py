...
STAGE = 11525
NAME = "stage11525_openhands_non_evidence_from_stage11507_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "openhands_non_evidence_from_stage11507_probe_request.json"
MANIFEST = OUT / "openhands_non_evidence_from_stage11507_probe_manifest.jsonl"
COMMAND = OUT / "openhands_non_evidence_from_stage11507_probe_command.json"
PROBE = ART / "stage11525_openhands_non_evidence_from_stage11507_probe/bounded_decoder_probe"
RUNTIME_OUT = ART / "stage11525_openhands_non_evidence_from_stage11507_probe/runtime_model"
...
def main() -> None:
    train = [row for row in load_jsonl(TRAIN) if row.get("task_type") not in {"evidence_citation", "alternative_hypothesis_elimination"}]
    ...
    gates = {
        "train_rows_present": len(train) == 16,
    ...
    summary = {
        ...
        "decision": "openhands_non_evidence_stage11507_probe_ready" if all(gates.values()) else "openhands_non_evidence_stage11507_probe_blocked",
        "metrics": {
        ...
        "command": command,
        "claim_boundary": [
            "Diagnostic Web transfer support probe only; evidence_citation and alternative_hypothesis_elimination train rows are intentionally excluded.",
