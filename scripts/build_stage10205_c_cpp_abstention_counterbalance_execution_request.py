...
STAGE = 10205
NAME = "stage10205_c_cpp_abstention_counterbalance_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST = OUT_DIR / "c_cpp_abstention_counterbalance_execution_request.json"
COMMAND_JSON = OUT_DIR / "c_cpp_abstention_counterbalance_command.json"
MANIFEST = OUT_DIR / "c_cpp_abstention_counterbalance_manifest.jsonl"
...
RUN_ID = "stage10206_c_cpp_abstention_counterbalance_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10206_c_cpp_abstention_counterbalance_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10206_c_cpp_abstention_counterbalance_probe/runtime_model"
MAX_STEPS = 224
...
def build_request() -> dict[str, Any]:
    ...
    request = {
        ...
        "passed": package_passed and bool(rows),
        ...
        "run_id": RUN_ID,
        "request_status": "save_enabled_execution_ready" if package_passed and rows else "blocked_by_incomplete_source_package",
        ...
        "artifact_purpose": "c_cpp abstention counterbalance probe layered on the stage10200 targeted contrast package",
        "required_honesty_gates": [
            "strict eval rows must remain identical to stage10200 and stage10149",
            "train-only c_cpp abstention rows remain auxiliary and do not create a new score claim on their source bundles",
            "saved runtime does not upgrade the maintainer-grade claim by itself",
