#!/usr/bin/env python3
"""Combined Python verifier support audit including simple-moe."""
...
STAGE = 11866
NAME = "stage11866_python_verifier_support_combined_audit_v12"
OUT = ART / NAME
SUMMARY = OUT / "python_verifier_support_combined_audit_v12.json"
COMBINED_ROWS = OUT / "python_verifier_support_combined_rows_v12.jsonl"

BASE_AUDIT = ART / "stage11862_python_verifier_support_combined_audit_v11/python_verifier_support_combined_audit_v11.json"
BASE_ROWS = ART / "stage11862_python_verifier_support_combined_audit_v11/python_verifier_support_combined_rows_v11.jsonl"
NEW_ROWS = ART / "stage11865_simple_moe_python_support_rows/simple_moe_python_support_rows.jsonl"
...
def main() -> None:
    ...
    artifact: dict[str, Any] = {
        ...
        "decision": "simple_moe_admitted_quota_incomplete",
