...
STAGE = 10987
NAME = "stage10987_pairwise_residual_family_probe_request"
OUT_DIR = ARTIFACTS / NAME
REQUEST_JSON = OUT_DIR / "pairwise_residual_family_probe_request.json"
COMMAND_JSON = OUT_DIR / "pairwise_residual_family_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "pairwise_residual_family_probe_manifest.jsonl"

PACKAGE_JSON = ARTIFACTS / "stage10983_clean_residual_family_support_package" / "clean_residual_family_support_package.json"
TRAIN_ROWS = ARTIFACTS / "stage10983_clean_residual_family_support_package" / "agentkernel_lite_encdec_train.jsonl"
VALIDATION_ROWS = ARTIFACTS / "stage10983_clean_residual_family_support_package" / "agentkernel_lite_encdec_validation.jsonl"
STRICT_ROWS = ARTIFACTS / "stage10983_clean_residual_family_support_package" / "agentkernel_lite_encdec_strict_eval.jsonl"
STRESS_ROWS = ARTIFACTS / "stage10983_clean_residual_family_support_package" / "agentkernel_lite_encdec_stress_eval.jsonl"
INIT_RUNTIME = ARTIFACTS / "stage10960_clean_explicit_ledger_support_probe" / "runtime_model" / "runtime_model_bundle.json"
RUN_ID = "stage10988_pairwise_residual_family_support_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10988_pairwise_residual_family_support_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10988_pairwise_residual_family_support_probe/runtime_model"
...
def main() -> None:
    ...
    command = [
        ...
        "--bounded-choice-aux-source", "encoder_option_retrieval_pairwise",
    ...
    payload = {
        ...
        "passed": True,
        "decision": "pairwise_residual_family_probe_ready",
        "claim_scope": [
            "Run one heldout-preserving support probe using a pairwise bounded-choice scorer over the clean residual-family curriculum.",
            "Test whether a runtime-relevant scorer architecture change moves the residual slices that broader clean data alone did not move.",
        ],
        "command": command,
        "run_id": RUN_ID,
        ...
        "required_honesty_gates": [
            ...
            "Only the bounded-choice scorer architecture changes; heldout row content is fixed.",
            "Residual slices are audited separately after the run and do not enter train in this stage.",
        ],
        "next_best_step": "Run the pairwise scorer probe, then audit overlay preservation, the expanded evidence successor family, and the Python verifier-transition candidate slice under the same pairwise scorer.",
    }
