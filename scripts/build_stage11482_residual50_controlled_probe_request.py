...
STAGE = 11482
NAME = "stage11482_residual50_controlled_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "residual50_controlled_probe_request.json"
MANIFEST = OUT / "residual50_controlled_probe_manifest.jsonl"
COMMAND_JSON = OUT / "residual50_controlled_probe_command.json"
...
RUN_DIR = ART / "stage11483_residual50_controlled_probe"
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": allowed,
        "decision": "residual50_controlled_probe_requested" if allowed else "residual50_controlled_probe_blocked",
        "hypothesis": {
            "failure_family": "residual evidence-role confusions across Python/C++ verifier constraint and Rust symptom/call-path families",
            "mechanism": "base encoder_option_retrieval lacks enough disjoint role-balanced same-family analogues with candidate_change_surface hard negatives",
            "single_changed_variable": "train-support data geometry; scorer remains encoder_option_retrieval",
            "intervention": "add Stage11481 Residual-50 train-support analogue rows to Stage11436 base train split",
        },
        "metrics": {
