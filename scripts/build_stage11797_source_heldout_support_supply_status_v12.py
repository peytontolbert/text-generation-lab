#!/usr/bin/env python3
"""Refresh support supply after selfplay-arena Python verifier admission."""
...
STAGE = 11797
NAME = "stage11797_source_heldout_support_supply_status_v12"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v12.json"
...
def main() -> None:
    ...
    artifact = {
        ...
        "delta_since_stage11793": {
            "python_verifier_ready_roots_added": 1,
            "python_verifier_ready_rows_added": 4,
        },
        "next_actions": [
            "Continue Python verifier expansion beyond 7/12 roots.",
