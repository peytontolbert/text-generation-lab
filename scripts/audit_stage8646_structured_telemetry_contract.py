...
def main() -> None:
    ...
    gates = {
        ...
        "row_gradient_norms_written": "row_gradient_norms.jsonl" in loop_src,
        "activation_summary_written": "activation_summary.jsonl" in loop_src,
        "feature_ablation_written": "feature_ablation_attribution.jsonl" in loop_src,
        "activation_patch_written": "activation_patch_recovery.jsonl" in loop_src,
        "row_dynamics_written": "row_dynamics_history.jsonl" in loop_src,
