...
STAGE = 10351
NAME = "stage10351_preserved_citation_aug_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
MANIFEST_JSONL = OUT_DIR / "preserved_citation_aug_manifest.jsonl"
REQUEST_JSON = OUT_DIR / "preserved_citation_aug_execution_request.json"
COMMAND_JSON = OUT_DIR / "preserved_citation_aug_command.json"
...
RUN_ID = "stage10352_preserved_citation_aug_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10352_preserved_citation_aug_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10352_preserved_citation_aug_probe/runtime_model"
MAX_STEPS = 24
LEARNING_RATE = "8e-6"
BATCH_SIZE = 2
...
def main() -> None:
    ...
    request = {
        ...
        "next_best_step": "run one preservation-enabled citation augmentation probe and check whether citation families improve while stage10342 solved behavior stays anchored",
        "preservation": {
