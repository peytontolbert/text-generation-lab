...
STAGE = 11171
NAME = "stage11171_external_fail_to_pass_support_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "external_fail_to_pass_support_postrun_audit.json"
...
VALIDATION_JSON = ARTIFACTS / "stage11170_external_fail_to_pass_support_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_eval.json"
STRICT_JSON = ARTIFACTS / "stage11170_external_fail_to_pass_support_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_strict_eval.json"
EXECUTION_JSON = ARTIFACTS / "stage11170_external_fail_to_pass_support_probe" / "bounded_decoder_probe" / "execution_result.json"
RESERVED_ROWS = ARTIFACTS / "stage11051_successor_residual_support_plus_priority_evidence" / "reserved_residual_candidates.jsonl"
SUPPORT_ROWS = ARTIFACTS / "stage11168_cleaned_plus_external_fail_to_pass_support_package" / "added_external_commit_fail_to_pass_rows.jsonl"
PACKAGE_SUMMARY = ARTIFACTS / "stage11168_cleaned_plus_external_fail_to_pass_support_package" / "cleaned_plus_external_fail_to_pass_support_package.json"
REQUEST_SUMMARY = ARTIFACTS / "stage11169_external_fail_to_pass_support_probe_request" / "external_fail_to_pass_support_probe_request.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Postrun audit for the external FAIL_TO_PASS verifier-target support diagnostic.",
            "The added rows are train-support-only external commit-backed FAIL_TO_PASS verifier-target rows; this audit cannot promote a new broad capability claim unless heldout surfaces improve without regression.",
        ],
        "source_artifacts": {
        ...
        "next_best_step_if_flat": (
            "Stop external historical commit support variants if still flat. Build fresh explicit verifier-transition roots with competing "
