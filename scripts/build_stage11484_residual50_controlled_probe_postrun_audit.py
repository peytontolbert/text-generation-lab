...
STAGE = 11484
NAME = "stage11484_residual50_controlled_probe_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "residual50_controlled_probe_postrun_audit.json"

RUNTIME = ART / "stage11483_residual50_controlled_probe/runtime_model/runtime_model_bundle.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "residual50_controlled_probe_promoted"
        if promoted
        else "residual50_controlled_probe_rejected_or_diagnostic_only",
        ...
        "decision_basis": [
            "Stage11483 trained the selected Stage11444 runtime on the Residual-50 train-support analogue package.",
            ...
            "Decoder-first or semantic-head-only gains are diagnostic and do not promote the selected product runtime.",
        ],
        "source_artifacts": {
    ...
    print(json.dumps({"decision": summary["decision"], "promotion_gates": gates, "product": product}, indent=2, sort_keys=True))
