...
STAGE = 11102
NAME = "stage11102_fresh_family_support_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "fresh_family_support_postrun_audit.json"
...
RUNTIME_BUNDLE = ARTIFACTS / "stage11101_fresh_family_support_probe" / "runtime_model" / "runtime_model_bundle.json"
VALIDATION_JSON = ARTIFACTS / "stage11101_fresh_family_support_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_eval.json"
STRICT_JSON = ARTIFACTS / "stage11101_fresh_family_support_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_strict_eval.json"
EXECUTION_JSON = ARTIFACTS / "stage11101_fresh_family_support_probe" / "bounded_decoder_probe" / "execution_result.json"
RESERVED_ROWS = ARTIFACTS / "stage11051_successor_residual_support_plus_priority_evidence" / "reserved_residual_candidates.jsonl"
FRESH_SUPPORT_ROWS = ARTIFACTS / "stage11099_fresh_family_support_package" / "added_fresh_family_support_rows.jsonl"
BASELINE_POSTRUN = ARTIFACTS / "stage11090_pairwise_semantic_evidence_postrun_audit" / "pairwise_semantic_evidence_postrun_audit.json"
PACKAGE_SUMMARY = ARTIFACTS / "stage11099_fresh_family_support_package" / "fresh_family_support_package.json"
...
def main() -> None:
    ...
    reserved_card = _write_bounded_choice_eval_audit(
        ...
        bounded_choice_aux_source="encoder_option_retrieval_pairwise",
        eval_batch_size=8,
    )
    ...
    if baseline:
        baseline_successor_validation = (((baseline.get("result_snapshot") or {}).get("clean_validation_accuracy")))
        baseline_successor_strict = (((baseline.get("result_snapshot") or {}).get("clean_strict_accuracy")))
        baseline_reserved = (((baseline.get("result_snapshot") or {}).get("reserved_candidate_accuracy")))
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Audit the stage11101 runtime against the unchanged successor validation/strict overlay and the untouched reserved residual candidate bank.",
            "Check anti-cheat overlap between the stage11099 fresh-family support rows and the scored strict/reserved surfaces before making any claim.",
        ],
        "source_artifacts": {
        ...
        "headline_findings": [
            "This audit measures whether the stage11099 fresh-family support moved the untouched successor overlay or only changed newly trained support geometry.",
            ...
            "Fresh-family support rows are explicitly checked for overlap against strict and reserved surfaces before interpreting any gain.",
        ],
        "runtime_bundle": {
