...
STAGE = 10228
NAME = "stage10228_evidence_coherence_narrow_package"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
TRAIN_JSONL = OUT_DIR / "agentkernel_lite_encdec_train.jsonl"
EVAL_JSONL = OUT_DIR / "agentkernel_lite_encdec_eval.jsonl"
PACKAGE_JSON = OUT_DIR / "evidence_coherence_narrow_package.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
BASE_PACKAGE = ROOT / "runs/local/artifacts/stage10222_bundle_coherence_counterbalance_package/bundle_coherence_counterbalance_package.json"
CHOICE_LABELS = list("ABCDEFGHJKLMNOPQRSTUVWXYZ")

CONTRAST_SPECS = [
    {
        "name": "c_cpp_abstain_vs_singletons_refresh",
        "language_family": "c_cpp",
        "task_type": "abstention_insufficient_evidence",
        "gold_value": "ABSTAIN_INSUFFICIENT_EVIDENCE",
    },
    {
        "name": "c_cpp_evidence_candidate_vs_others_refresh",
        "language_family": "c_cpp",
        "task_type": "evidence_citation",
        "gold_value": "candidate_change_surface",
    },
    {
        "name": "rust_evidence_candidate_vs_others_refresh",
        "language_family": "rust",
        "task_type": "evidence_citation",
        "gold_value": "candidate_change_surface",
    },
    {
        "name": "web_evidence_candidate_vs_others_refresh",
        "language_family": "web_js_ts_html",
        "task_type": "evidence_citation",
        "gold_value": "candidate_change_surface",
    },
    {
        "name": "python_evidence_verifier_vs_others_refresh",
...
def canonical_source_rows(rows: list[dict[str, Any]], spec: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    for other_index, other_value in enumerate(other_values):
        ...
        for order_index, ordered_values in enumerate(unique_orders):
            ...
            anti_cheat.update({
                ...
                "evidence_coherence_narrow_refresh": True,
...
def build_package() -> dict[str, Any]:
    ...
    for spec in CONTRAST_SPECS:
        selected = canonical_source_rows(train_rows, spec)
        produced = 0
    ...
    package = {
        ...
        "unsupported_reviewed_failure_families": [
            ...
            "python::evidence_citation candidate_change_surface lacks direct python train support and remains cross-language-only if it improves",
            "rust::evidence_citation symptom_or_call_path_analogue lacks direct rust train support and remains evaluation-only for same-language claims",
        ],
        ...
        "required_honesty_gates": [
            "strict eval rows are copied unchanged from stage10222, stage10213, stage10200, and stage10149",
            "all narrow evidence-coherence refresh rows derive only from train split rows",
