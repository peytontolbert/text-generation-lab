#!/usr/bin/env python3
"""Refresh support supply after codex-utils-string Rust admission."""
...
STAGE = 11851
NAME = "stage11851_source_heldout_support_supply_status_v26"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v26.json"
...
RUST = ART / "stage11850_rust_verifier_support_combined_audit_v10/rust_verifier_support_combined_audit_v10.json"
...
def main() -> None:
    ...
    artifact = {
        ...
        "next_actions": ["Continue Python verifier expansion beyond 8/12 roots.", "Continue C/C++ abstain-attractor expansion beyond 7/16 roots.", f"Continue Rust verifier expansion beyond {rust_roots}/12 roots."],
