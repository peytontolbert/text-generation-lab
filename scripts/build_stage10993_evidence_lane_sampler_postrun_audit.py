...
STAGE = 10993
NAME = "stage10993_evidence_lane_sampler_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "evidence_lane_sampler_postrun_audit.json"
RUNTIME_BUNDLE = ARTIFACTS / "stage10992_evidence_lane_sampler_support_probe" / "runtime_model" / "runtime_model_bundle.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "passed": True,
        "claim_scope": [
            "Audit the evidence-lane-sampler runtime against the unchanged overlay and the two live residual slices.",
            "Measure whether changing optimization geometry improves the residual boundaries without regressing the honest heldout frontier.",
        ],
        ...
        "next_best_step": "Compare these results against stage10986 and the standing overlay baseline to decide whether sampler geometry changes are enough or whether deeper target/interface changes are still needed.",
    }
