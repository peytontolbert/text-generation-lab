...
STAGE = 11339
NAME = 'stage11339_web_source_snippet_current_runtime_score'
OUT = ART / NAME
SUMMARY = OUT / 'web_source_snippet_current_runtime_score.json'
RUNTIME = ART / 'stage11200_role_focused_residual_probe/runtime_model/runtime_model_bundle.json'
SPLITS = {
...
def main() -> None:
    ...
    summary = {
        ...
        'passed': True,
        'decision': 'web_source_snippet_current_runtime_score_complete',
