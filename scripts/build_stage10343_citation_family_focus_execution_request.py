...
STAGE = 10343
NAME = "stage10343_citation_family_focus_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
MANIFEST_JSONL = OUT_DIR / "citation_family_focus_manifest.jsonl"
REQUEST_JSON = OUT_DIR / "citation_family_focus_execution_request.json"
COMMAND_JSON = OUT_DIR / "citation_family_focus_command.json"
...
RUN_ID = "stage10344_citation_family_focus_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10344_citation_family_focus_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10344_citation_family_focus_probe/runtime_model"
MAX_STEPS = 56
LEARNING_RATE = "8e-6"
BATCH_SIZE = 2
...
def main() -> None:
    ...
    frontloaded_rows = cpp_citation_rows + rust_citation_rows + web_support_rows + python_candidate_rows + python_verifier_rows
    ...
    request = {
        ...
        "required_honesty_gates": [
            ...
            "citation-family rows are frontloaded first with full rust coverage to test whether the remaining offsets are order-sensitive",
        ],
        "next_best_step": "run one citation-family-focus probe and check whether citation-first ordering plus full rust coverage clears the remaining 12 evidence-citation misses",
        "command": command,
