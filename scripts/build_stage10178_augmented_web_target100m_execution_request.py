...
STAGE = 10178
NAME = "stage10178_augmented_web_target100m_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST = OUT_DIR / "augmented_web_target100m_execution_request.json"
COMMAND_JSON = OUT_DIR / "augmented_web_target100m_command.json"
MANIFEST = OUT_DIR / "augmented_web_target100m_manifest.jsonl"
...
RUN_ID = "stage10179_augmented_web_target100m_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10179_augmented_web_target100m_probe/bounded_decoder_probe"
...
def command(package_rows: int, split_counts: dict[str, int]) -> list[str]:
    return [
        "env",
        f"TMPDIR={TMPDIR}",
        f"TEMP={TMPDIR}",
...
def build_request() -> dict[str, Any]:
    ...
    cmd = command(len(rows), split_counts)
    req = {
        "stage": STAGE,
        "stage_name": NAME,
