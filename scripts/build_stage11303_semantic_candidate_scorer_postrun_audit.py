...
STAGE = 11303
NAME = "stage11303_semantic_candidate_scorer_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "semantic_candidate_scorer_postrun_audit.json"
RUNTIME_BUNDLE = ARTIFACTS / "stage11302_semantic_candidate_scorer_probe/runtime_model/runtime_model_bundle.json"
REQUEST_JSON = ARTIFACTS / "stage11301_semantic_candidate_scorer_probe_request/semantic_candidate_scorer_probe_request.json"
PACKAGE_SUMMARY = ARTIFACTS / "stage11296_capped_fact_rich_verifier_package/capped_fact_rich_verifier_package.json"
...
JUDGMENT_VALIDATION = ARTIFACTS / "stage11296_capped_fact_rich_verifier_package/capped_fact_rich_verifier_validation_rows.jsonl"
JUDGMENT_STRICT = ARTIFACTS / "stage11296_capped_fact_rich_verifier_package/capped_fact_rich_verifier_strict_rows.jsonl"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "semantic_candidate_scorer_postrun_audit_complete",
