...
STAGE = 10796
NAME = 'stage10796_deleaked_python_support_probe_request'
OUT_DIR = ARTIFACTS / NAME
REQUEST_JSON = OUT_DIR / 'deleaked_python_support_probe_request.json'
COMMAND_JSON = OUT_DIR / 'deleaked_python_support_probe_command.json'
MANIFEST_JSONL = OUT_DIR / 'deleaked_python_support_probe_manifest.jsonl'

PACKAGE_JSON = ARTIFACTS / 'stage10794_deleaked_python_overflow_support_package' / 'deleaked_python_overflow_support_package.json'
TRAIN_ROWS = ARTIFACTS / 'stage10794_deleaked_python_overflow_support_package' / 'agentkernel_lite_encdec_train.jsonl'
VALIDATION_ROWS = ARTIFACTS / 'stage10794_deleaked_python_overflow_support_package' / 'agentkernel_lite_encdec_validation.jsonl'
STRICT_ROWS = ARTIFACTS / 'stage10794_deleaked_python_overflow_support_package' / 'agentkernel_lite_encdec_strict_eval.jsonl'
STRESS_ROWS = ARTIFACTS / 'stage10794_deleaked_python_overflow_support_package' / 'agentkernel_lite_encdec_stress_eval.jsonl'

INIT_RUNTIME = ARTIFACTS / 'stage10788_larger_root_split_support_probe' / 'runtime_model' / 'runtime_model_bundle.json'
...
RUN_ID = 'stage10797_deleaked_python_support_probe'
OUTPUT_DIR = 'runs/local/artifacts/stage10797_deleaked_python_support_probe/bounded_decoder_probe'
RUNTIME_MODEL_DIR = 'runs/local/artifacts/stage10797_deleaked_python_support_probe/runtime_model'
...
def main() -> None:
    ...
    request = {
        ...
        'decision': 'deleaked_python_support_probe_ready',
        ...
        'claim_scope': [
            'Run the next standalone support probe from the de-leaked Python-expanded root-split package.',
            'Keep the honest 24-row strict frontier fixed while testing whether the wider, leak-clean Python support actually moves the plateau.',
        ],
        'required_honesty_gates': [
            'strict and validation rows remain unchanged from the honest reviewed v2.7 frontier',
            'all added Python overflow support rows come from the de-leaked stage10794 package',
        ...
        'next_best_step': 'run the probe, then audit whether leak-clean Python support changes the honest 24-row frontier without regressions',
    }
