...
STAGE = 10180
NAME = "stage10180_augmented_web_scaled_step_target100m_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST = OUT_DIR / "augmented_web_scaled_step_target100m_execution_request.json"
COMMAND_JSON = OUT_DIR / "augmented_web_scaled_step_target100m_command.json"
MANIFEST = OUT_DIR / "augmented_web_scaled_step_target100m_manifest.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
PACKAGE = ROOT / "runs/local/artifacts/stage10177_augmented_web_permutation_balanced_package/augmented_web_permutation_balanced_package.json"
...
RUN_ID = "stage10181_augmented_web_scaled_step_target100m_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10181_augmented_web_scaled_step_target100m_probe/bounded_decoder_probe"
MAX_STEPS = 224
...
def build_request() -> dict[str, Any]:
    ...
    req = {
        ...
        "required_honesty_gates": [
            ...
            "augmented web package remains auxiliary and does not promote a maintainer-grade claim on its own",
            "web strict eval remains the original bddy index.html root while code_assist only expands web training support",
            "scaled-step follow-up is intended to test optimization-budget recovery, not to relabel the benchmark",
        ],
    }
