...
STAGE = 10345
NAME = "stage10345_citation_counterbalance_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
MANIFEST_JSONL = OUT_DIR / "citation_counterbalance_manifest.jsonl"
REQUEST_JSON = OUT_DIR / "citation_counterbalance_execution_request.json"
COMMAND_JSON = OUT_DIR / "citation_counterbalance_command.json"
...
RUN_ID = "stage10346_citation_counterbalance_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10346_citation_counterbalance_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10346_citation_counterbalance_probe/runtime_model"
MAX_STEPS = 64
LEARNING_RATE = "8e-6"
BATCH_SIZE = 2
...
def main() -> None:
    ...
    request = {
        ...
        "required_honesty_gates": [
            ...
            "python verifier rows remain present so the stage10342 repair is not discarded",
            "citation support adds contrast and weakness rows instead of only replaying the unresolved base permutations",
        ],
        "next_best_step": "run one citation-counterbalance probe and check whether added c_cpp/rust contrast support clears citation misses without rebreaking python verifier_outcome",
        "command": command,
