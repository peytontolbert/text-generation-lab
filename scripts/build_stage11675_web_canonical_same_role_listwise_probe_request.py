...
STAGE = 11675
NAME = "stage11675_web_canonical_same_role_listwise_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "web_canonical_same_role_listwise_probe_request.json"
...
RUN_DIR = ART / "stage11675_web_canonical_same_role_listwise_probe"
...
def main() -> None:
    ...
    summary = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "web_canonical_same_role_listwise_probe_ready" if all(gates.values()) else "web_canonical_same_role_listwise_probe_blocked",
        ...
        "claim_boundary": [
            "This is a head-only diagnostic over the canonical Web renderer with generic same-role candidate listwise loss.",
