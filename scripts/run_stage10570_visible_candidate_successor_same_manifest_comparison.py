...
STAGE = 10570
NAME = "stage10570_visible_candidate_successor_same_manifest_comparison"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
SUMMARY_PATH = OUT_DIR / "visible_candidate_successor_same_manifest_comparison.json"
...
RUNTIME_BUNDLE = ROOT / "runs/local/artifacts/stage10567_visible_candidate_decisive_evidence_probe/runtime_model/runtime_model_bundle.json"
EXECUTION_RESULT = ROOT / "runs/local/artifacts/stage10567_visible_candidate_decisive_evidence_probe/bounded_decoder_probe/execution_result.json"
MODEL_ID = "gemma3:12b"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Same-surface seq2seq generation on the strict rows from stage10555 using the stage10556 preservation-aware successor runtime.",
