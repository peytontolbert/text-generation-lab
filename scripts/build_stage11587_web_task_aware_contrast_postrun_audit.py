...
STAGE = 11587
NAME = "stage11587_web_task_aware_contrast_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_task_aware_contrast_postrun_audit.json"

RUNTIME = ART / "stage11586_web_task_aware_contrast_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "promote_if_all_gates_pass" if all(gates.values()) else "do_not_promote_web_task_aware_contrast_runtime",
        "runtime": rel(RUNTIME),
        "device": str(DEVICE),
        "scorer": SCORER,
        "results": results,
