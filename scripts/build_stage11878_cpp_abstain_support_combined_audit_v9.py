#!/usr/bin/env python3
"""Combined C/C++ abstain-attractor support audit including additional benchmark roots."""
...
STAGE = 11878
NAME = "stage11878_cpp_abstain_support_combined_audit_v9"
OUT = ART / NAME
SUMMARY = OUT / "cpp_abstain_support_combined_audit_v9.json"
COMBINED_ROWS = OUT / "cpp_abstain_support_rows_v9.jsonl"

ROW_SOURCES = [
    ART / "stage11874_cpp_abstain_support_combined_audit_v8/cpp_abstain_support_rows_v8.jsonl",
    ART / "stage11877_cpp_benchmark_extra_abstain_support_rows/cpp_benchmark_extra_abstain_support_rows.jsonl",
]
...
def main() -> None:
    ...
    artifact = {
        ...
        "decision": "cpp_abstain_support_quota_satisfied" if len(roots) >= 16 else "cpp_abstain_support_rows_admitted_but_quota_incomplete",
        ...
        "same_repo_family_warning": "google_benchmark contributes multiple train-support roots; use for quota closure/probe support, not source-heldout breadth claims.",
        "audited_rows": audited,
        "claim_boundary": [
            "Rows are train-support-only for C/C++ abstain-attractor repair.",
            "Quota closure does not imply source-heldout C/C++ breadth.",
        ],
