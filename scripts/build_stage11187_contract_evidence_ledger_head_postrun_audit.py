...
STAGE = 11187
NAME = "stage11187_contract_evidence_ledger_head_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "contract_evidence_ledger_head_postrun_audit.json"

RUNTIME_BUNDLE = ARTIFACTS / "stage11186_contract_evidence_ledger_head_probe/runtime_model/runtime_model_bundle.json"
EXECUTION_JSON = ARTIFACTS / "stage11186_contract_evidence_ledger_head_probe/bounded_decoder_probe/execution_result.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "claim_scope": [
            "Audit stage11186 after training the evidence-ledger head on contract-aware evidence train support.",
