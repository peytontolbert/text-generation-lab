...
STAGE = 10846
NAME = "stage10846_residual_family_rebalanced_probe_request"
OUT_DIR = ARTIFACTS / NAME
REQUEST_JSON = OUT_DIR / "residual_family_rebalanced_probe_request.json"
COMMAND_JSON = OUT_DIR / "residual_family_rebalanced_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "residual_family_rebalanced_probe_manifest.jsonl"

PACKAGE_JSON = ARTIFACTS / "stage10844_residual_family_rebalanced_support_package" / "residual_family_rebalanced_support_package.json"
TRAIN_ROWS = ARTIFACTS / "stage10844_residual_family_rebalanced_support_package" / "agentkernel_lite_encdec_train.jsonl"
VALIDATION_ROWS = ARTIFACTS / "stage10844_residual_family_rebalanced_support_package" / "agentkernel_lite_encdec_validation.jsonl"
STRICT_ROWS = ARTIFACTS / "stage10844_residual_family_rebalanced_support_package" / "agentkernel_lite_encdec_strict_eval.jsonl"
STRESS_ROWS = ARTIFACTS / "stage10844_residual_family_rebalanced_support_package" / "agentkernel_lite_encdec_stress_eval.jsonl"
...
RUN_ID = "stage10847_residual_family_rebalanced_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10847_residual_family_rebalanced_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10847_residual_family_rebalanced_probe/runtime_model"
...
def main() -> None:
    ...
    request = {
        ...
        "decision": "residual_family_rebalanced_probe_ready",
        ...
        "claim_scope": [
            "Run a residual-family diagnostic probe from the rebalanced support package with frozen validation and strict overlays.",
            "Lower preservation pressure relative to stage10840 so the runtime has a better chance to move the remaining verifier and evidence decision boundaries.",
        ],
        "required_honesty_gates": [
            "strict and validation rows remain unchanged from stage10844",
        ...
        "next_best_step": "Run the probe only as a diagnostic package, then compare the saved runtime on the unchanged strict overlay and inspect whether the two residual families move without regressions.",
    }
