...
STAGE = 11129
NAME = "stage11129_trainable_evidence_ledger_head_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "trainable_evidence_ledger_head_postrun_audit.json"
...
RUNTIME_BUNDLE = ARTIFACTS / "stage11128_trainable_evidence_ledger_head_probe" / "runtime_model" / "runtime_model_bundle.json"
VALIDATION_JSON = ARTIFACTS / "stage11128_trainable_evidence_ledger_head_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_eval.json"
STRICT_JSON = ARTIFACTS / "stage11128_trainable_evidence_ledger_head_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_strict_eval.json"
EXECUTION_JSON = ARTIFACTS / "stage11128_trainable_evidence_ledger_head_probe" / "bounded_decoder_probe" / "execution_result.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Audit the stage11125 persistent evidence-ledger scorer runtime against unchanged successor validation/strict and untouched reserved residual candidates.",
            "Decide whether the evidence-ledger scorer architecture moved the evidence lane beyond the stage11117 encoder-option-retrieval baseline.",
        ],
        "bounded_choice_aux_source": scorer_source,
        "source_artifacts": {
        ...
        "decision": (
            "evidence_ledger_scorer_promotable_frontier_gain"
            if strict_gate and reserved_gate and reserved_evidence_gate
            else "evidence_ledger_scorer_diagnostic_only_move_to_fresh_non_aliased_roots_or_stronger_objective"
        ),
        "headline_findings": [
            "This is the first audit of a saved evidence-ledger scorer runtime on the latest trainable evidence package.",
