...
STAGE = 10184
NAME = "stage10184_hybrid_web_surface_rebalanced_target100m_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST = OUT_DIR / "hybrid_web_surface_rebalanced_target100m_execution_request.json"
COMMAND_JSON = OUT_DIR / "hybrid_web_surface_rebalanced_target100m_command.json"
MANIFEST = OUT_DIR / "hybrid_web_surface_rebalanced_target100m_manifest.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
PACKAGE = ROOT / "runs/local/artifacts/stage10183_hybrid_web_surface_rebalanced_package/hybrid_web_surface_rebalanced_package.json"
...
RUN_ID = "stage10185_hybrid_web_surface_rebalanced_target100m_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10185_hybrid_web_surface_rebalanced_target100m_probe/bounded_decoder_probe"
MAX_STEPS = 224
...
def build_request() -> dict[str, Any]:
    ...
    req = {
        ...
        "required_honesty_gates": [
            ...
            "hybrid web package remains auxiliary and does not promote a maintainer-grade claim on its own",
            "web strict eval remains the original bddy index.html root",
            "code_assist web replenishment is restricted to verifier and abstention supervision because its candidate-path gold targets a backend surface rather than the held-out frontend target family",
            "the 224-step budget is preserved so the package tests web rebalance rather than a step-count confound",
        ],
    }
