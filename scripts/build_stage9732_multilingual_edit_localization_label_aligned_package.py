...
STAGE = 9732
NAME = "stage9732_multilingual_edit_localization_label_aligned_package"
...
MANIFEST = OUT_DIR / "multilingual_edit_localization_label_aligned.jsonl"
AUDIT = OUT_DIR / "multilingual_edit_localization_label_aligned_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "MULTILINGUAL_EDIT_LOCALIZATION_LABEL_ALIGNED_PACKAGE_STAGE9732.md"
...
def main() -> None:
    ...
    next_step = "Run Stage9733 target-100M execution on the label-aligned multilingual edit-localization package and compare against the Stage9729 zero-exact baseline."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Materialized a label-aligned multilingual edit-localization package so train, eval, and strict-eval share the same target label inventory across all four languages.",
