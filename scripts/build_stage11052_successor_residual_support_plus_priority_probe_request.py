...
STAGE = 11052
NAME = "stage11052_successor_residual_support_plus_priority_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "successor_residual_support_plus_priority_probe_request.json"
COMMAND_JSON = OUT_DIR / "successor_residual_support_plus_priority_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "successor_residual_support_plus_priority_probe_manifest.jsonl"

PACKAGE_DIR = ARTIFACTS / "stage11051_successor_residual_support_plus_priority_evidence"
PACKAGE_JSON = PACKAGE_DIR / "successor_residual_support_plus_priority_evidence.json"
...
PROBE_OUT_DIR = ARTIFACTS / "stage11053_successor_residual_support_plus_priority_probe" / "bounded_decoder_probe"
RUNTIME_OUT_DIR = ARTIFACTS / "stage11053_successor_residual_support_plus_priority_probe" / "runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "successor_residual_support_plus_priority_probe_requested",
        "claim_scope": [
            "Run one bounded probe from the stage11051 support package that includes the five stage11045 evidence-role support rows.",
            "Keep the successor overlay and the reserved residual bank reported separately.",
        ],
        "source_artifacts": {
        ...
        "metrics": {
            ...
            "priority_support_rows_added": package.get("metrics", {}).get("added_priority_evidence_rows"),
        },
        "required_honesty_gates": [
            "The five stage11045 rows are train support and must not be reported as heldout improvement.",
            "Successor validation and strict remain the main scored overlay and must stay under encoder_option_retrieval.",
            "Reserved candidate reporting must remain separate from the successor overlay and from the trained priority evidence rows.",
        ],
