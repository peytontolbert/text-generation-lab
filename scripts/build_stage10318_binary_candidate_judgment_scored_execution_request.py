...
STAGE = 10318
NAME = "stage10318_binary_candidate_judgment_scored_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
INVENTORY_JSON = OUT_DIR / "binary_candidate_judgment_scored_inventory.json"
MANIFEST_JSONL = OUT_DIR / "binary_candidate_judgment_scored_manifest.jsonl"
REQUEST_JSON = OUT_DIR / "binary_candidate_judgment_scored_execution_request.json"
COMMAND_JSON = OUT_DIR / "binary_candidate_judgment_scored_command.json"
...
RUN_ID = "stage10319_binary_candidate_judgment_scored_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10319_binary_candidate_judgment_scored_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10319_binary_candidate_judgment_scored_probe/runtime_model"
LEARNING_RATE = "8e-6"
BATCH_SIZE = 2
...
def build() -> dict[str, Any]:
    ...
    request = {
        ...
        "created_at_utc": now_utc(),
        "passed": True,
        "decision": "binary_candidate_judgment_scored_probe_ready",
        ...
        "goal": "Measure whether binary candidate-judgment auxiliary supervision improves weak python/web action-taking rows without collapsing the existing strict frontier.",
    }
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
