...
STAGE = 9423
NAME = "stage9423_suffix_choice_control_probe_audit"
SOURCE_SUMMARY = ROOT / "runs/summaries/stage9422_suffix_choice_control_preexecution.json"
RUN_DIR = ROOT / "runs/local/artifacts/stage9423_suffix_choice_control_probe"
AUDIT = RUN_DIR / "stage9423_suffix_choice_control_probe_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "SUFFIX_CHOICE_CONTROL_PROBE_AUDIT_STAGE9423.md"
...
def main() -> None:
    ...
    if source.get("passed") is not True:
        failures.append("source_stage9422_not_passed")
    ...
    if losses.get("suffix_choice_ce") != 78:
