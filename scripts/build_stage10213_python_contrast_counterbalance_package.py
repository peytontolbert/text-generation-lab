...
STAGE = 10213
NAME = "stage10213_python_contrast_counterbalance_package"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
TRAIN_JSONL = OUT_DIR / "agentkernel_lite_encdec_train.jsonl"
EVAL_JSONL = OUT_DIR / "agentkernel_lite_encdec_eval.jsonl"
PACKAGE_JSON = OUT_DIR / "python_contrast_counterbalance_package.json"
...
CONTRAST_SPECS = [
    {
        "name": "python_evidence_verifier_vs_candidate",
        "task_type": "evidence_citation",
        "language_family": "python",
        "gold_value": "verifier_and_test_constraint",
        "contrast_values": ["verifier_and_test_constraint", "candidate_change_surface"],
    },
    {
        "name": "python_evidence_verifier_vs_nearby",
        "task_type": "evidence_citation",
        "language_family": "python",
        "gold_value": "verifier_and_test_constraint",
        "contrast_values": ["verifier_and_test_constraint", "nearby_definition_or_usage_context"],
    },
    {
        "name": "python_evidence_verifier_vs_background",
        "task_type": "evidence_citation",
        "language_family": "python",
        "gold_value": "verifier_and_test_constraint",
        "contrast_values": ["verifier_and_test_constraint", "algorithmic_background_reference"],
    },
    {
        "name": "python_evidence_verifier_vs_external",
        "task_type": "evidence_citation",
        "language_family": "python",
        "gold_value": "verifier_and_test_constraint",
        "contrast_values": ["verifier_and_test_constraint", "external_analogue_reference"],
    },
    {
        "name": "python_evidence_verifier_vs_symptom",
        "task_type": "evidence_citation",
        "language_family": "python",
        "gold_value": "verifier_and_test_constraint",
        "contrast_values": ["verifier_and_test_constraint", "symptom_or_call_path_analogue"],
    },
    {
        "name": "python_minfix_universe_vs_find_graph_stats",
        "task_type": "minimal_fix_selection",
        "language_family": "python",
        "gold_value": "scripts/universe_build.py",
        "contrast_values": ["scripts/universe_build.py", "arxiv-public-datasets/analysis/find_graph_stats.py"],
    },
    {
        "name": "python_minfix_universe_vs_gcn_classification",
        "task_type": "minimal_fix_selection",
        "language_family": "python",
        "gold_value": "scripts/universe_build.py",
        "contrast_values": ["scripts/universe_build.py", "arxiv-public-datasets/analysis/kipf_welling_GCN/GCN_classification.py"],
    },
    {
        "name": "python_minfix_universe_vs_domain_counts",
        "task_type": "minimal_fix_selection",
        "language_family": "python",
        "gold_value": "scripts/universe_build.py",
        "contrast_values": ["scripts/universe_build.py", "scripts/arxiv_domain_counts.py"],
    },
    {
        "name": "python_minfix_universe_vs_build_py",
        "task_type": "minimal_fix_selection",
        "language_family": "python",
        "gold_value": "scripts/universe_build.py",
        "contrast_values": ["scripts/universe_build.py", "build.py"],
    },
    {
        "name": "python_minfix_universe_vs_algorithms_seed",
        "task_type": "minimal_fix_selection",
        "language_family": "python",
        "gold_value": "scripts/universe_build.py",
        "contrast_values": ["scripts/universe_build.py", "scripts/algorithms_seed_from_python_algorithms.py"],
    },
    {
        "name": "python_patch_universe_vs_find_graph_stats",
    ...
    {
        "name": "python_patch_universe_vs_gcn_classification",
        "task_type": "patch_impact",
        "language_family": "python",
        "gold_value": "scripts/universe_build.py",
        "contrast_values": ["scripts/universe_build.py", "arxiv-public-datasets/analysis/kipf_welling_GCN/GCN_classification.py"],
    ...
    {
        "name": "python_patch_universe_vs_domain_counts",
        "task_type": "patch_impact",
        "language_family": "python",
        "gold_value": "scripts/universe_build.py",
        "contrast_values": ["scripts/universe_build.py", "scripts/arxiv_domain_counts.py"],
    ...
    {
        "name": "python_patch_universe_vs_build_py",
        "task_type": "patch_impact",
        "language_family": "python",
        "gold_value": "scripts/universe_build.py",
        "contrast_values": ["scripts/universe_build.py", "build.py"],
    ...
    {
        "name": "python_patch_universe_vs_algorithms_seed",
        "task_type": "patch_impact",
        "language_family": "python",
        "gold_value": "scripts/universe_build.py",
        "contrast_values": ["scripts/universe_build.py", "scripts/algorithms_seed_from_python_algorithms.py"],
...
def build_contrast_rows(base_row: dict[str, Any], spec: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    for idx, ordered_values in enumerate(unique_orders):
        ...
        anti_cheat.update({
            ...
            "python_label_prior_counterbalance": True,
...
def build_package() -> dict[str, Any]:
    ...
    package = {
        ...
        "required_honesty_gates": [
            "strict eval rows are copied unchanged from stage10200 and stage10149",
            "all python counterbalance rows derive only from train split rows",
            "python counterbalance package remains auxiliary and does not upgrade the maintainer-grade claim",
