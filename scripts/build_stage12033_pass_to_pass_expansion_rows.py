#!/usr/bin/env python3
"""Materialize additional verifier-backed PASS_TO_PASS transition observations."""
...
ROOT = Path("runs/local/artifacts/stage12033_pass_to_pass_expansion_rows")
ROWS = ROOT / "pass_to_pass_expansion_rows.jsonl"
SUMMARY = ROOT / "pass_to_pass_expansion_rows.json"
SUMMARY_MIRROR = Path("runs/summaries/stage12033_pass_to_pass_expansion_rows.json")
...
OBSERVATIONS: list[dict[str, Any]] = [
    {
        ...
        "selected_verifier_path": "einops/tests/test_layers.py",
        "command": "env EINOPS_TEST_BACKENDS=numpy python -m pytest -q -c /dev/null -o cache_dir=/data/tmp/stage12033_pytest_cache einops/tests/test_layers.py",
        "returncode": 0,
        "stdout_tail": "6 passed, 4 skipped, 1 warning in 0.48s",
    },
    {
        "language_family": "python",
        "repo_family": "lastmile-ai__mcp-agent",
        "cwd": "/data/repositories/lastmile-ai__mcp-agent",
        "selected_verifier_path": "tests/utils/test_mime_utils.py + tests/config/test_env_settings.py",
        "command": "env PYTHONPATH=/data/repositories/lastmile-ai__mcp-agent/src python -m pytest -q -c /dev/null -o cache_dir=/data/tmp/stage12033_pytest_cache tests/utils/test_mime_utils.py tests/config/test_env_settings.py",
        "returncode": 0,
        "stdout_tail": "38 passed in 0.54s",
    },
    {
        ...
        "command": "cargo test --manifest-path /data/repositories/tokenizers/tokenizers/Cargo.toml --features fancy-regex decoders::ctc::tests::handmade_sample --quiet",
        "returncode": 0,
    ...
    },
    {
        ...
        "repo_family": "tokenizers",
        "cwd": "/data/repositories/tokenizers",
        "selected_verifier_path": "tokenizers::decoders::fuse::tests::decode",
    ...
    },
    {
        ...
        "command": "cargo test --manifest-path /data/repositories/tokenizers/tokenizers/Cargo.toml --features fancy-regex decoders::sequence::tests::sequence_basic --quiet",
        "returncode": 0,
        "stdout_tail": "running 1 test; ok. 1 passed; 0 failed; 191 filtered out",
    },
    {
        ...
        "repo_family": "tokenizers",
        "cwd": "/data/repositories/tokenizers",
        "selected_verifier_path": "tokenizers::models::unigram::lattice::tests::test_viterbi",
    ...
    },
    {
        ...
        "selected_verifier_path": "packages/core/test/shared/transport.test.ts",
        "command": "./node_modules/.bin/vitest run --globals packages/core/test/shared/transport.test.ts",
        "returncode": 0,
        "stdout_tail": "Test Files 1 passed; Tests 13 passed",
    },
    {
        "language_family": "web_js_ts_html",
        "repo_family": "modelcontextprotocol__typescript-sdk",
        "cwd": "/data/repositories/modelcontextprotocol__typescript-sdk",
        "selected_verifier_path": "packages/core/test/shared/customMethods.test.ts",
        "command": "./node_modules/.bin/vitest run --globals packages/core/test/shared/customMethods.test.ts",
        "returncode": 0,
        "stdout_tail": "Test Files 1 passed; Tests 13 passed",
    },
    {
        ...
        "selected_verifier_path": "src/lib/badges.test.ts",
        "command": "env VITE_CONVEX_URL=https://example.invalid ./node_modules/.bin/vitest run src/lib/badges.test.ts",
        "returncode": 0,
        "stdout_tail": "Test Files 1 passed; Tests 13 passed",
    },
]
...
REJECTED_PROBES = [
    {
        "repo_family": "lastmile-ai__mcp-agent",
        "command": "env PYTHONPATH=/data/repositories/lastmile-ai__mcp-agent/src python -m pytest -q -c /dev/null -o cache_dir=/data/tmp/stage12033_pytest_cache tests/utils/test_config_preload.py",
        "returncode": 2,
        "reason": "collection failed because pydantic_yaml is missing; not admitted as verifier-backed PASS_TO_PASS",
    }
]
...
def make_row(obs: dict[str, Any]) -> dict[str, Any]:
    ...
    row_id = f"stage12033::{obs['repo_family']}::{hashlib.sha1(material.encode()).hexdigest()[:12]}::{semantic}"
    ...
    return {
        "row_id": row_id,
        "root_id": row_id,
        "root_lineage_key": f"stage12033::{obs['repo_family']}::{obs['selected_verifier_path']}",
        ...
        "split": "train",
        "split_role": "stage12033_pass_to_pass_expansion_train_support_only",
        ...
        "standalone_projection_source": {
            "projection_mode": "stage12033_pass_to_pass_expansion_rows",
...
def main() -> None:
    ...
    summary = {
        "stage": "stage12033_pass_to_pass_expansion_rows",
        "rows_path": str(ROWS),
        ...
        "next_stage_recommendation": {
            "stage": "stage12034_transition_support_rollup_v24",
            "action": "Merge PASS_TO_PASS rows and report remaining Transition-Root-250 floors.",
        },
    }
