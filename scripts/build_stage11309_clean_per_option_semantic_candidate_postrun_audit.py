...
STAGE = 11309
NAME = "stage11309_clean_per_option_semantic_candidate_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "clean_per_option_semantic_candidate_postrun_audit.json"
RUNTIME_BUNDLE = ARTIFACTS / "stage11308_clean_per_option_semantic_candidate_probe/runtime_model/runtime_model_bundle.json"
REQUEST_JSON = ARTIFACTS / "stage11307_clean_per_option_semantic_candidate_probe_request/clean_per_option_semantic_candidate_probe_request.json"
PACKAGE_SUMMARY = ARTIFACTS / "stage11306_clean_per_option_semantic_candidate_package/clean_per_option_semantic_candidate_package.json"
PACKAGE_AUDIT = PACKAGE_SUMMARY
CLEAN_STRICT = ARTIFACTS / "stage11306_clean_per_option_semantic_candidate_package/clean_per_option_semantic_candidate_strict_rows.jsonl"
CLEAN_VALIDATION = ARTIFACTS / "stage11306_clean_per_option_semantic_candidate_package/clean_per_option_semantic_candidate_validation_rows.jsonl"
JUDGMENT_VALIDATION = ARTIFACTS / "stage11306_clean_per_option_semantic_candidate_package/clean_per_option_semantic_candidate_judgment_validation_rows.jsonl"
JUDGMENT_STRICT = ARTIFACTS / "stage11306_clean_per_option_semantic_candidate_package/clean_per_option_semantic_candidate_judgment_strict_rows.jsonl"
RESIDUAL_BANK = ARTIFACTS / "stage11306_clean_per_option_semantic_candidate_package/clean_per_option_semantic_candidate_residual_rows.jsonl"
SCORERS = ["encoder_option_retrieval_semantic_candidate_head", "encoder_option_retrieval_evidence_judgment_head", "encoder_option_retrieval_verifier_conditioned", "decoder_first_step", "encoder_option_retrieval"]
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "clean_per_option_semantic_candidate_postrun_audit_complete",
