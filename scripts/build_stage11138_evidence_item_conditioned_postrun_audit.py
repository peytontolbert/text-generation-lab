...
STAGE = 11138
NAME = "stage11138_evidence_item_conditioned_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "evidence_item_conditioned_postrun_audit.json"
...
RUNTIME_BUNDLE = ARTIFACTS / "stage11137_evidence_item_conditioned_probe" / "runtime_model" / "runtime_model_bundle.json"
VALIDATION_JSON = ARTIFACTS / "stage11137_evidence_item_conditioned_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_eval.json"
STRICT_JSON = ARTIFACTS / "stage11137_evidence_item_conditioned_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_strict_eval.json"
EXECUTION_JSON = ARTIFACTS / "stage11137_evidence_item_conditioned_probe" / "bounded_decoder_probe" / "execution_result.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Audit the stage11137 evidence-item conditioned runtime against unchanged successor validation/strict and untouched reserved residual candidates.",
            "This tests conditioned evidence-item option geometry, not role-name support or a custom scorer head.",
        ],
        "bounded_choice_aux_source": scorer_source,
        "source_artifacts": {
        ...
        "decision": (
            "evidence_item_conditioned_probe_promotable_frontier_gain"
            if strict_gate and validation_gate and reserved_gate and reserved_evidence_gate
            else "evidence_item_conditioned_probe_diagnostic_only"
        ),
        "runtime_bundle": {
