#!/usr/bin/env python3
"""Combined Python verifier support audit including hyper-connections."""
...
STAGE = 11862
NAME = "stage11862_python_verifier_support_combined_audit_v11"
OUT = ART / NAME
SUMMARY = OUT / "python_verifier_support_combined_audit_v11.json"
COMBINED_ROWS = OUT / "python_verifier_support_combined_rows_v11.jsonl"

BASE_AUDIT = ART / "stage11858_python_verifier_support_combined_audit_v10/python_verifier_support_combined_audit_v10.json"
BASE_ROWS = ART / "stage11858_python_verifier_support_combined_audit_v10/python_verifier_support_combined_rows_v10.jsonl"
NEW_ROWS = ART / "stage11861_hyper_connections_python_support_rows/hyper_connections_python_support_rows.jsonl"
...
def main() -> None:
    ...
    artifact: dict[str, Any] = {
        ...
        "decision": "hyper_connections_admitted_quota_incomplete",
