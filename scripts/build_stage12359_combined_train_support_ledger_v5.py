...
STAGE = "stage12359_combined_train_support_ledger_v5"
OUT = ROOT / "runs/local/artifacts" / STAGE
SUMMARY = ROOT / "runs/summaries" / f"{STAGE}.json"
EXTRA = ROOT / "runs/local/artifacts/stage12358_mixed_selected_test_admissions/mixed_selected_test_train_support_rows.jsonl"
...
def main() -> None:
    ...
    source_counts["stage12358_mixed_selected_test"] = len(extra_rows)
    ...
    ledger.update({
        "stage": STAGE,
        "decision": "combined_train_support_ledger_v5_ready_500_not_reached",
    ...
    (OUT / "combined_train_support_ledger_v5.json").write_text(json.dumps(ledger, indent=2, sort_keys=True) + "\n", encoding="utf-8")
