...
STAGE = 10335
NAME = "stage10335_balanced_web_python_cpp_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
MANIFEST_JSONL = OUT_DIR / "balanced_web_python_cpp_manifest.jsonl"
REQUEST_JSON = OUT_DIR / "balanced_web_python_cpp_execution_request.json"
COMMAND_JSON = OUT_DIR / "balanced_web_python_cpp_command.json"
...
RUN_ID = "stage10336_balanced_web_python_cpp_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10336_balanced_web_python_cpp_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10336_balanced_web_python_cpp_probe/runtime_model"
MAX_STEPS = 56
LEARNING_RATE = "8e-6"
BATCH_SIZE = 2
...
def main() -> None:
    ...
    cpp_anchor_rows = [
        clone_row(row, stage_prefix="stage10335_cpp_anchor", query_suffix=f"anchor_{idx:02d}")
    ...
    request = {
        ...
        "passed": True,
        "decision": "balanced_web_python_cpp_successor_ready",
        ...
        "required_honesty_gates": [
            ...
            "c_cpp evidence-citation anchor rows explicitly preserve the stable candidate_change_surface evidence prior",
        ],
        "next_best_step": "run one balanced warm-start probe and promote it only if python action gains survive without any web or c_cpp regression",
        "command": command,
