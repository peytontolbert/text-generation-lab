...
try:
    from scripts.build_stage9175_trainer_setup_emit_instance_design import (
        EMITTABLE_OUTPUTS,
    ...
    from build_stage9175_trainer_setup_emit_instance_design import (  # type: ignore
        EMITTABLE_OUTPUTS,
        REQUIRED_INSTANCE_GUARDS,
        REQUIRED_INSTANCE_REFS,
        STILL_BLOCKED_OUTPUTS,
...
STAGE = 9176
NAME = "stage9176_trainer_setup_emit_instance_audit"
REGISTRY = ROOT / "runs/local/artifacts/reconstructed_stage_registry.json"
SOURCE_9175 = ROOT / "runs/summaries/stage9175_trainer_setup_emit_instance_design.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "TRAINER_SETUP_EMIT_INSTANCE_AUDIT_STAGE9176.md"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT = OUT_DIR / "trainer_setup_emit_instance_audit.json"
...
def registry(latest: int = 9175) -> dict[str, Any]:
...
def build_audit(registry_card: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    source = load_json(SOURCE_9175)
    design = build_design(registry(9174))
    design_failures = validate_design(design)
    negatives = run_negative_cases()
    checks = {
        "source_stage9175_passed": source.get("passed") is True,
        ...
        "emit_instance_not_open_now": design["metrics"]["emit_instance_open_now"] is False,
        ...
        "registry_frontier_stage9175": int((registry_card.get("metrics") or {}).get("latest_stage", -1)) == 9175,
    ...
    return {
        ...
        "decision": "Audited the emit-instance design and kept output emission and all execution paths closed.",
        "next_best_step": "Stop at the emit-instance design boundary until a deliberate emitting instance is intentionally opened.",
    }
...
def main() -> None:
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage9176 Trainer Setup Emit-Instance Audit",
                "",
                f"Passed: `{summary['passed']}`",
                "",
                "Audits the emit-instance design without emitting outputs.",
                "",
