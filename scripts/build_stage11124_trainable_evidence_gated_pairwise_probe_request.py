...
STAGE = 11124
NAME = "stage11124_trainable_evidence_gated_pairwise_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "trainable_evidence_gated_pairwise_probe_request.json"
COMMAND_JSON = OUT_DIR / "trainable_evidence_gated_pairwise_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "trainable_evidence_gated_pairwise_probe_manifest.jsonl"
...
PROBE_OUT_DIR = ARTIFACTS / "stage11125_trainable_evidence_gated_pairwise_probe" / "bounded_decoder_probe"
RUNTIME_OUT_DIR = ARTIFACTS / "stage11125_trainable_evidence_gated_pairwise_probe" / "runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "trainable_evidence_gated_pairwise_probe_requested",
        "claim_scope": [
            "Train a persistent pairwise bounded-choice scorer head gated to evidence_citation rows on the current stage11114 trainable evidence support package.",
            "Keep validation and strict successor surfaces unchanged, then score the untouched reserved residual bank to test evidence-only scorer-objective alignment rather than support-row volume.",
        ],
        "source_artifacts": {
        ...
        "training_contract": {
            "bounded_choice_aux_source": "encoder_option_retrieval_evidence_pairwise_gated",
            ...
            "loader_requirement": "stage11120 proves saved pairwise heads are strictly reloadable by the production loader",
        },
        "promotion_gates": [
            "Strict successor accuracy must stay at or above 22/23, and validation must not repeat the global pairwise regression.",
        ...
        "next_best_step": "Execute this request, then run the stage11126 postrun audit over successor validation/strict and reserved residual candidates.",
        "outputs": {
