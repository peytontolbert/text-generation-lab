...
STAGE = 11381
NAME = "stage11381_web_sourcebot_abstention_preserved_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_sourcebot_abstention_preserved_postrun_audit.json"
RUNTIME = ART / "stage11380_web_sourcebot_abstention_preserved_probe/runtime_model/runtime_model_bundle.json"
BASELINE = ART / "stage11374_web_sourcebot_combined_current_score/web_sourcebot_combined_current_score.json"
SPLITS = {
    "stage11378_train_support": ART / "stage11378_web_sourcebot_plus_abstention_preservation_package/web_sourcebot_plus_abstention_preservation_rows.jsonl",
...
def main() -> None:
    ...
    decision = "accept_stage11380_as_diagnostic_support_runtime_keep_stage11200_frontier" if all(gates.values()) else "reject_stage11380_keep_stage11200_frontier"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        ...
        "recommended_next_action": "If validation still regresses, stop Web support probing and materialize true Web abstention roots before another run.",
    }
