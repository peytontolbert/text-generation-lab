#!/usr/bin/env python3
"""Combined admission audit for Rust verifier support including codex-utils-string."""
...
STAGE = 11850
NAME = "stage11850_rust_verifier_support_combined_audit_v10"
OUT = ART / NAME
SUMMARY = OUT / "rust_verifier_support_combined_audit_v10.json"
ADMITTED_ROWS = OUT / "rust_verifier_support_rows_v10.jsonl"
...
def main() -> None:
    ...
    artifact = {
        ...
        "claim_boundary": ["Rows are Rust verifier_outcome selected-inline-test train support only.", "This does not satisfy the full Stage11742 Rust quota or strict source-heldout proof."],
