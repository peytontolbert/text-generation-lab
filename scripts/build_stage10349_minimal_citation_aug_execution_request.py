...
STAGE = 10349
NAME = "stage10349_minimal_citation_aug_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
MANIFEST_JSONL = OUT_DIR / "minimal_citation_aug_manifest.jsonl"
REQUEST_JSON = OUT_DIR / "minimal_citation_aug_execution_request.json"
COMMAND_JSON = OUT_DIR / "minimal_citation_aug_command.json"
...
RUN_ID = "stage10350_minimal_citation_aug_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10350_minimal_citation_aug_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10350_minimal_citation_aug_probe/runtime_model"
MAX_STEPS = 24
LEARNING_RATE = "8e-6"
BATCH_SIZE = 2
...
def main() -> None:
    ...
    request = {
        ...
        "required_honesty_gates": [
            ...
            "full stage10342 solved support must remain present",
            "citation augmentation is minimal and targeted rather than replacing the repaired support geometry",
        ],
        "next_best_step": "run one minimal warm citation augmentation probe from stage10342 and check whether small targeted boosters improve citation families without regressing the repaired frontier",
        "command": command,
