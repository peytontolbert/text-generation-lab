...
NAME = "stage11696_web_identity_gap_topup_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_identity_gap_topup_postrun_audit.json"

WEB_RUNTIME = ART / "stage11675_web_canonical_same_role_listwise_probe/runtime_model/runtime_model_bundle.json"
IDENTITY_RUNTIME = ART / "stage11695_web_identity_gap_topup_probe/runtime_model/runtime_model_bundle.json"
...
def main() -> None:
    ...
    if gates["bridged_web_beats_gemma_56_of_66"] and protected_ok:
        decision = "web_identity_gap_topup_promotable_web_win_candidate"
    elif gates["bridged_web_beats_previous_53_of_66"] and protected_ok:
        decision = "web_identity_gap_topup_improves_not_yet_gemma_win"
    elif protected_ok:
        decision = "web_identity_gap_topup_preserves_but_no_web_gain"
    else:
        decision = "web_identity_gap_topup_rejected_protected_regression"
    summary = {
        "stage": 11696,
        "stage_name": NAME,
        "created_at_utc": now(),
        ...
        "claim_boundary": [
            "This is a routed two-runtime postrun audit: Stage11675 Web head plus Stage11695 identity head.",
