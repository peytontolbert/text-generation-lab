#!/usr/bin/env python3
"""Combined Python verifier support audit including einops."""
...
STAGE = 11858
NAME = "stage11858_python_verifier_support_combined_audit_v10"
OUT = ART / NAME
SUMMARY = OUT / "python_verifier_support_combined_audit_v10.json"
COMBINED_ROWS = OUT / "python_verifier_support_combined_rows_v10.jsonl"

BASE_AUDIT = ART / "stage11818_python_verifier_support_combined_audit_v9/python_verifier_support_combined_audit_v9.json"
BASE_ROWS = ART / "stage11818_python_verifier_support_combined_audit_v9/python_verifier_support_combined_rows_v9.jsonl"
NEW_ROWS = ART / "stage11857_einops_python_support_rows/einops_python_support_rows.jsonl"
...
def main() -> None:
    ...
    artifact: dict[str, Any] = {
        ...
        "decision": "einops_admitted_quota_incomplete",
