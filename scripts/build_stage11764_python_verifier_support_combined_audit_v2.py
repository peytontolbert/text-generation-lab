#!/usr/bin/env python3
"""Combined Python verifier support admission audit including Digital-World-Model."""
...
STAGE = 11764
NAME = "stage11764_python_verifier_support_combined_audit_v2"
OUT = ART / NAME
SUMMARY = OUT / "python_verifier_support_combined_audit_v2.json"
COMBINED_ROWS = OUT / "python_verifier_support_combined_rows_v2.jsonl"
