...
STAGE = 11524
NAME = "stage11524_openhands_from_stage11507_support_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "openhands_from_stage11507_support_postrun_audit.json"

RUNTIME = ART / "stage11523_openhands_from_stage11507_support_probe/runtime_model/runtime_model_bundle.json"
REQUEST = ART / "stage11523_openhands_from_stage11507_support_probe_request/openhands_from_stage11507_support_probe_request.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "openhands_stage11507_support_promoted" if promoted else "openhands_stage11507_support_diagnostic_only",
        ...
        "comparison_to_stage11507_web_smokes": {
            ...
            "stage11524_llama_product_correct": product["llama_stack_heldout"]["correct"],
            "stage11522_openhands_product_correct": baseline_correct(STAGE11522, "product"),
            "stage11524_openhands_product_correct": product["openhands_heldout"]["correct"],
        },
        "gates": gates,
        "claim_boundary": [
            "Diagnostic Web adaptation probe only.",
