...
STAGE = 11930
NAME = "stage11930_cpp_transition_recovery_routed_audit"
OUT = ART / NAME
SUMMARY = OUT / "cpp_transition_recovery_routed_audit.json"
...
RUNTIMES = {
    ...
    "stage11929_cpp_transition_recovery": ART / "stage11929_cpp_transition_recovery_probe/runtime_model/runtime_model_bundle.json",
}
PROTECTED_ROWSETS = {
...
def main() -> None:
    ...
    postrun = results["stage11929_cpp_transition_recovery"]
    gates = {
        ...
        "transition_projection_at_least_365_of_640": (postrun["transition_projection_routed"].get("correct") or 0) >= 355,
    ...
    if all(gates.values()):
        decision = "cpp_transition_recovery_candidate_ready_for_gemma_comparison"
    elif gates["transition_projection_improved_vs_stage11924"] and gates["filtered_strict_preserved"] and gates["old_canary_strict_preserved"]:
        decision = "cpp_transition_recovery_partial_candidate"
    else:
        decision = "cpp_transition_recovery_rejected"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "created_at_utc": now(),
