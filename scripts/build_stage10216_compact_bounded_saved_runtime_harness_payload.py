...
STAGE = 10216
NAME = "stage10216_compact_bounded_saved_runtime_harness_payload"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
PAYLOAD = OUT_DIR / "compact_bounded_saved_runtime_harness_payload.json"
...
def build_payload() -> dict[str, Any]:
        ...
        runs.append(
            {
                "cell_key": cell_key,
                "task_pack": {
                    "bundle_id": f"stage10215_saved_runtime_compact_bounded::{language}",
                    "task_pack_id": f"stage10215_saved_runtime_compact_bounded::{language}",
                    "source_id": f"stage10215_saved_runtime_compact_bounded::{language}",
                    "lineage_hash": f"stage10215_saved_runtime_compact_bounded::{language}",
                    ...
                    "slice_tags": ["maintainer_bundle", language, "compact_bounded", "saved_runtime", "diagnostic_harness"],
    ...
    return {
        ...
        "claim_scope": "diagnostic compact bounded maintainer projection only; current saved runtime 100M constrained-choice scoring versus live gemma3:12b same-row outputs",
        "eval_hardening": {
