...
STAGE = 11640
NAME = "stage11640_normalized_web_support_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "normalized_web_support_postrun_audit.json"

RUNTIME = ART / "stage11639_normalized_web_support_guarded_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
...
def main() -> None:
    ...
    gates = {
        ...
        "web_successor_at_least_30_of_36": (results["web_successor_strict"]["correct"] or 0) >= 30 and results["web_successor_strict"]["rows"] == 36,
        "normalized_support_full_coverage": results["normalized_web_train_support"]["coverage"] == 1.0 and results["normalized_web_train_support"]["rows"] == 206,
    }
    preservation_gates = {
        key: gates[key]
        for key in [
    ...
    if all(preservation_gates.values()) and gates["web_heldout_beats_gemma_52_of_66"]:
        decision = "promote_stage11639_web_beats_gemma"
    elif all(preservation_gates.values()) and gates["web_heldout_beats_routed_38_of_66"]:
        decision = "stage11639_improves_web_but_not_gemma"
    else:
        decision = "do_not_promote_stage11639"
    ...
    summary = {
        ...
        "claim_boundary": [
            "This is a postrun audit for a guarded Web-support probe.",
            "Promotion requires preserving protected gates and improving Web heldout under the selected product scorer.",
            "A Web Gemma win requires more than 52/66 on the same 66-row heldout artifact.",
        ],
    }
