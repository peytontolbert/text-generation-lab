...
STAGE = 11291
NAME = "stage11291_paired_candidate_item_contrast_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "paired_candidate_item_contrast_probe_request.json"
COMMAND_JSON = OUT_DIR / "paired_candidate_item_contrast_probe_command.json"
MANIFEST = OUT_DIR / "paired_candidate_item_contrast_probe_manifest.jsonl"
...
JUDGMENT_PACKAGE = ARTIFACTS / "stage11290_paired_candidate_item_contrast_package"
JUDGMENT_SUMMARY = JUDGMENT_PACKAGE / "paired_candidate_item_contrast_package.json"
JUDGMENT_AUDIT = JUDGMENT_SUMMARY
JUDGMENT_TRAIN = JUDGMENT_PACKAGE / "paired_candidate_item_contrast_train_rows.jsonl"
JUDGMENT_VALIDATION = JUDGMENT_PACKAGE / "paired_candidate_item_contrast_validation_rows.jsonl"
JUDGMENT_STRICT = JUDGMENT_PACKAGE / "paired_candidate_item_contrast_strict_rows.jsonl"
...
RUN_DIR = ARTIFACTS / "stage11292_paired_candidate_item_contrast_probe"
...
def main() -> None:
    ...
    if not package.get("passed"):
        raise SystemExit("Stage11290 package did not pass")
    if not audit.get("passed"):
        raise SystemExit("Stage11290 audit did not pass")
    ...
    summary = {
        ...
        "passed": True,
        "decision": "paired_candidate_item_contrast_probe_requested",
        "rationale": [
            "Stage11290 supplies same-root changed/verifier evidence pairs with implementation-like changed-source positives and legacy evidence-citation contrast values.",
            "Stage11290 passed pair balance, duplicate-id, root-split, and target-leak audits.",
            "This is diagnostic: Stage11290 covers C/C++/Python/Rust/Web in train, but heldout is small; this is a contrast diagnostic, not a headline benchmark.",
        ],
        "metrics": {
        ...
        "promotion_gate_for_postrun": {
            ...
            "paired_contrast_validation_or_strict_should_score_above_majority_baseline": True,
        },
        "source_artifacts": {
