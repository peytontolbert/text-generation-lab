#!/usr/bin/env python3
"""Audit Stage11935 routed transition-candidate-head runtime."""
...
STAGE = 11936
NAME = "stage11936_transition_candidate_head_routed_audit"
OUT = ART / NAME
SUMMARY = OUT / "transition_candidate_head_routed_audit.json"
...
TRANSITION_SCORERS = {
    ...
    "stage11935_transition_candidate_head": "encoder_option_retrieval_transition_candidate_head",
}
...
def main() -> None:
    ...
    if protected_ok and gates["transition_projection_at_least_gemma_386_of_640"]:
        decision = "transition_candidate_head_promotable_pending_same_manifest_gemma_attachment"
    elif protected_ok and gates["transition_projection_improved_vs_stage11924"]:
        decision = "transition_candidate_head_improved_but_not_gemma_beating"
    elif protected_ok:
        decision = "transition_candidate_head_preserved_but_no_frontier_gain"
    else:
        decision = "transition_candidate_head_rejected_protected_regression"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "created_at_utc": now(),
