...
STAGE = 10770
NAME = "stage10770_enriched_support_candidate_probe_request"
OUT_DIR = ARTIFACTS / NAME
REQUEST_JSON = OUT_DIR / "enriched_support_candidate_probe_request.json"
COMMAND_JSON = OUT_DIR / "enriched_support_candidate_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "enriched_support_candidate_probe_manifest.jsonl"

PACKAGE_JSON = ARTIFACTS / "stage10769_enriched_support_candidate_training_package" / "enriched_support_candidate_training_package.json"
TRAIN_ROWS = ARTIFACTS / "stage10769_enriched_support_candidate_training_package" / "agentkernel_lite_encdec_train.jsonl"
VALIDATION_ROWS = ARTIFACTS / "stage10769_enriched_support_candidate_training_package" / "agentkernel_lite_encdec_validation.jsonl"
STRICT_ROWS = ARTIFACTS / "stage10769_enriched_support_candidate_training_package" / "agentkernel_lite_encdec_strict_eval.jsonl"
STRESS_ROWS = ARTIFACTS / "stage10769_enriched_support_candidate_training_package" / "agentkernel_lite_encdec_stress_eval.jsonl"
...
RUN_ID = "stage10771_enriched_support_candidate_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10771_enriched_support_candidate_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10771_enriched_support_candidate_probe/runtime_model"
...
def main() -> None:
    ...
    request = {
        ...
        "decision": "enriched_support_candidate_probe_ready",
        ...
        "enriched_support_snapshot": {
            "support_rows_added_from_stage10769": len(support_rows),
        ...
        "claim_scope": [
            "Run a standalone support-only probe that keeps the reviewed v2.7 strict frontier fixed while adding the first enriched C/C++ and Python root-materialization support rows.",
        ...
        "required_honesty_gates": [
            ...
            "all stage10769 rows remain train_support_only and strict_eval_eligible=false",
            "all stage10769 rows use provisional AI gold only for support training, not for promotable eval",
        ...
        "next_best_step": "run the probe, then audit whether the enriched C/C++ and Python support rows improve strict performance without regressions before widening to Rust",
    }
