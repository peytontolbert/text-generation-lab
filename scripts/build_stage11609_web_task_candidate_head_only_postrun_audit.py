...
STAGE = 11609
NAME = "stage11609_web_task_candidate_head_only_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_task_candidate_head_only_postrun_audit.json"

RUNTIME = ART / "stage11608_web_task_candidate_head_only_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "promote_stage11608_if_all_gates_pass" if all(gates.values()) else "do_not_promote_stage11608_web_task_candidate_head_only",
        "runtime": rel(RUNTIME),
        "device": str(DEVICE),
        "scorer": SCORER,
        "results": results,
