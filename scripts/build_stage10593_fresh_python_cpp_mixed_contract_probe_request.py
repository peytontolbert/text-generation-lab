...
STAGE = 10593
NAME = "stage10593_fresh_python_cpp_mixed_contract_probe_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST_JSON = OUT_DIR / "fresh_python_cpp_mixed_contract_probe_request.json"
COMMAND_JSON = OUT_DIR / "fresh_python_cpp_visible_candidate_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "fresh_python_cpp_mixed_contract_probe_manifest.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"

SUPPORT_PACKAGE = ROOT / "runs/local/artifacts/stage10591_fresh_python_cpp_visible_candidate_mixed_contract_package/fresh_python_cpp_visible_candidate_mixed_contract_package.json"
...
RUN_ID = "stage10594_fresh_python_cpp_mixed_contract_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10594_fresh_python_cpp_mixed_contract_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10594_fresh_python_cpp_mixed_contract_probe/runtime_model"
...
def main() -> None:
    ...
    request = {
        ...
        "decision": "fresh_python_cpp_mixed_contract_probe_ready",
        ...
        "claim_scope": [
            "Fresh-root target-100M probe on the stage10591 repo-disjoint Python/C++ mixed-contract visible-candidate package.",
            "Starts from the current stage10586 fresh-transfer runtime so any gain measures the effect of the mixed-contract package rather than a weaker baseline.",
        ...
        "training_deltas": {
            "train_support_manifest": "stage10591_fresh_python_cpp_visible_candidate_mixed_contract_package",
        ...
        "required_honesty_gates": [
            ...
            "fresh mixed-contract same-manifest comparison versus Gemma must be reported separately from old-frontier comparisons",
            "no claim of Rust/Web uplift can be made from this package because stage10591 only covers Python and C/C++",
        ],
        "post_run_required_artifacts": [
            "bounded_decoder_probe/execution_result.json",
            "post-run repaired v2.7 canary audit against stage10594 runtime",
            "post-run rebuilt 54-row same-manifest comparison against stage10594 runtime",
        ...
        "known_limits": [
            ...
            "Retrieve and verifier rows in stage10591 are mixed-contract fresh-root targets; the next probe should test whether the 100M model keeps its margin once the constant-target shortcut is removed.",
        ],
        "next_best_step": "Launch the stage10594 probe from this request, then rerun canary and old-frontier audits plus a fresh mixed-contract Gemma comparison before deciding whether the 100M model keeps its fresh-root margin under the harder contract.",
        "command": command,
    }
