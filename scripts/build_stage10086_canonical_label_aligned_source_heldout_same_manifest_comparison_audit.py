...
STAGE = 10086
NAME = "stage10086_canonical_label_aligned_source_heldout_same_manifest_comparison_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT = OUT_DIR / "canonical_label_aligned_source_heldout_same_manifest_comparison_audit.json"
ROWS = OUT_DIR / "canonical_label_aligned_source_heldout_same_manifest_comparison_rows.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "CANONICAL_LABEL_ALIGNED_SOURCE_HELDOUT_SAME_MANIFEST_COMPARISON_AUDIT_STAGE10086.md"
...
HUNDRED_M = ROOT / "runs/local/artifacts/stage10084_canonical_label_aligned_source_heldout_target100m_probe/edit_localization_probe/row_field_logits.jsonl"
GEMMA = ROOT / "runs/local/artifacts/stage10085_canonical_label_aligned_source_heldout_gemma_execution/same_prompt_surface_gemma12b_outputs_rows.jsonl"
    ...
    if not hundred_m or not gemma_rows:
        return {
            ...
            "metrics": {
                ...
                "shared_rows": 0,
                "comparison_rows": 0,
                "macro_exact_100m": None,
                "macro_exact_gemma": None,
                "macro_delta_100m_minus_gemma": None,
                "wins_100m": 0,
                "wins_gemma": 0,
                "ties": 0,
                "per_language": {},
...
def main() -> None:
    ...
    next_step = "After the stage10084 100M rerun and stage10085 Gemma queue both execute, use this audit to answer whether canonical label alignment survives on the honest 55-row source-heldout bank."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Materialized the canonical source-heldout same-manifest comparison audit scaffold so the stage10083 reruns can be judged directly on the honest 55-row heldout bank after label-semantic alignment.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage10086 Canonical Label Aligned Source-Heldout Same-Manifest Comparison Audit",
                "",
