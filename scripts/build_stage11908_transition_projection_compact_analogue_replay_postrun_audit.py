...
STAGE = 11908
NAME = "stage11908_transition_projection_compact_analogue_replay_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "transition_projection_compact_analogue_replay_postrun_audit.json"
...
RUNTIMES = {
    ...
    "stage11907_transition_projection_compact_analogue_replay": ART / "stage11907_transition_projection_compact_analogue_replay_probe/runtime_model/runtime_model_bundle.json",
}
PROTECTED_ROWSETS = {
...
def main() -> None:
    ...
    postrun_all = results["stage11907_transition_projection_compact_analogue_replay"]["all_transition_projection_rows"]
    protected = results["stage11907_transition_projection_compact_analogue_replay"]
    gates = {
    ...
    if gates["projection_fit_improved"] and gates["projection_fit_at_least_320_of_640"]:
        decision = "transition_projection_compact_analogue_replay_learned_interface"
    elif gates["projection_fit_improved"]:
        decision = "transition_projection_compact_analogue_replay_partial_fit"
    else:
        decision = "transition_projection_compact_analogue_replay_no_fit_gain"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "created_at_utc": now(),
        ...
        "claim_boundary": [
            ...
            "Stage11907 trains on root-disjoint transition projection and compact analogue rows; no protected rowset is used as train replay.",
