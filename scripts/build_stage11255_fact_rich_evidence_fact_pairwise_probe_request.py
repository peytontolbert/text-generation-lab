...
STAGE = 11255
NAME = "stage11255_fact_rich_evidence_fact_pairwise_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "fact_rich_evidence_fact_pairwise_probe_request.json"
COMMAND_JSON = OUT_DIR / "fact_rich_evidence_fact_pairwise_probe_command.json"
MANIFEST = OUT_DIR / "fact_rich_evidence_fact_pairwise_probe_manifest.jsonl"
...
BALANCED_PACKAGE = ARTIFACTS / "stage11249_fact_rich_evidence_option_package"
BALANCED_SUMMARY = BALANCED_PACKAGE / "fact_rich_evidence_option_package.json"
BALANCED_TRAIN = BALANCED_PACKAGE / "fact_rich_evidence_option_train_rows.jsonl"
BALANCED_VALIDATION = BALANCED_PACKAGE / "fact_rich_evidence_option_validation_rows.jsonl"
BALANCED_STRICT = BALANCED_PACKAGE / "fact_rich_evidence_option_strict_rows.jsonl"
...
RUN_DIR = ARTIFACTS / "stage11256_fact_rich_evidence_fact_pairwise_probe"
...
def main() -> None:
    ...
    command = [
        ...
        "--bounded-choice-aux-source", "encoder_option_retrieval_evidence_fact_pairwise",
    ...
    summary = {
        ...
        "passed": True,
        "decision": "fact_rich_evidence_fact_pairwise_probe_requested",
        "rationale": [
            "Stage11249 changes the option surface so the fact-pairwise scorer sees role-prefixed concrete evidence facts.",
            "The package preserves Stage11243 root splits and role balance but makes option values fact-rich.",
            "This probe tests whether the corrected evidence fact-pairwise head can use role-prefixed concrete evidence facts without collapsing fact-rich option values into the unknown role bucket.",
        ],
        "metrics": {
        ...
        "promotion_gate_for_postrun": {
            ...
            "fact_rich_validation_or_strict_should_improve_vs_stage11250": True,
        },
        "source_artifacts": {
