...
STAGE = 11132
NAME = "stage11132_evidence_item_option_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "evidence_item_option_probe_request.json"
COMMAND_JSON = OUT_DIR / "evidence_item_option_probe_command.json"
MANIFEST_JSONL = OUT_DIR / "evidence_item_option_probe_manifest.jsonl"
...
PROBE_OUT_DIR = ARTIFACTS / "stage11133_evidence_item_option_probe" / "bounded_decoder_probe"
RUNTIME_OUT_DIR = ARTIFACTS / "stage11133_evidence_item_option_probe" / "runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "evidence_item_option_probe_requested",
        "claim_scope": [
            "Run one isolated encoder_option_retrieval probe using stage11131 evidence-item option support rows.",
            "Test whether scoring visible evidence-item descriptions improves residual evidence behavior without adding role-name aliases or a new scorer head.",
        ],
        "source_artifacts": {
        ...
        "training_contract": {
            ...
            "purpose": "isolate evidence-item option geometry from evidence-role scorer architecture changes",
        },
        "promotion_gates": [
