...
STAGE = 11251
NAME = "stage11251_fact_rich_evidence_option_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "fact_rich_evidence_option_probe_request.json"
COMMAND_JSON = OUT_DIR / "fact_rich_evidence_option_probe_command.json"
MANIFEST = OUT_DIR / "fact_rich_evidence_option_probe_manifest.jsonl"
...
RUN_DIR = ARTIFACTS / "stage11252_fact_rich_evidence_option_probe"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "fact_rich_evidence_option_probe_requested",
        "rationale": [
            "Stage11249 changes the product option surface so raw retrieval sees role-prefixed concrete evidence facts.",
            "The package preserves Stage11243 root splits and role balance but makes option values fact-rich.",
            "This probe tests whether fact-rich option values can align the product scorer without a new scorer architecture.",
        ],
        "metrics": {
