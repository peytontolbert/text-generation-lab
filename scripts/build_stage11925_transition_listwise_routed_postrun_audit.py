#!/usr/bin/env python3
"""Audit Stage11924 routed transition listwise runtime."""
...
STAGE = 11925
NAME = "stage11925_transition_listwise_routed_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "transition_listwise_routed_postrun_audit.json"
...
def main() -> None:
    ...
    postrun = results["stage11924_transition_listwise_head_only"]
    gates = {
    ...
    if all(gates.values()):
        decision = "transition_listwise_routed_candidate_ready_for_gemma_comparison"
        ...
        decision = "transition_listwise_routed_partial_candidate"
    else:
        decision = "transition_listwise_routed_rejected"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "created_at_utc": now(),
