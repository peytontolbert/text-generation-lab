#!/usr/bin/env python3
"""Combined Python verifier support audit including python_algorithms knapsack."""
...
STAGE = 11818
NAME = "stage11818_python_verifier_support_combined_audit_v9"
OUT = ART / NAME
SUMMARY = OUT / "python_verifier_support_combined_audit_v9.json"
COMBINED_ROWS = OUT / "python_verifier_support_combined_rows_v9.jsonl"

BASE_AUDIT = ART / "stage11814_python_verifier_support_combined_audit_v8_duplicate_guard/python_verifier_support_combined_audit_v8_duplicate_guard.json"
BASE_ROWS = ART / "stage11814_python_verifier_support_combined_audit_v8_duplicate_guard/python_verifier_support_combined_rows_v8.jsonl"
NEW_ROWS = ART / "stage11817_python_algorithms_knapsack_support_rows/python_algorithms_knapsack_support_rows.jsonl"
...
def main() -> None:
    ...
    artifact: dict[str, Any] = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "passed": len(blocked) == 0 and len(new_rows) > 0,
        "decision": "python_algorithms_knapsack_admitted_quota_incomplete",
