...
STAGE = 11901
NAME = "stage11901_transition_projection_support_only_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "transition_projection_support_only_postrun_audit.json"
...
RUNTIMES = {
    ...
    "stage11900_transition_projection_support_only": ART / "stage11900_transition_projection_support_only_learnability_probe/runtime_model/runtime_model_bundle.json",
}
PROTECTED_ROWSETS = {
...
def main() -> None:
    ...
    postrun_all = results["stage11900_transition_projection_support_only"]["all_transition_projection_rows"]
    protected = results["stage11900_transition_projection_support_only"]
    gates = {
    ...
    if gates["projection_fit_improved"] and gates["projection_fit_at_least_320_of_640"]:
        decision = "transition_projection_support_only_learned_interface"
    elif gates["projection_fit_improved"]:
        decision = "transition_projection_support_only_partial_fit"
    else:
        decision = "transition_projection_support_only_no_fit_gain"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "created_at_utc": now(),
        ...
        "claim_boundary": [
            ...
            "Stage11900 is non-promotable because it trains directly on projection support rows and echo eval rows.",
