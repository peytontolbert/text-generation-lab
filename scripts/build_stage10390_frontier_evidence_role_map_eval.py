...
NAME = "stage10390_frontier_evidence_role_map_eval"
...
def _option_variant(row: dict[str, object], evidence_variant: str) -> str:
...
def _score_row(
    ...
    *,
    ...
    option_variant = _option_variant(row, evidence_variant)
...
def main() -> None:
    ...
    out_path = OUT_DIR / "frontier_evidence_role_map_eval.json"
    out_path.write_text(
        json.dumps(
            {
                "stage_name": NAME,
