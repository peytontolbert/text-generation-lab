#!/usr/bin/env python3
"""Refresh support supply after duplicate Python root quarantine."""
...
STAGE = 11815
NAME = "stage11815_source_heldout_support_supply_status_v17"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v17.json"

PYTHON = ART / "stage11814_python_verifier_support_combined_audit_v8_duplicate_guard/python_verifier_support_combined_audit_v8_duplicate_guard.json"
...
def main() -> None:
    ...
    support_status = {
        "python_verifier_support": {
            ...
            "quarantined_duplicate_rows": py.get("blocked_rows", 0),
        },
    ...
    artifact = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "support_supply_corrected_duplicate_root_training_probe_not_ready",
        "passed": True,
        "training_probe_ready": training_probe_ready,
        "support_status": support_status,
        "delta_since_stage11809": {
            "python_verifier_ready_roots_added": 0,
            "python_verifier_duplicate_rows_quarantined": py.get("blocked_rows", 0),
        },
        "next_actions": [
            "Find genuinely new Python verifier roots beyond the existing 7/12.",
        ...
        "claim_boundary": [
            ...
            "Stage11811 rows are preserved as diagnostic artifacts but not counted toward quota.",
        ],
        "source_artifacts": {
