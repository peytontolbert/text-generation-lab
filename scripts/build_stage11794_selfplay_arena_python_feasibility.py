#!/usr/bin/env python3
"""Capture selfplay-arena Python verifier feasibility."""
...
STAGE = 11794
NAME = "stage11794_selfplay_arena_python_feasibility"
OUT = ART / NAME
LOGS = OUT / "logs"
SUMMARY = OUT / "selfplay_arena_python_feasibility.json"
RESULTS = OUT / "selfplay_arena_python_feasibility_results.jsonl"
REPO = Path("/data/parametergolf/helpful_repos/selfplay-arena")
SELECTED_TEST = "tests/test_prompt_pipeline.py::test_generation_sample_extracts_fenced_block"
SIBLING_TEST = "tests/test_prompt_pipeline.py::test_generation_sample_accepts_raw_def_solve"
...
def run_pytest(test_path: str, name: str) -> dict[str, Any]:
...
def main() -> None:
    selected = run_pytest(SELECTED_TEST, "selected_generation_fenced_block")
    sibling = run_pytest(SIBLING_TEST, "sibling_generation_raw_def")
    ...
    artifact = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "selfplay_arena_python_feasibility_recorded",
        "passed": passed,
