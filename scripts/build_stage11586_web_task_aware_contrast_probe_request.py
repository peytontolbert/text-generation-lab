...
STAGE = 11586
NAME = "stage11586_web_task_aware_contrast_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "web_task_aware_contrast_probe_request.json"
TRAIN_ROWS = OUT / "web_task_aware_contrast_train_rows.jsonl"
STRICT_ROWS = OUT / "web_task_aware_contrast_successor_strict_rows.jsonl"
MANIFEST = OUT / "web_task_aware_contrast_probe_manifest.jsonl"
COMMAND = OUT / "web_task_aware_contrast_probe_command.json"
...
PROBE = ART / "stage11586_web_task_aware_contrast_probe/bounded_decoder_probe"
RUNTIME_OUT = ART / "stage11586_web_task_aware_contrast_probe/runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "web_task_aware_contrast_probe_ready" if all(gates.values()) else "web_task_aware_contrast_probe_blocked",
        "metrics": {
        ...
        "command": command,
        "claim_boundary": [
            "This is a controlled Web task-aware contrast probe request, not a promotion.",
        ...
        "source_artifacts": {
            ...
            "stage11585_readiness": rel(ART / "stage11585_web_task_aware_contrast_readiness_audit/contrast_readiness_summary.json"),
        },
        "outputs": {
