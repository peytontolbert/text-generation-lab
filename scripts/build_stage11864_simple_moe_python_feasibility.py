#!/usr/bin/env python3
"""Capture simple-moe Python verifier feasibility."""
...
STAGE = 11864
NAME = "stage11864_simple_moe_python_feasibility"
OUT = ART / NAME
LOGS = OUT / "logs"
SUMMARY = OUT / "simple_moe_python_feasibility.json"
RESULTS = OUT / "simple_moe_python_feasibility_results.jsonl"
REPO = Path("/data/repositories/simple-moe")
SELECTED_TEST = "tests/test_model_stack_integration.py::test_router_uses_runtime_topk_helper"
SIBLING_TEST = "tests/test_model_stack_integration.py::test_moe_forward_matches_naive_reference"
SECOND_SIBLING_TEST = "tests/test_model_stack_integration.py::test_model_stack_helpers_fall_back_to_pytorch"
...
def main() -> None:
    selected = run_pytest(SELECTED_TEST, "selected_router_runtime_topk")
    sibling = run_pytest(SIBLING_TEST, "sibling_moe_naive_reference")
    second_sibling = run_pytest(SECOND_SIBLING_TEST, "sibling_model_stack_fallback")
    ...
    row = {
        ...
        "source_path": "src/models/router.py",
        "selected_test_path": "tests/test_model_stack_integration.py",
        "distractor_source_path": "src/models/moe.py",
        "second_distractor_source_path": "src/models/_model_stack.py",
        "passed": passed,
    ...
    artifact = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "simple_moe_python_feasibility_recorded",
        "passed": passed,
