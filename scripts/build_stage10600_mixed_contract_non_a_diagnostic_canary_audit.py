...
STAGE = 10600
NAME = "stage10600_mixed_contract_non_a_diagnostic_canary_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT_JSON = OUT_DIR / "mixed_contract_non_a_diagnostic_canary_audit.json"
ROW_JSONL = OUT_DIR / "mixed_contract_non_a_diagnostic_canary_rows.jsonl"
...
RUNTIME_BUNDLE = ROOT / "runs/local/artifacts/stage10599_mixed_contract_non_a_diagnostic_probe/runtime_model/runtime_model_bundle.json"
EXECUTION_RESULT = ROOT / "runs/local/artifacts/stage10599_mixed_contract_non_a_diagnostic_probe/bounded_decoder_probe/execution_result.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "passed": True,
        "claim_scope": [
            "Saved-runtime canary regression audit on the repaired 24-row v2.7 overlay using the stage10599 diagnostic runtime.",
