#!/usr/bin/env python3
"""Refresh support supply after Rust verifier quota completion."""
...
STAGE = 11855
NAME = "stage11855_source_heldout_support_supply_status_v27"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v27.json"

PYTHON = ART / "stage11818_python_verifier_support_combined_audit_v9/python_verifier_support_combined_audit_v9.json"
CPP = ART / "stage11826_cpp_abstain_support_combined_audit_v7/cpp_abstain_support_combined_audit_v7.json"
...
def main() -> None:
    ...
    artifact = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "support_supply_improved_but_training_probe_not_ready" if not training_probe_ready else "support_supply_ready_for_training_probe_request",
        "passed": True,
        "training_probe_ready": training_probe_ready,
        "support_status": support_status,
        "quota_satisfied": {"python_verifier_support": py_roots >= 12, "cpp_abstain_attractor_support": cpp_roots >= 16, "rust_verifier_support": rust_roots >= 12},
        "delta_since_stage11831": {"rust_verifier_ready_roots_added": max(0, rust_roots - 6), "rust_verifier_ready_rows_added": max(0, int(rust.get("admitted_rows", 0)) - 24)},
        "next_actions": ["Continue Python verifier expansion beyond 8/12 roots.", "Continue C/C++ abstain-attractor expansion beyond 7/16 roots.", "Rust verifier support quota is satisfied; preserve it and avoid further Rust-only training probes until the other gates are ready."],
