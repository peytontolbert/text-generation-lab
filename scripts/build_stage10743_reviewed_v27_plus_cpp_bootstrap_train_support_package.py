...
STAGE = 10743
NAME = "stage10743_reviewed_v27_plus_cpp_bootstrap_train_support_package"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
PACKAGE_JSON = OUT_DIR / "reviewed_v27_plus_cpp_bootstrap_train_support_package.json"
ROOT_MANIFEST_JSONL = OUT_DIR / "reviewed_v27_plus_cpp_bootstrap_root_manifest.jsonl"
ROWS_JSONL = OUT_DIR / "reviewed_v27_plus_cpp_bootstrap_bounded_rows.jsonl"
...
CPP_ADMISSION = ROOT / "runs/local/artifacts/stage10742_cpp_bootstrap_ai_adjudicated_admission/cpp_bootstrap_ai_adjudicated_admitted_manifest.json"
CPP_ROOTS = ROOT / "runs/local/artifacts/stage10742_cpp_bootstrap_ai_adjudicated_admission/cpp_bootstrap_ai_adjudicated_root_manifest.jsonl"
...
def main() -> None:
    ...
    if admission.get("passed") is not True:
        raise SystemExit("stage10742_not_passed")
    ...
    payload = {
        ...
        "passed": True,
        "decision": "reviewed_v27_extended_with_five_bootstrap_execution_backed_cpp_support_roots",
        "claim_boundary": [
            "The strict and stress evaluation sets remain unchanged from the prior reviewed v2.7 support package.",
            "The newly added bootstrap C/C++ roots are admitted for train-support use only and are not same-surface admissible yet.",
        ...
        "source_artifacts": {
            ...
            "cpp_bootstrap_adjudicated_admission": display(CPP_ADMISSION),
            "cpp_bootstrap_root_manifest": display(CPP_ROOTS),
        },
