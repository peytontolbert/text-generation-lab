...
NAME = "stage11686_counterfactual_identity_semantic_head_fixed_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "counterfactual_identity_semantic_head_fixed_postrun_audit.json"

RUNTIME = ART / "stage11685_counterfactual_identity_semantic_head_fixed_probe/runtime_model/runtime_model_bundle.json"
TRAIN_LOG = ART / "stage11685_counterfactual_identity_semantic_head_fixed_probe/bounded_decoder_probe/loss_by_step.jsonl"
ROWSETS = {
