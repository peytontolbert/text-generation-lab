...
STAGE = 11159
NAME = "stage11159_local_verifier_support_postrun_audit"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "local_verifier_support_postrun_audit.json"
...
RUNTIME_BUNDLE = ARTIFACTS / "stage11158_local_verifier_support_probe" / "runtime_model" / "runtime_model_bundle.json"
VALIDATION_JSON = ARTIFACTS / "stage11158_local_verifier_support_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_eval.json"
STRICT_JSON = ARTIFACTS / "stage11158_local_verifier_support_probe" / "bounded_decoder_probe" / "bounded_choice_eval_audit_strict_eval.json"
EXECUTION_JSON = ARTIFACTS / "stage11158_local_verifier_support_probe" / "bounded_decoder_probe" / "execution_result.json"
RESERVED_ROWS = ARTIFACTS / "stage11051_successor_residual_support_plus_priority_evidence" / "reserved_residual_candidates.jsonl"
SUPPORT_ROWS = ARTIFACTS / "stage11156_cleaned_plus_local_verifier_support_package" / "added_local_verifier_transition_rows.jsonl"
PACKAGE_SUMMARY = ARTIFACTS / "stage11156_cleaned_plus_local_verifier_support_package" / "cleaned_plus_local_verifier_support_package.json"
REQUEST_SUMMARY = ARTIFACTS / "stage11157_local_verifier_support_probe_request" / "local_verifier_support_probe_request.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "claim_scope": [
            "Postrun audit for the local verifier-transition support diagnostic.",
            "The added rows are train-support-only PASS_TO_PASS verifier guardrails; this audit cannot promote a new broad capability claim unless heldout surfaces improve without regression.",
        ],
        "source_artifacts": {
        ...
        "next_best_step_if_flat": (
            "Stop local PASS_TO_PASS support variants. Build fresh explicit verifier-transition roots with competing "
