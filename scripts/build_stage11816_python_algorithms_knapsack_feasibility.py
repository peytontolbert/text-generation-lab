#!/usr/bin/env python3
"""Capture python_algorithms knapsack verifier feasibility."""
...
STAGE = 11816
NAME = "stage11816_python_algorithms_knapsack_feasibility"
OUT = ART / NAME
LOGS = OUT / "logs"
SUMMARY = OUT / "python_algorithms_knapsack_feasibility.json"
RESULTS = OUT / "python_algorithms_knapsack_feasibility_results.jsonl"
REPO = Path("/data/repository_library/python_algorithms")
SELECTED_TEST = "knapsack/tests/test_knapsack.py::Test::test_easy_case"
SIBLING_TEST = "knapsack/tests/test_knapsack.py::Test::test_knapsack_repetition"
...
def main() -> None:
    selected = run_pytest(SELECTED_TEST, "selected_knapsack_easy_case")
    sibling = run_pytest(SIBLING_TEST, "sibling_knapsack_repetition")
    ...
    artifact = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "python_algorithms_knapsack_feasibility_recorded",
        "passed": passed,
