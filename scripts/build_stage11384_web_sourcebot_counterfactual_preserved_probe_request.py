...
STAGE = 11384
NAME = "stage11384_web_sourcebot_counterfactual_preserved_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "web_sourcebot_counterfactual_preserved_probe_request.json"
CMD = OUT / "web_sourcebot_counterfactual_preserved_probe_command.json"
MAN = OUT / "web_sourcebot_counterfactual_preserved_probe_manifest.jsonl"
TRAIN = ART / "stage11383_web_sourcebot_abstention_counterfactual_combined_package/web_sourcebot_abstention_counterfactual_combined_rows.jsonl"
...
RUN = ART / "stage11385_web_sourcebot_counterfactual_preserved_probe"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "web_sourcebot_counterfactual_preserved_probe_requested_diagnostic_only",
        "metrics": {
