...
STAGE = 11932
NAME = "stage11932_transition_bucket_remap_inference_audit"
OUT = ART / NAME
SUMMARY = OUT / "transition_bucket_remap_inference_audit.json"
...
def main() -> None:
    ...
    previous = results["stage11507_selected_frontier"]
    ...
    gates = {
        ...
        "transition_projection_improved_vs_selected_after_bucket_remap": (postrun["transition_projection_routed"].get("correct") or 0) > (previous["transition_projection_routed"].get("correct") or 0),
        "transition_projection_at_least_364_of_640": (postrun["transition_projection_routed"].get("correct") or 0) >= 355,
    ...
    if all(gates.values()):
        decision = "transition_bucket_remap_safe_candidate"
    elif gates["transition_projection_improved_vs_selected_after_bucket_remap"] and gates["filtered_strict_preserved"] and gates["old_canary_strict_preserved"]:
        decision = "transition_bucket_remap_partial_candidate"
    else:
        decision = "transition_bucket_remap_rejected"
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "created_at_utc": now(),
