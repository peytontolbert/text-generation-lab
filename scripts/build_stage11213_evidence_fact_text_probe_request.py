...
STAGE = 11213
NAME = "stage11213_evidence_fact_text_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "evidence_fact_text_probe_request.json"
COMMAND_JSON = OUT_DIR / "evidence_fact_text_probe_command.json"
MANIFEST = OUT_DIR / "evidence_fact_text_probe_manifest.jsonl"
...
RUN_DIR = ARTIFACTS / "stage11213_evidence_fact_text_probe"
...
def main() -> None:
    ...
    command = [
        ...
        "--bounded-choice-aux-source", "encoder_option_retrieval_evidence_fact_text",
    ...
    summary = {
        ...
        "passed": True,
        "decision": "evidence_fact_text_probe_requested",
        "rationale": (
        ...
        "scorer_under_test": "encoder_option_retrieval_evidence_fact_text",
        "metrics": {
