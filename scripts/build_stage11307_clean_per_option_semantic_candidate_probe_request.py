...
STAGE = 11307
NAME = "stage11307_clean_per_option_semantic_candidate_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "clean_per_option_semantic_candidate_probe_request.json"
COMMAND_JSON = OUT_DIR / "clean_per_option_semantic_candidate_probe_command.json"
MANIFEST = OUT_DIR / "clean_per_option_semantic_candidate_probe_manifest.jsonl"

JUDGMENT_PACKAGE = ARTIFACTS / "stage11306_clean_per_option_semantic_candidate_package"
BASE_PACKAGE = JUDGMENT_PACKAGE
BASE_TRAIN = JUDGMENT_PACKAGE / "clean_per_option_semantic_candidate_train_rows.jsonl"
BASE_VALIDATION = JUDGMENT_PACKAGE / "clean_per_option_semantic_candidate_validation_rows.jsonl"
BASE_STRICT = JUDGMENT_PACKAGE / "clean_per_option_semantic_candidate_strict_rows.jsonl"
JUDGMENT_SUMMARY = JUDGMENT_PACKAGE / "clean_per_option_semantic_candidate_package.json"
JUDGMENT_AUDIT = JUDGMENT_SUMMARY
JUDGMENT_TRAIN = JUDGMENT_PACKAGE / "clean_per_option_semantic_candidate_train_rows.jsonl"
JUDGMENT_VALIDATION = JUDGMENT_PACKAGE / "clean_per_option_semantic_candidate_judgment_validation_rows.jsonl"
JUDGMENT_STRICT = JUDGMENT_PACKAGE / "clean_per_option_semantic_candidate_judgment_strict_rows.jsonl"
RESIDUAL_BANK = JUDGMENT_PACKAGE / "clean_per_option_semantic_candidate_residual_rows.jsonl"
INIT_RUNTIME = ARTIFACTS / "stage11200_role_focused_residual_probe/runtime_model/runtime_model_bundle.json"
RUN_DIR = ARTIFACTS / "stage11308_clean_per_option_semantic_candidate_probe"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "clean_per_option_semantic_candidate_probe_requested",
        "rationale": [
            "Stage11306 supplies root-disjoint cleaned rows with per-option semantic_candidate metadata; this request tests whether the semantic candidate head can consume that schema.",
        ...
        "metrics": {
            ...
            "train_source_note": "base_train is the cleaned Stage11306 train set; judgment_train is the same path and is not double-added",
