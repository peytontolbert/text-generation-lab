#!/usr/bin/env python3
"""Refresh support supply after neural-network Python admission."""
...
STAGE = 11777
NAME = "stage11777_source_heldout_support_supply_status_v7"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v7.json"
...
def main() -> None:
    ...
    support_status = {
        ...
        "rust_verifier_support": {
            ...
            "repo_family_warning": "Current true Rust verifier roots are from one repo family.",
        },
