...
STAGE = 11602
NAME = "stage11602_web_semantic_candidate_head_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "web_semantic_candidate_head_probe_request.json"
MANIFEST = OUT / "web_semantic_candidate_head_probe_manifest.jsonl"
COMMAND = OUT / "web_semantic_candidate_head_probe_command.json"
...
PROBE = ART / "stage11602_web_semantic_candidate_head_probe/bounded_decoder_probe"
RUNTIME_OUT = ART / "stage11602_web_semantic_candidate_head_probe/runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "web_semantic_candidate_head_probe_ready" if all(gates.values()) else "web_semantic_candidate_head_probe_blocked",
        "metrics": {
        ...
        "command": command,
        "claim_boundary": [
            "This is a guarded probe of the metadata-aware semantic candidate head on answerable no-abstain Web geometry, not a promotion.",
