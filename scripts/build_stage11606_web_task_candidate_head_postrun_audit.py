...
STAGE = 11606
NAME = "stage11606_web_task_candidate_head_postrun_audit"
OUT = ART / NAME
SUMMARY = OUT / "web_task_candidate_head_postrun_audit.json"

RUNTIME = ART / "stage11605_web_task_candidate_head_probe/runtime_model/runtime_model_bundle.json"
ROWSETS = {
...
def main() -> None:
    ...
    summary = {
        ...
        "created_at_utc": now(),
        "passed": True,
        "decision": "promote_stage11605_if_all_gates_pass" if all(gates.values()) else "do_not_promote_stage11605_web_task_candidate_head",
        "runtime": rel(RUNTIME),
        "device": str(DEVICE),
        "scorer": SCORER,
        "results": results,
