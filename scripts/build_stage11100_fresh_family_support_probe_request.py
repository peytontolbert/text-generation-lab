...
STAGE = 11100
NAME = "stage11100_fresh_family_support_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "fresh_family_support_probe_request.json"
...
PROBE_OUT_DIR = ARTIFACTS / "stage11101_fresh_family_support_probe" / "bounded_decoder_probe"
RUNTIME_OUT_DIR = ARTIFACTS / "stage11101_fresh_family_support_probe" / "runtime_model"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "fresh_family_support_probe_requested",
        "claim_scope": [
            "Run one bounded probe from the stage11099 fresh-family support package.",
        ...
        "required_honesty_gates": [
            ...
            "The pairwise bounded-choice aux source is a runtime continuation choice, not a new scored-interface claim by itself.",
        ],
