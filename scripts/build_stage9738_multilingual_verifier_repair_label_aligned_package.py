...
STAGE = 9738
NAME = "stage9738_multilingual_verifier_repair_label_aligned_package"
...
MANIFEST = OUT_DIR / "multilingual_verifier_repair_label_aligned.jsonl"
AUDIT = OUT_DIR / "multilingual_verifier_repair_label_aligned_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "MULTILINGUAL_VERIFIER_REPAIR_LABEL_ALIGNED_PACKAGE_STAGE9738.md"
REGISTRY = ROOT / "runs/local/artifacts/reconstructed_stage_registry.json"
LANGS = ["python", "rust", "c_cpp", "web_js_ts_html"]
SPLITS = ["train", "eval", "strict_eval"]
TARGET_LOSS = "verifier_repair_ce"
LABEL_KEY = "verifier_repair_action"
...
def main() -> None:
    ...
    next_step = "Run Stage9739 target-100M execution on the label-aligned multilingual verifier-repair package and compare against both the Stage9729 baseline and the Stage9731 longer-step sweep."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Materialized a label-aligned multilingual verifier-repair package so train, eval, and strict-eval share the same target label inventory across all four languages.",
