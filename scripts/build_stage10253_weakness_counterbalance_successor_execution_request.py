...
STAGE = 10253
NAME = "stage10253_weakness_counterbalance_successor_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
REQUEST = OUT_DIR / "weakness_counterbalance_successor_execution_request.json"
COMMAND_JSON = OUT_DIR / "weakness_counterbalance_successor_command.json"
MANIFEST = OUT_DIR / "weakness_counterbalance_successor_manifest.jsonl"
...
RUN_ID = "stage10254_weakness_counterbalance_successor_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10254_weakness_counterbalance_successor_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10254_weakness_counterbalance_successor_probe/runtime_model"
...
def build_request() -> dict[str, Any]:
    ...
    payload = {
        ...
        "required_honesty_gates": [
            ...
            "added c_cpp abstention rows remain train-only and disjoint from miss roots",
            "web miss families remain uncovered and therefore should not be interpreted as repaired by this probe",
            "results remain auxiliary until rerun against refreshed standalone and harness paths",
        ],
