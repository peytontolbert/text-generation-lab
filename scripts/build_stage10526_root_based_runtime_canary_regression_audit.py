...
STAGE = 10526
NAME = "stage10526_root_based_runtime_canary_regression_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT_JSON = OUT_DIR / "root_based_runtime_canary_regression_audit.json"
ROW_JSONL = OUT_DIR / "root_based_runtime_canary_regression_rows.jsonl"
...
def main() -> None:
    ...
    payload = {
        ...
        "passed": True,
        "claim_scope": [
            "Saved-runtime canary regression audit on the repaired 24-row v2.7 overlay.",
            "Reports both bounded-choice recovery and raw greedy label generation after the root-based seq2seq bootstrap run.",
