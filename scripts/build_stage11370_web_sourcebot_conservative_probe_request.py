...
STAGE = 11370
NAME = "stage11370_web_sourcebot_conservative_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "web_sourcebot_conservative_probe_request.json"
CMD = OUT / "web_sourcebot_conservative_probe_command.json"
MAN = OUT / "web_sourcebot_conservative_probe_manifest.jsonl"
...
RUN = ART / "stage11371_web_sourcebot_conservative_probe"
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "web_sourcebot_conservative_probe_requested_diagnostic_only",
        "metrics": {
            ...
            "baseline": baseline,
            "prior_stage11369": prior,
        },
        "change_vs_stage11367": {
            "max_steps": "80 -> 36",
            "learning_rate": "5e-6 -> 2e-6",
            "decoder_ce_weight": "0.1 -> 0.05",
            "bounded_choice_aux_weight": "2.5 -> 2.0",
            "contrast_weight": "1.0 -> 0.5",
            "preservation_kl_weight": "0.75 -> 2.0",
        },
        "source_artifacts": {
            "train": rel(TRAIN),
            "baseline_score": rel(BASELINE),
            "prior_postrun": rel(PRIOR),
