...
STAGE = 11280
NAME = "stage11280_capped_direct_retrieval_evidence_probe_request_fixed_options"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "capped_direct_retrieval_evidence_probe_request_fixed_options.json"
COMMAND_JSON = OUT_DIR / "capped_direct_retrieval_evidence_probe_command_fixed_options.json"
MANIFEST = OUT_DIR / "capped_direct_retrieval_evidence_probe_manifest_fixed_options.jsonl"
...
JUDGMENT_PACKAGE = ARTIFACTS / "stage11276_capped_direct_retrieval_evidence_package"
JUDGMENT_SUMMARY = JUDGMENT_PACKAGE / "capped_direct_retrieval_evidence_package.json"
JUDGMENT_AUDIT = JUDGMENT_SUMMARY
JUDGMENT_TRAIN = JUDGMENT_PACKAGE / "capped_direct_retrieval_evidence_train_rows.jsonl"
JUDGMENT_VALIDATION = JUDGMENT_PACKAGE / "capped_direct_retrieval_evidence_validation_rows.jsonl"
JUDGMENT_STRICT = JUDGMENT_PACKAGE / "capped_direct_retrieval_evidence_strict_rows.jsonl"
...
RUN_DIR = ARTIFACTS / "stage11281_capped_direct_retrieval_evidence_probe_fixed_options"
...
def main() -> None:
    ...
    if not package.get("passed"):
        raise SystemExit("Stage11276 package did not pass")
    if not audit.get("passed"):
        raise SystemExit("Stage11276 audit did not pass")
    ...
    summary = {
        ...
        "passed": True,
        "decision": "capped_direct_retrieval_evidence_probe_fixed_options_requested",
        "rationale": [
            "Stage11276 provides repo-capped multilingual source-backed verifier-vs-changed evidence rows; this request tests whether the judgment-head scorer can use that cleaner source supply.",
            "Stage11276 passed source-text, duplicate-id, and root-split audits.",
            "This is diagnostic: Stage11276 covers C/C++/Python/Rust/Web, but it is verifier-vs-changed evidence-candidate supervision, not a full maintainer-bundle benchmark.",
        ],
        "metrics": {
        ...
        "promotion_gate_for_postrun": {
            ...
            "capped_direct_retrieval_validation_or_strict_should_score_above_majority_baseline": True,
        },
        "source_artifacts": {
