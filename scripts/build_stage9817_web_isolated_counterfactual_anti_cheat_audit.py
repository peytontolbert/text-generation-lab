...
STAGE = 9817
NAME = "stage9817_web_isolated_counterfactual_anti_cheat_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT = OUT_DIR / "opaque_choice_counterfactual_anti_cheat_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "WEB_ISOLATED_COUNTERFACTUAL_ANTI_CHEAT_AUDIT_STAGE9817.md"
...
ROW_LOGITS = ROOT / "runs/local/artifacts/stage9815_web_isolated_structured_exec/row_field_logits.jsonl"
        ...
        records.append(
            {
                ...
                "manifest_hash": load_json(ROOT / "runs/local/artifacts/stage9815_web_isolated_structured_exec/probe_contract_audit.json").get("manifest_sha256"),
...
def main() -> None:
    ...
    summary = {
        ...
        "decision": "Packaged the web-isolated multilingual win into counterfactual anti-cheat cards with real Stage9815 100M row outputs, real Stage9816 Gemma row outputs, prompt-surface leakage checks, split-stable mapping checks, shallow baselines, and transformed prompt probes.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage9817 Web Isolated Counterfactual Anti Cheat Audit",
                "",
                ...
                "",
                "This stage does not promote the result to general intelligence. It packages the web-isolated multilingual edit-localization win with the anti-cheat and counterfactual evidence needed to judge whether the score survives prompt leakage checks, label-order changes, decoy mentions, evidence ablations, and causal swaps.",
                "",
                f"Next: {next_step}",
                "",
            ]
