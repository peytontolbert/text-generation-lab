#!/usr/bin/env python3
"""Refresh support supply after PyTorch MKL C/C++ admission."""
...
STAGE = 11789
NAME = "stage11789_source_heldout_support_supply_status_v10"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v10.json"

PYTHON = ART / "stage11776_python_verifier_support_combined_audit_v4/python_verifier_support_combined_audit_v4.json"
CPP = ART / "stage11788_cpp_abstain_support_combined_audit_v4/cpp_abstain_support_combined_audit_v4.json"
...
def main() -> None:
    ...
    artifact = {
        ...
        "delta_since_stage11785": {"cpp_abstain_ready_roots_added": 1, "cpp_abstain_ready_rows_added": 4},
        "next_actions": [
            "Continue C/C++ build/verifier expansion beyond 4/16 roots.",
