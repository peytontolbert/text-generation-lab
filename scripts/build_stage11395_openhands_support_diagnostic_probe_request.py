...
STAGE = 11395
NAME = "stage11395_openhands_support_diagnostic_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "openhands_support_diagnostic_probe_request.json"
CMD = OUT / "openhands_support_diagnostic_probe_command.json"
MAN = OUT / "openhands_support_diagnostic_probe_manifest.jsonl"
...
SEALED = ART / "stage11390_openhands_unit_verifier_heldout_candidate_rows/openhands_unit_verifier_heldout_candidate_rows.jsonl"
INIT = ART / "stage11200_role_focused_residual_probe/runtime_model/runtime_model_bundle.json"
BASELINE = ART / "stage11391_openhands_web_heldout_candidate_score_audit/openhands_web_heldout_candidate_score_audit.json"
RUN = ART / "stage11396_openhands_support_diagnostic_probe"
...
def main() -> None:
    ...
    overlaps = sorted({root_key(r) for r in train} & {root_key(r) for r in val + strict + sealed})
    if overlaps:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "openhands_support_diagnostic_probe_requested_not_promotable",
        "metrics": {
            "train_rows": len(train),
            "eval_rows": len(val),
            "strict_rows": len(strict),
            "sealed_openhands_rows_not_in_manifest": len(sealed),
            "root_overlaps_with_eval_or_sealed": overlaps,
            "baseline": baseline.get("stage11200_frontier", {}),
        },
        "source_artifacts": {
            "train": rel(TRAIN),
            ...
            "sealed_openhands_heldout": rel(SEALED),
        ...
        "promotion_gate": {
            ...
            "sealed_stage11390_should_improve": "above 4/18 baseline",
