#!/usr/bin/env python3
"""Refresh support supply after FAISS C/C++ admission."""
...
STAGE = 11769
NAME = "stage11769_source_heldout_support_supply_status_v5"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v5.json"

PYTHON = ART / "stage11764_python_verifier_support_combined_audit_v2/python_verifier_support_combined_audit_v2.json"
CPP = ART / "stage11768_cpp_abstain_support_combined_audit_v2/cpp_abstain_support_combined_audit_v2.json"
RUST = ART / "stage11759_rust_verifier_support_admission_audit/rust_verifier_support_admission_audit.json"
...
def main() -> None:
    ...
    support_status = {
        ...
        "cpp_abstain_attractor_support": {"ready_roots": cpp_roots, "ready_rows": cpp.get("admitted_rows", 0), "remaining_support_roots": max(0, 16 - cpp_roots), "required_support_roots": 16, "materialized_rows": cpp.get("outputs", {}).get("combined_rows")},
        "rust_verifier_support": {"ready_roots": rust_roots, "ready_rows": rust.get("admitted_rows", 0), "remaining_support_roots": max(0, 12 - rust_roots), "required_support_roots": 12, "materialized_rows": rust.get("outputs", {}).get("admitted_rows"), "repo_family_warning": "Current true Rust verifier roots are from one repo family."},
    ...
    artifact: dict[str, Any] = {
        ...
        "delta_since_stage11765": {"cpp_abstain_ready_roots_added": 1, "cpp_abstain_ready_rows_added": 4},
        "next_actions": [
            "Continue C/C++ build/verifier expansion beyond 2/16 roots.",
            "Continue Python verifier expansion beyond 3/12 roots.",
            "Find more non-tokenizers Rust repo families beyond 2/12 roots from one family.",
        ],
