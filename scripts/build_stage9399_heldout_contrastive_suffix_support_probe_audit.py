...
STAGE = 9399
NAME = "stage9399_heldout_contrastive_suffix_support_probe_audit"
SOURCE_SUMMARY = ROOT / "runs/summaries/stage9398_heldout_contrastive_suffix_support_preexecution.json"
RUN_DIR = ROOT / "runs/local/artifacts/stage9399_heldout_contrastive_suffix_support_probe"
AUDIT = RUN_DIR / "stage9399_heldout_contrastive_suffix_support_probe_audit.json"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "HELDOUT_CONTRASTIVE_SUFFIX_SUPPORT_PROBE_AUDIT_STAGE9399.md"
...
def main() -> None:
    ...
    if source.get("passed") is not True:
        failures.append("source_stage9398_not_passed")
    ...
    quality_gate_passed = bool(
        generated == 31
        and exact_by_split["train"] == by_split["train"] == 15
    ...
    next_step = "Rejoin heldout suffix support into bounded decoder repair path." if audit["quality_gate_passed"] else "Inspect Stage9399 residuals and add support for still-missing suffix families before any decoder CE."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
