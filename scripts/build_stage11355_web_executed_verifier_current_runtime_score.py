...
STAGE = 11355
NAME = "stage11355_web_executed_verifier_current_runtime_score"
OUT = ART / NAME
SUMMARY = OUT / "web_executed_verifier_current_runtime_score.json"
RUNTIME = ART / "stage11200_role_focused_residual_probe/runtime_model/runtime_model_bundle.json"
SPLITS = {
    "web_executed_verifier_train_support": ART / "stage11354_web_executed_verifier_support_rows/web_executed_verifier_train_support_rows.jsonl",
...
def main() -> None:
    ...
    summary = {
        ...
        "passed": True,
        "decision": "web_executed_verifier_current_runtime_score_complete",
        ...
        "recommended_next_action": "Use this as the baseline for any future Stage11354 executed-verifier support probe; do not promote without heldout movement.",
    }
