...
STAGE = 10547
NAME = "stage10547_masked_projection_successor_canary_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT_JSON = OUT_DIR / "masked_projection_successor_canary_audit.json"
ROW_JSONL = OUT_DIR / "masked_projection_successor_canary_rows.jsonl"
...
def main() -> None:
    ...
    payload = {
        ...
        "passed": True,
        "claim_scope": [
            "Saved-runtime canary regression audit on the repaired 24-row v2.7 overlay using the stage10545 masked-projection successor runtime.",
