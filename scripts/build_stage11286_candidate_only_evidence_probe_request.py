...
STAGE = 11286
NAME = "stage11286_candidate_only_evidence_probe_request"
OUT_DIR = ARTIFACTS / NAME
SUMMARY_JSON = OUT_DIR / "candidate_only_evidence_probe_request.json"
COMMAND_JSON = OUT_DIR / "candidate_only_evidence_probe_command.json"
MANIFEST = OUT_DIR / "candidate_only_evidence_probe_manifest.jsonl"
...
JUDGMENT_PACKAGE = ARTIFACTS / "stage11285_candidate_only_evidence_judgment_package"
JUDGMENT_SUMMARY = JUDGMENT_PACKAGE / "candidate_only_evidence_judgment_package.json"
JUDGMENT_AUDIT = JUDGMENT_SUMMARY
JUDGMENT_TRAIN = JUDGMENT_PACKAGE / "candidate_only_evidence_judgment_train_rows.jsonl"
JUDGMENT_VALIDATION = JUDGMENT_PACKAGE / "candidate_only_evidence_judgment_validation_rows.jsonl"
JUDGMENT_STRICT = JUDGMENT_PACKAGE / "candidate_only_evidence_judgment_strict_rows.jsonl"
...
RUN_DIR = ARTIFACTS / "stage11287_candidate_only_evidence_probe"
...
def main() -> None:
    ...
    if not package.get("passed"):
        raise SystemExit("Stage11285 package did not pass")
    if not audit.get("passed"):
        raise SystemExit("Stage11285 audit did not pass")
    ...
    summary = {
        ...
        "passed": True,
        "decision": "candidate_only_evidence_probe_requested",
        "rationale": [
            "Stage11285 removes root-level verifier route, available-role lists, and source-row identity from Stage11276 rows; this request tests whether candidate-only prompt geometry reduces the verifier-positive attractor.",
            "Stage11285 passed source-text, duplicate-id, root-split, and target-leak audits.",
            "This is diagnostic: Stage11285 covers C/C++/Python/Rust/Web, but it is candidate-only evidence judgment supervision, not a full maintainer-bundle benchmark.",
        ],
        "metrics": {
        ...
        "promotion_gate_for_postrun": {
            ...
            "candidate_only_validation_or_strict_should_score_above_majority_baseline": True,
        },
        "source_artifacts": {
