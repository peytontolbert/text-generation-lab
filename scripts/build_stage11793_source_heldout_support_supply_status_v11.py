#!/usr/bin/env python3
"""Refresh support supply after PEFT Python verifier admission."""
...
STAGE = 11793
NAME = "stage11793_source_heldout_support_supply_status_v11"
OUT = ART / NAME
SUMMARY = OUT / "source_heldout_support_supply_status_v11.json"

PYTHON = ART / "stage11792_python_verifier_support_combined_audit_v5/python_verifier_support_combined_audit_v5.json"
...
def main() -> None:
    ...
    artifact = {
        ...
        "delta_since_stage11789": {
            "python_verifier_ready_roots_added": 1,
            "python_verifier_ready_rows_added": 4,
        },
        "next_actions": [
            "Continue Python verifier expansion beyond 6/12 roots.",
