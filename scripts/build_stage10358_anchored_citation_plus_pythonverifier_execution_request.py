...
STAGE = 10358
NAME = "stage10358_anchored_citation_plus_pythonverifier_execution_request"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
MANIFEST_JSONL = OUT_DIR / "anchored_citation_plus_pythonverifier_manifest.jsonl"
REQUEST_JSON = OUT_DIR / "anchored_citation_plus_pythonverifier_execution_request.json"
COMMAND_JSON = OUT_DIR / "anchored_citation_plus_pythonverifier_command.json"
...
RUN_ID = "stage10359_anchored_citation_plus_pythonverifier_probe"
OUTPUT_DIR = "runs/local/artifacts/stage10359_anchored_citation_plus_pythonverifier_probe/bounded_decoder_probe"
RUNTIME_MODEL_DIR = "runs/local/artifacts/stage10359_anchored_citation_plus_pythonverifier_probe/runtime_model"
MAX_STEPS = 20
LEARNING_RATE = "4e-6"
BATCH_SIZE = 2
...
def main() -> None:
    ...
    for row in cpp_citation_rows + rust_citation_rows + cpp_minimal_contrast_rows + rust_minimal_weakness_rows:
    ...
    request = {
        ...
        "frontloaded_support_rows": {
            ...
            "cpp_minimal_contrast_rows": len(cpp_minimal_contrast_rows),
        ...
        "required_honesty_gates": [
            ...
            "only citation-family train rows are exempt from preservation KL",
        ],
        "next_best_step": "run one preservation-enabled citation augmentation probe with repeated python verifier anchors and check whether citation adaptation still collapses the unresolved verifier family to a fixed wrong semantic answer",
        "preservation": {
