...
STAGE = 10061
NAME = "stage10061_hybrid_web_targeted_same_manifest_comparison_audit"
OUT_DIR = ROOT / "runs/local/artifacts" / NAME
AUDIT = OUT_DIR / "hybrid_web_targeted_same_manifest_comparison_audit.json"
ROWS = OUT_DIR / "hybrid_web_targeted_same_manifest_comparison_rows.jsonl"
SUMMARY = ROOT / "runs/summaries" / f"{NAME}.json"
DOC = ROOT / "docs" / "HYBRID_WEB_TARGETED_SAME_MANIFEST_COMPARISON_AUDIT_STAGE10061.md"
...
SUCCESSOR_HUNDRED_M = ROOT / "runs/local/artifacts/stage10060_hybrid_web_targeted_target100m_probe/edit_localization_probe/row_field_logits.jsonl"
...
def main() -> None:
    ...
    next_step = "Use this audit to decide whether the hybrid packet finally combines the stage10056 rust/cpp recovery with the stronger targeted web behavior while retaining the Python lead."
    summary = {
        "stage": STAGE,
        "stage_name": NAME,
        "name": NAME,
        ...
        "decision": "Materialized the same-manifest comparison audit for the hybrid web-targeted successor run so the resulting 100M outputs can be judged directly against stage10040 and the fixed Gemma comparator.",
    ...
    DOC.write_text(
        "\n".join(
            [
                "# Stage10061 Hybrid Web Targeted Same Manifest Comparison Audit",
                "",
