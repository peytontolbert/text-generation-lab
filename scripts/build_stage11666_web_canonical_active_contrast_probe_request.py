...
STAGE = 11666
NAME = "stage11666_web_canonical_active_contrast_probe_request"
OUT = ART / NAME
SUMMARY = OUT / "web_canonical_active_contrast_probe_request.json"
...
RUN_DIR = ART / "stage11666_web_canonical_active_contrast_probe"
...
def main() -> None:
    ...
    summary = {
        ...
        "stage_name": NAME,
        "created_at_utc": now(),
        "decision": "web_canonical_active_contrast_probe_ready" if all(gates.values()) else "web_canonical_active_contrast_probe_blocked",
        ...
        "claim_boundary": [
            "This is a head-only diagnostic over the canonical Web renderer after the canonical contrast parser fix.",
