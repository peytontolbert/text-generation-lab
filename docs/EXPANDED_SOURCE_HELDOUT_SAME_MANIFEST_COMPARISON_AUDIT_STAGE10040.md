...
Next: After the stage10040 100M rerun and stage10041 Gemma queue both exist, use this audit to answer whether the 100M still beats Gemma on the expanded 55-row heldout compare subset of the 95-row manifest.
