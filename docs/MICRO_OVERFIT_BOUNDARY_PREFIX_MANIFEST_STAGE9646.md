# Stage9646 Micro-Overfit Boundary Prefix Manifest
...
Strongest metadata baseline: `0.5`

Decoder CE, denoise CE, runtime, Gemma, harness, checkpoint export, and promotion remain closed.

Next: If Stage9646 passes, run Stage9647 micro-overfit target-100M probe and require train/eval exact before widening.
