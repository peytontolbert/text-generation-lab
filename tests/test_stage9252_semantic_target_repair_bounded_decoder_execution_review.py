...
def _load():
    ...
    path = root / "scripts/build_stage9252_semantic_target_repair_bounded_decoder_execution_review.py"
    spec = importlib.util.spec_from_file_location("stage9252", path)
