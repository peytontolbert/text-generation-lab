...
def _load():
    ...
    path = root / "scripts/build_stage9696_capped_multisurface_structured_target_100m_contract_preflight.py"
    spec = importlib.util.spec_from_file_location("stage9696", path)
