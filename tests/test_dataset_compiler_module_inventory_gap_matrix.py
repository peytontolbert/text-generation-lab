...
from scripts.build_stage8926_dataset_compiler_module_inventory_gap_matrix import (  # noqa: E402
    AUTHORITY_CLOSED,
    build_matrix,
    validate_matrix,
)
...
def registry() -> dict[str, object]:
    return {"metrics": {"latest_stage": 8925, "authority_counts": {key: 0 for key in AUTHORITY_CLOSED}}}
