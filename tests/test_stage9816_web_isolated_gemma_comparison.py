...
def _load():
    ...
    path = root / "scripts/build_stage9816_web_isolated_gemma_comparison.py"
    spec = importlib.util.spec_from_file_location("stage9816", path)
...
def test_stage9816_model_slice_reader_uses_manifest_rows():
    mod = _load()
