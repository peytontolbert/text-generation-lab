...
def _load():
    ...
    path = root / "scripts/build_stage9817_web_isolated_counterfactual_anti_cheat_audit.py"
    spec = importlib.util.spec_from_file_location("stage9817", path)
...
def test_stage9817_builds_web_isolated_cards_with_stubbed_probes():
    mod = _load()
