...
def _load():
    ...
    path = root / "scripts/build_stage9695_multisurface_structured_tiny_execution_review.py"
...
def test_ticket_stays_inactive_and_requires_followup_contract():
    ...
    assert "fresh_stage9696_capped_contract_only_preflight_passed" in ticket["required_before_execution"]
