...
def test_stage10055_same_manifest_comparison_audit_requires_successor_outputs():
    mod = _load(ROOT / "scripts/build_stage10055_mixed_fresh_source_multilingual_same_manifest_comparison_audit.py", "stage10055")
