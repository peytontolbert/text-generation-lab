...
def _load():
    ...
    path = root / "scripts/build_stage9795_opaque_choice_counterfactual_anti_cheat_audit.py"
    spec = importlib.util.spec_from_file_location("stage9795", path)
...
def test_stage9795_builds_corrected_opaque_choice_cards_with_stubbed_probes():
    mod = _load()
