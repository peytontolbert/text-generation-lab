...
from scripts.build_stage9173_trainer_setup_emit_only_design import (  # noqa: E402
    NEGATIVE_CASES,
    build_design,
    registry,
    run_negative_cases,
