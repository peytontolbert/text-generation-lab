...
def test_stage10064_same_manifest_comparison_audit_requires_successor_outputs():
    mod = _load(ROOT / "scripts/build_stage10064_web_non_b_anticollapse_same_manifest_comparison_audit.py", "stage10064")
