...
def _load():
    ...
    path = root / 'scripts/build_stage9777_verifier_repair_evidence_sufficiency_audit.py'
    spec = importlib.util.spec_from_file_location('stage9777', path)
...
def test_stage9777_finds_verifier_repair_safe_evidence_collapse():
    mod = _load()
