...
def _load():
    ...
    path = root / 'scripts/build_stage9849_counterfactual_curriculum_gemma_comparison.py'
    spec = importlib.util.spec_from_file_location('stage9849', path)
...
def test_stage9849_build_audit_counts_wins():
    mod = _load()
    hundred = [
